...
- Elimine **plantillas de solo vista previa** bloques (se expande/divide o párrafos que solo explican que el contenido resaltado es de solo vista previa, de liberación rápida, de zona protegida, etc.) una vez que la función sea GA.

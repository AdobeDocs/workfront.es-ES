...
4. Para obtener información detallada sobre terminología, puntuación y reglas de procedimiento, consulte [reference.md](reference.md)
...
Para ver las reglas terminológicas y de puntuación completas, consulte [reference.md](reference.md).

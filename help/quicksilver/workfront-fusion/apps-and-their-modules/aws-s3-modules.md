...
description: El [!DNL Adobe Workfront Fusion AWS] Los módulos S3 permiten realizar operaciones en los bloques de S3.
author: Becky
...
El [!DNL Adobe Workfront Fusion AWS] Los módulos S3 permiten realizar operaciones en los bloques de S3.
...
## Connect [!DNL AWS] hasta [!DNL Workfront Fusion] {#connect-aws-to-workfront-fusion}

Para conectar [!DNL AWS S3] hasta [!DNL Workfront Fusion] debe conectar su [!DNL AWS] cuenta a [!DNL Workfront Fusion]. Para ello, primero debe crear un usuario de API en [!DNL AWS] [!UICONTROL IAM].

1. Inicie sesión en su [!DNL AWS] [!UICONTROL IAM] cuenta.
1. Vaya a **[!UICONTROL Administración de acceso e identidad]** > **[!UICONTROL Administración de acceso]** > **[!UICONTROL Usuarios]**.

1. Clic **[!UICONTROL Añadir usuario]**.
1. Introduzca el nombre del nuevo usuario y seleccione **[!UICONTROL Acceso mediante programación]** en la opción [!UICONTROL Tipo de acceso] sección.
1. Clic **[!UICONTROL Adjuntar directivas existentes directamente]** y luego busque **[!UICONTROL AmazonS3FullAccess]** en la barra de búsqueda. Haga clic en él cuando aparezca y luego haga clic en **[!UICONTROL Siguiente]**.

1. Continúe con las otras pantallas de diálogo y haga clic en **[!UICONTROL Crear usuario]**.
1. Copie el proporcionado **[!UICONTROL ID de clave de acceso]** y **[!UICONTROL Clave de acceso secreta]**.

1. Ir a [!DNL Workfront Fusion] y abra el [!DNL AWS S3] del módulo **[!UICONTROL Crear una conexión]** diálogo.
1. Introduzca el [!UICONTROL ID de clave de acceso] y [!UICONTROL Clave de acceso secreta] del paso 7 a los campos respectivos y haga clic en **[!UICONTROL Continuar]** para establecer la conexión.

Se ha establecido la conexión. Puede continuar con la configuración del módulo.

## [!DNL AWS S3] módulos y sus campos

Al configurar [!DNL AWS S3] módulos, [!DNL Workfront Fusion] muestra los campos que se indican a continuación. Junto con estos, se añaden [!DNL AWS S3] Los campos pueden mostrarse, en función de factores como el nivel de acceso en la aplicación o el servicio. Un título en negrita en un módulo indica un campo obligatorio.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Para obtener instrucciones acerca de cómo conectar su [!DNL AWS] cuenta a [!DNL Workfront Fusion], consulte <a href="#connect-aws-to-workfront-fusion" class="MCXref xref">Connect [!DNL AWS] hasta [!DNL Workfront Fusion]</a> en este artículo.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione el punto final regional. Para obtener más información, consulte el tema sobre <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html">extremos regionales</a> en la documentación de AWS.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Región] </td> 
   <td> <p>Seleccione el punto final regional. Para obtener más información, consulte el tema sobre <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html">extremos regionales</a> en el [!DNL AWS] documentación.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Insertar encabezados de solicitud. Los encabezados disponibles se encuentran en <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html">[!DNL AWS S3] documentation: objeto [!UICONTROL PUT]</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Para un análisis detallado de la [!DNL Amazon S3] API, consulte [[!DNL Amazon S3] [!UICONTROL REST] Introducción a API](https://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html).
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Bucket] </td> 
   <td> <p>Seleccione el [!DNL Amazon S3] bloque en el que desea buscar archivos.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Bucket] </td> 
   <td> <p>Seleccione el [!DNL Amazon S3] bloque en el que desea buscar carpetas.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Prefix] (opcional)</p> </td> 

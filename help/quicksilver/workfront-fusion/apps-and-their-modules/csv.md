...
El [!DNL Adobe Workfront Fusion] [!UICONTROL CSV] Los módulos de permiten crear archivos CSV y analizar el texto CSV a partir de un valor de texto recibido o un archivo.
...
El [!UICONTROL Crear CSV] Aggregator permite crear un texto csv a partir de valores de texto recibidos.

Para obtener más información sobre los acumuladores, consulte [Módulo de agregado en [!DNL Adobe Workfront Fusion]](../../workfront-fusion/modules/aggregator-module.md).
...
## [!UICONTROL Creación de CSV (avanzada)]

El [!UICONTROL Creación de CSV (avanzada)] Aggregator permite crear un texto CSV a partir de valores de texto recibidos. Utiliza una estructura de datos que define las columnas CSV en el archivo CSV resultante. Una vez definidas, las columnas aparecen como campos en la configuración del módulo CSV y se pueden asignar a módulos posteriores en el escenario.
...
<p>Supongamos que desea exportar sus contactos de Google a un archivo CSV con dos columnas "Full Name" y "Email". El paquete de salida del módulo [!UICONTROL Contactos de Google] &gt;[!UICONTROL Obtener contactos de un grupo] tiene la siguiente estructura. Las direcciones de correo electrónico se almacenan dentro de <code>[!UICONTROL Emails[]]</code> item, que es una matriz de colecciones, cada una de las cuales contiene dos elementos: <code>Label</code> y <code>Email</code>.</p>
<p> <img src="assets/transforming-350x546.png" style="width: 350;height: 546;"> </p>
<p>Si utiliza el método simple [!DNL Create CSV] , se le ofrecerá una lista de casillas de verificación correspondientes a los elementos de nivel superior de un paquete. Si intenta marcar <code>Full name</code> y <code>Emails</code> , el módulo [!UICONTROL Crear CSV] genera el siguiente resultado, que probablemente no sea el deseado:</p>
<p>"emails","fullName"</p>
...
<p>Dado que el elemento <code>Full Name</code> es de tipo texto simple, se exporta muy bien. Pero el artículo <code>Emails</code>, que es de un tipo complejo Array of Collections, se exporta como [objeto Objeto], que es la forma en que Collections y Arrays se transforman en texto de forma predeterminada. Para obtener más información, consulte <a href="../../workfront-fusion/mapping/item-data-types.md" class="MCXref xref">Tipos de datos de elementos en Adobe Workfront Fusion</a>.</p>
<p>Para exportar el contenido de <code>Email </code>elemento de la primera colección de <code>Emails[]</code> en su lugar, es necesario emplear el módulo [!UICONTROL Crear CSV (avanzado)]. El módulo le permite definir columnas individuales del archivo CSV y asignarles elementos, incluidos los anidados.</p>
<ol>
<li value="1">Inserte el módulo [!UICONTROL Crear CSV (avanzado)] en un escenario y abra su configuración.</li>
<li value="2">Haga clic en <strong>[!UICONTROL Agregar]</strong> situado junto al campo [!UICONTROL Data structure] para crear una nueva estructura de datos.</li>
<li value="3"> <p>Escriba un nombre para la estructura de datos y haga clic en <strong>[!UICONTROL Agregar elemento]</strong> para añadir las columnas individuales. Si desea exportar dos columnas: "Nombre completo" y "Correo electrónico", la estructura de datos resultante tendría este aspecto:</p> <p> <img src="assets/google-contacts-350x524.png" style="width: 350;height: 524;"> </p> </li>
<li value="4"> <p>Una vez que haya definido correctamente la estructura de datos, los campos correspondientes a cada columna individual deben aparecer en la configuración del módulo [!UICONTROL Crear CSV (avanzado)] para que pueda asignar los elementos. Tome el primer elemento de la <code>[!UICONTROL Emails[]]</code> matriz y asignar su elemento <code>Email </code>Vaya al campo/columna Correo electrónico:</p> <p> <img src="assets/create-csv-advanced-350x308.png" style="width: 350;height: 308;"> </p> </li>
<li value="5"> <p>Ejecute el escenario. Dado que el elemento <code>Emails[1]: Email</code> asignado a la columna "Correo electrónico" es de tipo texto simple, se exporta correctamente ahora:</p> <p>"Nombre completo","Correo electrónico"</p> <p>"Shon Winer","Shon@Winer.com"</p> <p>"Lizeth Fulmore","Lizeth@Fulmore.com"</p> <p>"Hilario Gullatt","Hilario@Gullatt.com"</p> <p>"Abby Eisenbarth","Abby@Eisenbarth.com"</p> </li>
</ol>
</div>

## [!UICONTROL Analizar CSV]

El [!UICONTROL Analizar CSV] El transformador permite analizar el texto CSV desde un valor de texto recibido o un archivo.

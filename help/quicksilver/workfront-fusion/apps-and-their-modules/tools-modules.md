...
title: Herramientas
description: El [!DNL Adobe Workfront Fusion Tools] Esta sección incluye varios módulos útiles que pueden mejorar su situación.
author: Becky
...
El [!DNL Adobe Workfront Fusion Tools] Esta sección incluye varios módulos útiles que pueden mejorar su situación.

[!UICONTROL Herramientas] Los módulos de están disponibles en la lista de aplicaciones o en el [!UICONTROL Herramientas] icono ![](assets/tools-icon-small.png) en la parte inferior de la pantalla.
...
Puede utilizar este módulo, por ejemplo, para contactos o cualquier otra lista programada para enviarse a una dirección de correo electrónico especificada (como [!UICONTROL Correo electrónico] >[!UICONTROL Enviar un correo electrónico], o [!DNL Gmail] >[!UICONTROL Enviar un correo electrónico] módulos), o como un simple recordatorio para que se active cuando quiera.
...
* [[!UICONTROL Incrementar función]](#increment-function)
...
Este módulo recupera los valores creados anteriormente por [!UICONTROL Establecer variable] o [!UICONTROL Establecer varias variables] módulo.

Este módulo puede leer variables que se establecieron en cualquier parte del escenario, incluso si la variable se estableció en una ruta diferente a donde el [!UICONTROL Obtener varias variables] se encuentra el módulo de. El único requisito es que la [!UICONTROL Herramientas] > [!UICONTROL Establecer variable] o [!UICONTROL Herramientas] > [!UICONTROL Establecer varias variables] se ejecuta antes de que el [!UICONTROL Herramientas] > [!UICONTROL Obtener varias variables] módulo. Para obtener más información sobre el orden en que se ejecutan los módulos, consulte [Módulo de enrutador en [!DNL Adobe Workfront Fusion]](../../workfront-fusion/modules/router-module.md).
...
>[!INFO]
>
>**Ejemplos:**  Los siguientes son posibles usos del [!UICONTROL Establecer]/[!UICONTROL Obtener (varias) variables] módulos:
>
...
>* Para depurar una fórmula. Si una fórmula utilizada en un módulo no proporciona aparentemente un resultado correcto, copie la fórmula y péguela en un [!UICONTROL Establecer variable] que inserte antes del módulo correspondiente. Desconecte los módulos después de la [!UICONTROL Establecer variable] y ejecute el escenario. Compruebe el [!UICONTROL Establecer variable] , ajuste o simplifique la fórmula, ejecute de nuevo el escenario y siga haciéndolo hasta que se haya resuelto el problema.


#### [!UICONTROL Obtener variable]

Este módulo recupera un valor creado anteriormente por el [!UICONTROL Establecer variable] o [!UICONTROL Establecer varias variables] módulo.

Este módulo puede leer variables que se establecieron en cualquier parte del escenario, incluso si la variable se estableció en una ruta diferente a donde el [!UICONTROL Obtener variable] se encuentra el módulo de. El único requisito es que la [!UICONTROL Herramientas] > [!UICONTROL Establecer variable] o [!UICONTROL Herramientas] > [!UICONTROL Establecer varias variables] se ejecuta antes de que el [!UICONTROL Herramientas] > [!UICONTROL Obtener variable] módulo. Para obtener más información sobre el orden en que se ejecutan los módulos, consulte [Módulo de enrutador en [!DNL Adobe Workfront Fusion]](../../workfront-fusion/modules/router-module.md).
...
>1. Establezca el del módulo **[!UICONTROL Restablecer un valor]** a Nunca.
>1. Defina la ruta para los valores impares. Establezca el filtro para esta ruta utilizando la función de matemática de módulo igual a `1`:
>
>   ![](assets/odd-350x459.png)
>
>  **Nota**: No olvide cambiar el [!UICONTROL Igual a] operador desde el valor predeterminado [!UICONTROL Texto] al operador [!UICONTROL Numérico] operador.
>
>1. Establezca la ruta para los valores pares utilizando la función de matemática de módulo igual a `0`:
>
...
Este módulo crea variables que otros módulos pueden asignar en la ruta. La variable también se puede asignar al [!UICONTROL Obtener variable] o [!UICONTROL Obtener varias variables] módulos para cualquier ruta en el escenario.
...
Este módulo crea una variable que otros módulos pueden asignar en la ruta. La variable también se puede asignar al [!UICONTROL Obtener variable] o [!UICONTROL Obtener varias variables] módulos para cualquier ruta en el escenario.
...
Esta función puede resultar útil, por ejemplo, si desea reducir el [!DNL target] carga del servidor de servicios o para imitar el comportamiento humano al enviar SMS o correos electrónicos masivos.
...
>
>Para obtener más información sobre módulos de almacén de datos específicos, consulte [[!UICONTROL Almacén de datos] módulos](../../workfront-fusion/apps-and-their-modules/data-store-modules.md).
...
>[!INFO]
>
>**Ejemplo:** Puede utilizar el agregador de texto para insertar más valores (por ejemplo, nombres de clientes o notas) en un solo paquete y enviar un correo electrónico que contenga todos los valores del cuerpo del correo electrónico o el asunto del correo electrónico.

### Transformadores

* [[!UICONTROL Componga una cadena]](#compose-a-string)
* [[!UICONTROL Convertir la codificación del texto]](#convert-the-encoding-of-the-text)
* [[!UICONTROL Cambiar]](#switch)

#### [!UICONTROL Componga una cadena]
  ...
  <tr> 
   ...
   <td> <p>Active esta opción para utilizar expresiones regulares. El módulo determina los casos en función de la expresión regular, en lugar de una coincidencia exacta.</p> 
    <div> 
     ...
     <ul> 
      <li>Para ver la lista completa de metacaracteres, consulte <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions">Expresiones regulares</a> en documentos web de MDN.</li> 
      <li>Para ver un tutorial sobre cómo crear expresiones regulares, recomendamos <a href="https://regexone.com/">RegexOne</a>.</li> 
      <li>Para experimentar con expresiones regulares, recomendamos el <a href="https://regex101.com/">Expresiones regulares 101</a> sitio web. Seleccione ECMAScript (JavaScript) FLAVOR en el panel izquierdo.</li> 
     </ul> 
    </div> </td> 
  </tr> 
  <tr> 

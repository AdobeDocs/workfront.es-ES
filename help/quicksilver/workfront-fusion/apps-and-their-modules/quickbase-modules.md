...
description: En un [!DNL Adobe Workfront Fusion] , puede automatizar los flujos de trabajo que utilizan Quickbase, así como conectarlos a varias aplicaciones y servicios de terceros.
author: Becky
...
En un [!DNL Adobe Workfront Fusion] , puede automatizar los flujos de trabajo que utilizan [!DNL Quickbase], así como conectarlo a varias aplicaciones y servicios de terceros.
...
Al configurar [!DNL Quickbase] módulos, [!DNL Workfront Fusion] muestra los campos que se enumeran a continuación. Además de estos, se incluyen [!DNL Quickbase] pueden mostrarse los campos, en función de factores como el nivel de acceso en la aplicación o el servicio. Un título en negrita en un módulo indica un campo obligatorio.
...
Este módulo llama a cualquier disponible [!DNL Quickbase] El extremo de la API RESTful está documentado en [developer.quickbase.com](http://developer.quickbase.com/).

...
description: Esta [!DNL Adobe Workfront Fusion] Este módulo permite configurar una solicitud HTTP con la autorización de certificado del cliente HTTP y enviarla a un servidor. La respuesta HTTP recibida se incluye entonces en el paquete de salida.
author: Becky
...
Esta [!DNL Adobe Workfront Fusion] Este módulo permite configurar una solicitud HTTP con la autorización de certificado del cliente HTTP y enviarla a un servidor. La respuesta HTTP recibida se incluye entonces en el paquete de salida.
...
Al configurar la variable [!UICONTROL HTTP] >[!UICONTROL Realizar una solicitud de autorización de certificado de cliente] módulo, [!DNL Adobe Workfront Fusion] muestra los campos que se indican a continuación. Un título en negrita en un módulo indica un campo obligatorio.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Seleccione la clave que contiene las credenciales de autenticación del certificado de cliente o haga clic en <strong>[!UICONTROL Agregar]</strong> para agregar sus credenciales a una clave nueva. </p> <p>Nota: Puede agregar más credenciales para cambiar fácilmente entre cada conexión.</p> </td> 
  </tr> 
  <tr> 

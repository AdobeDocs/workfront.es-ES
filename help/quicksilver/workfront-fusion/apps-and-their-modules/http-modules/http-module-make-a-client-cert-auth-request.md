...
>
>* [HTTP > Crear un módulo de solicitud de autorización de certificado de cliente](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-a-client-cert-auth-request.html)
>
...
Para obtener información sobre las licencias de [!DNL Adobe Workfront Fusion], consulte [[!DNL Adobe Workfront Fusion] Licencias de ](../../../workfront-fusion/get-started/license-automation-vs-integration.md)

## Configuración del módulo [!UICONTROL HTTP] >[!UICONTROL Make a Client Certificate Authorization request]
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Seleccione la clave que contiene las credenciales de autenticación de certificado de cliente o haga clic en <strong>[!UICONTROL Add]</strong> para añadir las credenciales a una clave nueva. </p> <p>Nota: Se pueden añadir más credenciales para cambiar fácilmente entre cada conexión.</p> </td> 
  </tr> 
  <tr> 

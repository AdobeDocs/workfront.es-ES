...
>
>* [HTTP > Crear un módulo de solicitud OAuth 2.0](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-an-oauth-2-request.html)
>
...
* [Instrucciones para crear una conexión con Google en el módulo de solicitud HTTP >[!UICONTROL Crear] una OAuth 2.0](#instructions-for-creating-a-connection-to-google-in-the-http-make-an-oauth-20-request-module)
...
1. Haga clic en **[!UICONTROL Continue]** para guardar la configuración de conexión.
1. Continúe en [Configuración del módulo de solicitud OAuth 2.0](#oauth-20-request-module-setup).

### Instrucciones para crear una conexión a [!DNL Google] en el [!UICONTROL HTTP] >[!UICONTROL Make an OAuth 2.0 request module]
...
1. Asegúrese de haber creado un proyecto, establecido las opciones de configuración de OAuth y generado sus credenciales tal como se describe en [Conectar [!DNL Adobe Workfront Fusion]  a  [!DNL Google Services]  mediante un cliente de OAuth personalizado](../../../workfront-fusion/connections/connect-fusion-to-google-using-oauth.md).
1. Abra el módulo [!UICONTROL HTTP] >[!UICONTROL Realizar una solicitud OAuth 2.0].
1. Haga clic en **[!UICONTROL Añadir]** junto al cuadro de conexión.
...
### Instrucciones para conectarse a [!DNL Microsoft Graph API] a través del módulo [!UICONTROL HTTP] > [!UICONTROL Make an OAuth 2.0 request]

Para obtener instrucciones sobre la [!DNL Microsoft Graph API], consulte [Llamar a la  [!DNL MS Graph REST API]  a través del módulo  [!DNL Adobe Workfront Fusion] [!UICONTROL HTTP] > [!UICONTROL Make an OAuth 2.0 request]](../../../workfront-fusion/connections/call-the-ms-graph-rest-api.md).
...
Al configurar el módulo [!UICONTROL HTTP] >[!UICONTROL Make an OAuth 2.0 request], [!DNL Workfront Fusion] muestra los campos enumerados a continuación. El título en negrita en un módulo indica un campo obligatorio.

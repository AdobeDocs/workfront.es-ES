...
title: HTTP &gt; Realizar una solicitud de autorización de clave de API
...
# HTTP >[!UICONTROL Realizar una solicitud de autorización de clave de API]
...
## [!UICONTROL HTTP] >[!UICONTROL Realizar una solicitud de autorización de clave de API] configuración del módulo

Al configurar la variable [!UICONTROL HTTP] >[!UICONTROL Realizar una solicitud de autorización de clave de API] módulo, [!DNL Adobe Workfront Fusion] muestra los campos que se enumeran a continuación. Un título en negrita en un módulo indica un campo obligatorio.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Seleccione la clave que contiene las credenciales de autenticación de clave de API. Para agregar una clave nueva, haga clic en <strong>[!UICONTROL Agregar]</strong> y configure la siguiente información:</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Key name]</strong></p> <p>Escriba un nombre para este conjunto de credenciales de API.</p> </li> 
     ...
     <li> <p><strong>[!UICONTROL API Key parameter name]</strong> </p> <p>Introduzca el nombre mediante el cual la llamada de API identifica la clave de API, como "apiKey" o "X-API-Key". Puede encontrar esta información en la documentación del servicio web al que se está conectando el módulo.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Evaluar todos los estados como errores (excepto 2xx y 3xx)] </td> 
   <td> <p>Utilice esta opción para configurar la gestión de errores.</p> <p>Para obtener más información, consulte <a href="../../../workfront-fusion/errors/error-handling.md" class="MCXref xref">Gestión de errores en Adobe Workfront Fusion</a>.</p> </td> 
  </tr> 
  <tr> 

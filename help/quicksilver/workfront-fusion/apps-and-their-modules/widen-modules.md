...
description: En un [!DNL Adobe Workfront Fusion] , puede automatizar los flujos de trabajo que utilizan [!UICONTROL Ensanchar], así como conectarlo a múltiples aplicaciones y servicios de terceros.
author: Becky
draft: Probably
...
En un [!DNL Adobe Workfront Fusion] , puede automatizar los flujos de trabajo que utilizan [!UICONTROL Ensanchar], así como conectarlo a múltiples aplicaciones y servicios de terceros.
...
Para usar [!UICONTROL Ensanchar] módulos, debe tener un [!UICONTROL Ensanchar] cuenta.

## Connect [!DNL Widen] hasta [!DNL Workfront Fusion] {#connect-widen-to-workfront-fusion}

Puede crear una conexión con su [!DNL Widen] cuenta directamente desde dentro de un [!DNL Widen] módulo.

1. En cualquier [!DNL Widen] , haga clic en **[!UICONTROL Añadir]** junto al [!UICONTROL Conexión] field.
1. Seleccione el [!DNL Widen] dominio al que desea conectarse.
1. Introduzca el token para su [!DNL Widen] cuenta. Para obtener instrucciones sobre cómo localizar este token, consulte la [[!DNL Widen] Preguntas frecuentes sobre API](https://community.widen.com/collective/s/article/API-FAQs).
1. Clic **[!UICONTROL Continuar]** para crear la conexión y volver al módulo.

## [!DNL Widen] módulos y sus campos

Al configurar [!DNL Widen] módulos, [!DNL Workfront Fusion] muestra los campos que se indican a continuación. Junto con estos, se añaden [!DNL Widen] Los campos pueden mostrarse, en función de factores como el nivel de acceso en la aplicación o el servicio. Un título en negrita en un módulo indica un campo obligatorio.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <td> <p>Para obtener instrucciones acerca de cómo conectar su [!DNL Widen] cuenta a [!DNL Workfront Fusion], consulte <a href="#connect-widen-to-workfront-fusion" class="MCXref xref">Connect [!DNL Widen] hasta [!DNL Workfront Fusion] </a> en este artículo.</p> </td> 
  </tr> 
  <tr> 
...
* [[!UICONTROL Adición de recursos a colecciones]](#add-assets-to-collections)
...
Este módulo de acción le permite realizar una llamada autenticada personalizada a [!DNL Widen] API. De este modo, se puede crear una automatización del flujo de datos que el otro no puede realizar [!DNL Widen] módulos.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Seleccione si desea utilizar la última versión de la [!DNL Widen] API o versión 1.0</td> 
  </tr> 
  <tr> 
...
#### [!UICONTROL Adición de recursos a colecciones]
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Para cada colección a la que desee agregar los recursos:</p> 
    <ol> 
     <li value="1"> <p> Clic <strong>[!UICONTROL Agregar]</strong>.</p> </li> 
     <li value="2"> <p>Escriba o asigne el [!UICONTROL ID de colección].</p> </li> 
     <li value="3"> <p>Clic <strong>[!UICONTROL Agregar elemento]</strong>.</p> </li> 
    </ol> </td> 
  </tr> 
  <tr> 

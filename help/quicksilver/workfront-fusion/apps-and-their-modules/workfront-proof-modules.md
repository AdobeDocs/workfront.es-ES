...
## Connect [!DNL Workfront Proof] hasta [!DNL Workfront Fusion]

Puede crear una conexión con su [!DNL Workfront Proof] cuenta directamente desde dentro de un [!DNL Workfront Fusion] módulo.
   ...
   <table style="table-layout:auto"> 
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Escriba el nombre de usuario para su [!DNL Workfront Proof] cuenta.</td>
            </tr>
            <tr>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td>Introduzca el ID de la resolución que desea utilizar para la prueba. Para obtener una lista de los ID de resolución, consulte la [!DNL Workfront Proof] <a href="https://api.proofhq.com/home/objects/soapworkflowproofobject.html">Documentación de API</a>.</td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td>[!UICONTROL SWF]</td> 

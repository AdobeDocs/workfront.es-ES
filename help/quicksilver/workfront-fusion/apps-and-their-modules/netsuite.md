...
En un escenario de [!DNL Adobe Workfront Fusion], puede automatizar los flujos de trabajo que utilizan [!DNL NetSuite], así como conectarlo a varias aplicaciones y servicios de terceros.
...
Este módulo de acción le permite realizar una llamada autenticada personalizada a la API [!DNL NetSuite]. De este modo, puede crear una automatización del flujo de datos que no puedan realizar los otros [!DNL NetSuite] módulos.

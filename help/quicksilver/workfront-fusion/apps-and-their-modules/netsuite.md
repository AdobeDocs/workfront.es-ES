...
En un [!DNL Adobe Workfront Fusion] , puede automatizar los flujos de trabajo que utilizan [!DNL NetSuite], así como conectarlo a varias aplicaciones y servicios de terceros.
...
Al configurar [!DNL NetSuite] módulos, [!DNL Workfront Fusion] muestra los campos que se enumeran a continuación. Además de estos, se incluyen [!DNL NetSuite] pueden mostrarse los campos, en función de factores como el nivel de acceso en la aplicación o el servicio. Un título en negrita en un módulo indica un campo obligatorio.
...
Este módulo de acción le permite realizar una llamada autenticada personalizada al [!DNL NetSuite] API. De este modo, puede crear una automatización del flujo de datos que no se pueda lograr con la otra [!DNL NetSuite] módulos.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Para obtener instrucciones sobre cómo conectar su [!DNL NetSuite] cuenta de Workfront Fusion, consulte<a href="#create-a-connection-to-netsuite-in-a-workfront-fusion-netsuite-module" class="MCXref xref">Crear una conexión con [!DNL NetSuite] en un módulo de Workfront Fusion NetSuite</a> en este artículo.</p> </td> 
  </tr> 
  <tr> 

...
description: En un [!DNL Adobe Workfront Fusion] En este escenario, se pueden automatizar los flujos de trabajo que utilizan SharePoint y conectarlos a varias aplicaciones y servicios de terceros.
author: Becky
...
En un [!DNL Adobe Workfront Fusion] , puede automatizar los flujos de trabajo que utilizan [!DNL SharePoint], así como conectarlo a múltiples aplicaciones y servicios de terceros.
...
## Connect [!DNL SharePoint] hasta [!DNL Workfront Fusion] {#connect-sharepoint-to-workfront-fusion}

* [Connect [!DNL SharePoint] hasta [!DNL Workfront Fusion] uso de un [!DNL Microsoft] account](#connect-sharepoint-to-workfront-fusion-using-a-microsoft-account)
* [Connect [!DNL SharePoint] hasta [!DNL Workfront Fusion] uso de la configuración avanzada](#connect-sharepoint-to-workfront-fusion-using-advanced-settings)

### Connect [!DNL SharePoint] hasta [!DNL Workfront Fusion] uso de un [!DNL Microsoft] account

Puede usar su [!DNL Microsoft] cuenta para crear una conexión con [!DNL SharePoint]. Para obtener instrucciones acerca de cómo conectar su [!DNL Sharepoint] cuenta a [!DNL Workfront Fusion], consulte [Cree una conexión con [!DNL Adobe Workfront Fusion] - Instrucciones básicas](../../workfront-fusion/connections/connect-to-fusion-general.md)

### Connect [!DNL SharePoint] hasta [!DNL Workfront Fusion] uso de la configuración avanzada

Para conectar [!DNL SharePoint] hasta [!DNL Workfront Fusion] sin un [!DNL Microsoft] necesita un ID de cliente, un secreto de cliente y un ID de inquilino.

1. Clic **[!UICONTROL Añadir]** cerca de la parte superior del **[!DNL SharePoint]** para abrir el **[!UICONTROL Crear una conexión]** cuadro.

1. (Opcional) Cambiar el valor predeterminado **[!UICONTROL Nombre de conexión]**.
1. Clic **[!UICONTROL Mostrar configuración avanzada]**.
1. Introduzca el [!DNL SharePoint] **[!UICONTROL ID de cliente]** y **[!UICONTROL Secreto del cliente]**.
...
Al configurar [!DNL SharePoint] módulos, [!DNL Workfront Fusion] muestra los campos que se indican a continuación. Junto con estos, se añaden [!DNL SharePoint] Los campos pueden mostrarse, en función de factores como el nivel de acceso en la aplicación o el servicio. Un título en negrita en un módulo indica un campo obligatorio.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Para obtener instrucciones acerca de cómo conectar su [!DNL SharePoint] cuenta a [!DNL Workfront Fusion], consulte <a href="#connect-sharepoint-to-workfront-fusion" class="MCXref xref" data-mc-variable-override="">Connect [!DNL SharePoint] hasta [!DNL Workfront Fusion]</a> en este artículo.</p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar la ubicación de la carpeta en la que desea recuperar los cambios.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>, <strong>[!UICONTROL List ID]</strong>, y <strong>[!UICONTROL Identificador de carpeta]</strong> en los campos que aparecen.</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar la ubicación del archivo que desea obtener.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>, <strong>[!UICONTROL List ID]</strong>, y <strong>[!UICONTROL ID de archivo]</strong> en los campos que aparecen.</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar la ubicación del archivo que desea obtener.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>, <strong>[!UICONTROL List ID]</strong>, y <strong>[!UICONTROL folder ID]</strong> en los campos que aparecen.</p> </li> 
   ...
   <td>Introduzca el número máximo de elementos [!DNL Workfront Fusion] debe devolverse durante un ciclo de ejecución de escenario.</td> 
  <tr>
  </tr>
</tbody> 
</table>
...
* [[!UICONTROL Lista de elementos]](#list-items)
* [[!UICONTROL Mover elemento]](#move-an-item)
* [[!UICONTROL Actualizar un elemento]](#update-an-item)
* [[!UICONTROL Seguir artículos] (Programado)](#watch-items-scheduled)
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio y la lista que contiene el elemento que desea copiar.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>, <strong>[!UICONTROL List ID]</strong>, y <strong>[!UICONTROL Id. elemento]</strong> en los campos que aparecen.</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio y la lista donde desea crear un elemento.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong> y <strong>[!UICONTROL List ID]</strong> en los campos que aparecen.</p> </li> 
...
#### [!UICONTROL Seguir artículos] (Programado)
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio y la lista donde desea crear una lista.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong> donde desee crear una lista.</p> </li> 
  ...
  <tr> 
   ...
   <td>Para cada columna que desee establecer para la nueva lista, escriba un <strong>[!UICONTROL Nombre]</strong> para el campo y seleccione la opción <strong>[!UICONTROL Tipo]</strong> del valor que desea que tenga la nueva columna.</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio y la lista que contiene el elemento que desea obtener.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong> y <strong>ID de lista</strong> en los campos que aparecen.</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio del que desea recuperar listas.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>.</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio y la lista que desea ver.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong> donde se encuentra la lista que desea ver.</p> </li> 
...
>[!NOTE]
>
>API en la `beta` versión en [!DNL Microsoft Graph] están sujetos a cambios. No se admite el uso de estas API en aplicaciones de producción.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar la página que desea recuperar.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>y <strong>[!UICONTROL Id. de página]</strong>.</p> </li> 
...
Este módulo de acción busca los sitios según un parámetro especificado.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione cómo desea identificar el sitio y la lista que contiene el elemento que desea actualizar.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Entrar manualmente]</strong> </p> <p>Introduzca o asigne el <strong>[!UICONTROL Id. de sitio]</strong>, <strong>[!UICONTROL Id. de unidad]</strong>, y <strong>[!UICONTROL Identificador de carpeta]</strong> en los campos que aparecen.</p> </li> 

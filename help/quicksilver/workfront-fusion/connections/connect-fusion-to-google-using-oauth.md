...
* [Creación de un proyecto en [!DNL Google Cloud Platform]](#create-a-project-on-google-cloud-platform)
* [Configurar [!UICONTROL Consentimiento de OAuth] configuración](#configure-oauth-consent-settings)

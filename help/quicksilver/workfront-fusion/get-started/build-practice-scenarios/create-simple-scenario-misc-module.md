...
title: Cree un escenario sencillo en [!DNL Adobe Workfront Fusion]
...
1. En el [!UICONTROL Tipo de registro] , seleccione **[!UICONTROL Problema]**. Esto configura el módulo para que solo busque problemas.
...
1. En el **[!UICONTROL Criterios de búsqueda]** , configure los criterios para devolver el problema específico.
   ...
   1. En el último campo debajo de [!UICONTROL Criterios de búsqueda], introduzca una palabra o frase que sepa que está en el nombre del problema que está buscando.
...
1. Haga clic con el botón derecho en el módulo y seleccione **[!UICONTROL Cambiar nombre]**, escriba un nombre y describa lo que desea que haga el módulo (por ejemplo, &quot;Buscar un problema&quot;) y haga clic en **[!UICONTROL OK]**.
...
1. Seleccionar [!DNL Adobe Workfront] en la lista de aplicaciones, elija el módulo **[!UICONTROL Misc Action]**.
...
1. En el **[!UICONTROL Tipo de registro]**field, seleccione **[!UICONTROL Problema]**, porque la acción que se va a realizar está relacionada con un problema.
1. En el **[!UICONTROL Acción]** , seleccione **convertToProject**. Esta es la acción que convertirá el problema seleccionado en un proyecto.
1. Haga clic en **[!UICONTROL ID]** field.

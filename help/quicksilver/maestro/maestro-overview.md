...
Para obtener más información sobre cómo conceder acceso a Maestro y permitir que otros utilicen el programa, vea [Conceder acceso a Adobe Maestro](../maestro/access/grant-access.md).

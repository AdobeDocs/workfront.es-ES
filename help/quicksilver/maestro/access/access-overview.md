...
description: Existen restricciones de licencia y permiso de uso compartido para utilizar las funcionalidades de planificación de Adobe Workfront.
hidefromtoc: true
hide: true
...
Existen restricciones de licencia y permiso de uso compartido para utilizar las funcionalidades de planificación de Adobe Workfront.

## Requisitos de acceso

Debe tener la siguiente configuración para utilizar las funciones de planificación en Adobe Workfront:
...
<td>
 ...
 <td role="rowheader"><p>acuerdo con Adobe Workfront</p></td>
   <td>
<p>Su organización debe estar inscrita en el programa beta cerrado de capacidades de planificación de Adobe Workfront. </p>
   </td>
  </tr>
  <tr>
...
<p>Cualquiera</p>
  ...
  <tr>
   ...
   <td> <p>No hay controles de nivel de acceso para los objetos de capacidades de planificación</p>  
</td>
  </tr>
<tr>
   ...
   <p>Para obtener información sobre los permisos de uso compartido para los objetos de capacidades de Planning, consulte  
   <a href="../access/sharing-permissions-overview.md">Información general sobre los permisos de uso compartido en las funciones de planificación de Adobe Workfront</a> 
  </td>
  </tr>
<tr>
...
Una vez que su organización se haya inscrito en el programa beta de funciones de planificación de Workfront, puede agregar el área de Maestro al menú principal de todos los usuarios mediante una plantilla de diseño.
...
1. Asigne la plantilla de diseño a los usuarios que desea que tengan acceso a las funciones de planificación de Workfront.
...
No hay controles de acceso para las funciones de planificación en Workfront.

Los usuarios con cualquier tipo de licencia pueden acceder a las funciones de planificación de Workfront.
...
Para obtener más información, consulte [Información general sobre los permisos de uso compartido en las funciones de planificación de Adobe Workfront](/help/quicksilver/maestro/access/sharing-permissions-overview.md).

El tipo de licencia de Adobe Workfront funciona junto con los permisos de las capacidades de planificación para que pueda ver, contribuir o administrar objetos de las capacidades de planificación.

---
title: Compartir un espacio de trabajo
description: Puede compartir un área de trabajo con otros usuarios para garantizar la colaboración al trabajar en Adobe Workfront Maestro.
hidefromtoc: true
hide: true

...
Para obtener más información sobre los cuadros de mandos y cómo crearlos, consulte [Crear un cuadro de mandos](../../../administration-and-setup/set-up-workfront/configure-system-defaults/create-scorecard.md).
...
Para obtener más información acerca de la optimización del portafolio, consulte [Descripción general de Portfolio Optimizer](../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md).
...
Para obtener más información acerca de los permisos del proyecto, vea [Compartir un proyecto en Adobe Workfront](../../../workfront-basics/grant-and-request-access-to-objects/share-a-project.md).
...
1. Busque la sección **informe de valoración** del caso empresarial.\
   Debe crear un cuadro de mandos antes de que se muestre la sección **Cuadro de mandos** en el caso comercial.

   Para obtener información acerca de cómo crear un cuadro de mandos, vea [Crear un cuadro de mandos](../../../administration-and-setup/set-up-workfront/configure-system-defaults/create-scorecard.md).
...
1. Escriba una respuesta para todas las preguntas del informe de valoración.
   ...
   Para obtener más información sobre cómo generar la puntuación de alineación general del proyecto, vea [Generar una puntuación de alineación para un proyecto](#generate-an-alignment-score-for-a-project).
...
Para obtener más información, vea [Crear un cuadro de mandos](../../../administration-and-setup/set-up-workfront/configure-system-defaults/create-scorecard.md).
...
Puede ver la puntuación de alineación de un proyecto en el nivel de proyecto si tiene derechos de Contribute para el proyecto.

1. Vaya al proyecto cuya puntuación de alineación desee ver.
1. Haga clic en **Caso comercial** en el panel izquierdo.
1. Vaya a **Resumen de caso empresarial** en el lado derecho de la pantalla.

   La puntuación de alineación se encuentra en el resumen del caso empresarial, en el valor **Alignment**.
...
Para obtener más información acerca de la información mostrada en Portfolio Optimizer, consulte [Descripción general de Portfolio Optimizer](../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md).
...
1. Haga clic en **Optimización de Portfolio** en el panel izquierdo.

   Se muestra Portfolio Optimizer.

   La puntuación de alineación de un proyecto se muestra como un porcentaje en la columna **Alignment** de Portfolio Optimizer.
...
1. Haga clic en el nombre de un portafolio.
1. Haga clic en **Optimización de Portfolio** en el panel izquierdo.
1. En la parte superior del Optimizador de Portfolio se encuentra el valor **Alignment**, así como el indicador **Alignment**, que indica la puntuación de alineación del portafolio.

   Esta es la puntuación de alineación del portafolio.

   Para obtener más información sobre cómo se genera la puntuación de alineación de un portafolio, consulte [Generar una puntuación de alineación para un portafolio](#generate-an-alignment-score-for-a-portfolio).
...
La puntuación de alineación de un proyecto se muestra en la columna **Alignment** de Portfolio Optimizer.

La puntuación del optimizador de portafolios es una clasificación calculada automáticamente en Portfolio Optimizer mediante la cual se pueden priorizar los proyectos. La puntuación del optimizador de portafolios se muestra como un icono indicador acompañado de un número y se muestra en la columna **Puntuación** de Portfolio Optimizer. Solo se genera una puntuación de Portfolio Optimizer cuando se completan todas las secciones del caso empresarial, excepto los objetivos.

Para obtener más información sobre cómo crear un caso empresarial para un proyecto, vea [Crear un caso empresarial para un proyecto](../../../manage-work/projects/define-a-business-case/create-business-case.md).

Para obtener más información sobre cómo calcular la puntuación del optimizador de portafolios de un proyecto, consulte [Información general sobre la puntuación del optimizador de Portfolio](../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-score.md).

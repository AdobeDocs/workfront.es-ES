...
1. **IRC para la tarea 3** = 0,38 calculado de la siguiente manera:\
...
1. **EAC para el proyecto** = 224,49 horas calculado de la siguiente manera:\
   **EAC para el proyecto** = *IF* CPI &lt;> 0 *THEN* EAC = CPI/Horas planificadas\
   *ELSE* EAC = Horas planificadas + Horas reales\
...
1. **CPI**&#x200B;**&#x200B; de la tarea 1** = 0,14 calculado de la siguiente manera:\
   **IRC** **para la tarea 1** = *IF* Costo de mano de obra real + IncurredActualExpenseCost &lt;> 0 *THEN*
   ...
   * ELSE* IPC = CPI_Labor\
     ...
     **IRC** **para la tarea 1** = .14&#x200B;**&#x200B;**

1. **EAC**&#x200B;**de la tarea 1** = 13 400,00 $\
   **Mano de obra CPI** **para la tarea 1** = IF Costo de mano de obra real &lt;> 0 THEN

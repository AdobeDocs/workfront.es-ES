...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Administrar permisos para una plantilla. </p> <p>Permisos de contribución o superiores para la tarea de plantilla.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. (Opcional) Para editar varias tareas de plantilla de forma masiva, seleccione varias tareas de plantilla y haga clic en **Editar** en la parte superior de la lista de plantillas.
1. (Condicional) Para editar información limitada sobre una tarea de plantilla, haga clic en **Detalles de tarea de plantilla** en el panel izquierdo, vaya a las áreas de la sección Detalles para editar la información de cada área.
1. (Opcional) Haga clic en **Contraer todo** icono ![](assets/collapse-all-icon.png) para contraer todas las áreas.
...
1. (Condicional) Para editar toda la información sobre la tarea de plantilla, haga clic en **Más** menú ![](assets/qs-more-icon-on-an-object.png) junto al nombre de la tarea de plantilla y haga clic en **Editar**.

   El **Editar tarea de plantilla** aparece el cuadro.
     ...
     <tr> 
      ...
      <td> <p>La tarea futura creada a partir de esta plantilla tendrá este tipo de duración. <br>Tipo de duración identifica la relación entre lo siguiente:</p> <p>- número de recursos asignados a una tarea</p> <p>- el esfuerzo total necesario para completar la tarea</p> <p>- la duración total de la tarea. </p> <p>Los tipos de duración permiten establecer asignaciones de recursos coherentes según las necesidades de la tarea. Para obtener más información sobre el tipo de duración de una tarea, consulte <a href="../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md" class="MCXref xref">Información general sobre la duración y el tipo de duración de la tarea</a>.</p> <p>Seleccione entre las siguientes opciones:</p> 
       <ul> 
        ...
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Impulsado por el esfuerzo</span> </p> </li> 
   ...
   <tr> 
      ...
      <td> <p>La tarea en el proyecto creado a partir de esta plantilla tendrá esta restricción. Las restricciones de tarea identifican cuándo se debe completar una tarea. </p> <p>Seleccione entre las siguientes opciones:</p> 
       <ul> 
        ...
        <li><strong>Debe comenzar el</strong>. Especifique un <strong>Fecha planificada de inicio.</strong></li> 
        <li><strong>Debe finalizarse el</strong>. Especifique un <strong>Fecha planificada de finalización</strong>.</li> 
        ...
        <li>No iniciar después del. Especifique un <strong>Fecha planificada de inicio</strong>.</li> 
        <li><strong>No iniciar antes del</strong>. Especifique un <strong>Fecha planificada de inicio</strong>.</li> 
        <li><strong>No terminar después de</strong>. Especifique un <strong>Fecha planificada de finalización</strong>.</li> 
        <li><strong>No terminar antes del</strong>. Especifique un <strong>Fecha planificada de finalización</strong>.</li> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>Especifique el Tipo de ingresos para la tarea futura. Esto determina cómo se calculan los ingresos de la tarea, en función del número de horas de las tareas.</p> <p style="font-weight: normal;">Seleccione entre las siguientes opciones: </p> 
       ...
       </ul> <p>Para obtener más información sobre el seguimiento de ingresos, consulte <a href="../../../manage-work/projects/project-finances/billing-and-revenue-overview.md" class="MCXref xref">Resumen de facturación e ingresos</a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
   ...
   <p>Debe asociar una trayectoria del hito con una plantilla para que este campo se muestre. Para obtener más información, consulte <a href="../create-and-manage-templates/edit-templates.md">Editar plantillas de proyecto</a>.</p> 
     ...
     <tr> 
      ...
      <td> <p>Seleccione el proceso de aprobación que desea asociar con la tarea de plantilla. El administrador de Workfront debe definir los procesos de aprobación de tareas en el nivel del sistema para poder asociarlos a tareas de plantilla. <span>Un usuario con acceso administrativo a los procesos de aprobación también puede crear procesos de aprobación específicos del grupo.</span> Para obtener más información sobre la creación de procesos de aprobación, consulte <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-approval-processes.md" class="MCXref xref">Crear un proceso de aprobación para elementos de trabajo</a>.</p> <p>Tenga en cuenta lo siguiente al añadir procesos de aprobación: </p> 
       ...
       <li> <p>Cuando alguna de las tareas de plantilla tiene adjunto un proceso de aprobación de un solo uso, se reemplaza por el nivel de sistema <span>o proceso de aprobación a nivel de grupo</span> seleccione. </p> </li> 
       </ul> </li> 
       </ul> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>Notificaciones de recordatorio</strong> </td> 
      <td> <p>Seleccione las notificaciones de recordatorio que desee adjuntar a la tarea de plantilla. Se adjuntarán a las tareas futuras del proyecto creadas a partir de esta plantilla. El administrador del sistema debe configurar las notificaciones de recordatorio para poder seleccionarlas en una tarea. Para obtener más información sobre la configuración de notificaciones de recordatorio, consulte <a href="../../../administration-and-setup/manage-workfront/emails/set-up-reminder-notifications.md" class="MCXref xref">Configuración de notificaciones de recordatorio</a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. (Condicional y opcional) Si la restricción de tarea es simple, especifique la variable **Duración** de la tarea de plantilla en días. Esta será la duración de la tarea creada a partir de esta plantilla.
1. (Opcional) Seleccione una función de la lista **Rol de asignado** menú desplegable. Esta es la función que el usuario asignado puede desempeñar en esta tarea futura. En el menú desplegable solo aparecen los roles asociados con cada usuario asignado en su perfil.
1. (Opcional) Siga editando las secciones siguientes, según la información que desee modificar.
...
Puede definir formularios personalizados predeterminados que se adjuntarán automáticamente a las tareas cuando estas se agreguen a un proyecto. Para obtener información sobre la configuración del proyecto para incluir formularios personalizados de tareas predeterminados, consulte la sección &quot;Tareas&quot; en el artículo [Editar proyectos](../../../manage-work/projects/manage-projects/edit-projects.md).
...
1. (Condicional y opcional) Si adjuntó un formulario personalizado a la tarea de plantilla, edite los campos del formulario. Debe especificar todos los campos obligatorios antes de guardar la tarea de plantilla.
   ...
   >Para obtener información sobre la configuración de permisos de plantillas, consulte [Compartir una plantilla](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md).

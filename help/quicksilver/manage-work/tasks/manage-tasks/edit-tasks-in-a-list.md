...
1. (Opcional) Haga clic con el botón derecho en una tarea que desee modificar.
   ...
   Haga clic en el icono **Más** del menú ![Más en la lista de tareas](assets/more-icon-task-list.png) a la derecha del nombre de la tarea.
...
1. (Opcional) Haga clic con el botón derecho en una tarea que desee modificar.
   ...
   Haga clic en el icono de **Más** menú ![Modo en la lista de tareas](assets/more-icon-task-list.png).
...
1. Haga clic en una tarea de la lista y, a continuación, arrástrela y suéltela en una posición diferente en la cronología.

   Al hacer clic en una tarea principal para cambiar su posición, también se mueven todos los elementos secundarios.

   Workfront actualiza todas las dependencias dentro del proyecto y entre proyectos cuando realiza cambios en la cronología de las tareas.
...
1. (Opcional) Haga clic con el botón derecho en una tarea que desee modificar.
   ...
   Haga clic en el icono **Más** del menú ![Más en la lista de tareas](assets/more-icon-task-list.png).
...
1. Haga clic en cualquiera de los siguientes iconos o áreas para ir a la tarea y editar la información en el nivel de tarea:
   ...
   <table style="table-layout:auto"> 
      ...
      <tr> 
         ...
         <p><b>NOTA</b></p>
         <p>Si su organización utiliza el almacenamiento en la nube de Adobe para documentos, no puede agregar documentos a tareas en el Panel de resumen para tareas de almacenamiento en la nube de Adobe.</p>

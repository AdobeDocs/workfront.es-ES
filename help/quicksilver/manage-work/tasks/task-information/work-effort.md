...
* Cuando las tareas del proyecto tienen 0 horas planificadas y habilita la opción Usar esfuerzo de trabajo para calcular automáticamente la configuración de horas planificadas de la tarea en el proyecto y luego actualiza el nivel de esfuerzo de trabajo de medio a pequeño o grande, las horas planificadas también se actualizan. Para obtener más información, consulte la sección [Cómo calcula Workfront las horas planificadas en función del esfuerzo de trabajo](#how-workfront-calculates-planned-hours-based-on-work-effort) en este artículo.
...
* Cuando se actualiza el valor Esfuerzo de trabajo de una tarea, la duración ya no se calcula automáticamente según las horas planificadas. Para obtener más información acerca de cómo calcula Duración para tareas de Duración simple, vea [Información general del tipo de duración: Simple](../../../manage-work/tasks/taskdurtn/simple-duration-type.md).
...
* No se puede actualizar el nivel de esfuerzo de trabajo en una tarea principal. El nivel de esfuerzo de trabajo de una tarea principal se calcula automáticamente en función del número de horas planificadas para las tareas, que es un resumen de todas las tareas secundarias. Para obtener información sobre las tareas principales, consulte [Creación de subtareas](../../../manage-work/tasks/create-tasks/create-subtasks.md).

## Habilitar mediante esfuerzo de trabajo en lugar de horas planificadas

1. Vaya a un proyecto y haga clic en **Más** menú ![](assets/more-icon.png), luego haga clic en **Editar**.
1. Clic **Configuración de tarea**, luego seleccione la opción **Utilizar Esfuerzo de trabajo para calcular automáticamente las horas planificadas para la tarea**. De forma predeterminada, esta opción no está seleccionada.

   ![](assets/nwe-work-effort-on-projects-350x182.png)

   Para obtener más información sobre cómo habilitar el uso del esfuerzo de trabajo en un proyecto, consulte la sección &quot;Configuración de tareas&quot; en la [Editar proyectos](../../../manage-work/projects/manage-projects/edit-projects.md) artículo.

1. Clic **Tareas** en el panel izquierdo, haga clic en el nombre de una tarea para acceder a ella.
1. Haga clic en **Más** menú ![](assets/more-icon.png), luego haga clic en **Editar**. Asegúrese de que la tarea tenga un Tipo de duración simple.

   >[!TIP]
   >
   >También puede actualizar el esfuerzo de trabajo de una tarea en la sección Detalles de la tarea.

1. En el **Información general** , haga clic en el menú desplegable Esfuerzo de trabajo para corregir la cantidad de esfuerzo necesario para completar la tarea.
   ...
   * La sección &quot;Información general&quot; en la [Editar tareas](../../../manage-work/tasks/manage-tasks/edit-tasks.md) artículo
...
Como administrador de Workfront, puede definir las horas típicas por día laborable en el área de Preferencias de proyecto de Configuración. Es la cantidad diaria de tiempo que se considera tiempo de trabajo. Para obtener información sobre la configuración de las Preferencias del proyecto para su instancia de Workfront, consulte [Configurar las preferencias de proyecto de todo el sistema](../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md).
...
Por ejemplo, una tarea con una duración de 3 días y un esfuerzo de trabajo medio tiene 12 horas planificadas:
...
Por ejemplo, si tiene una tarea con una Duración de 2 días y actualiza las Horas planificadas de 8 a 20 horas, el Esfuerzo de trabajo de la tarea se actualiza de medio a grande:

...
* **Cuando un problema está asociado a una cola de solicitudes:** Cuando copia un problema en otro objeto y el problema está asociado a una cola de solicitudes, el problema copiado ya no está asociado a la cola original desde la que se originó el primer problema.
* **Cuando se adjunta un documento al problema:** Cuando copia un problema en otro objeto y el problema tiene un documento adjunto, el documento y sus versiones también se trasladan al nuevo problema. Las pruebas o aprobaciones asociadas con el documento no se mueven.
...
1. Si ha seleccionado ir a un proyecto, haga clic en **Problemas** en el panel izquierdo.
1. Seleccione el problema o problemas que desee copiar y haga clic en el icono **Menú Más** en la parte superior de la lista de problemas y haga clic en **Copiar a**.

   ![](assets/copy-issue-in-list-nwe-350x169.png)

1. Siga copiando el problema, tal como se describe en la sección [Copiar un solo problema](#copy-a-single-issue) a partir del paso 2.
...
1. Vaya al problema que desee copiar y haga clic en el icono **Más** menú ![](assets/more-icon.png) a la derecha del nombre del problema, **Copiar** hasta.

   ![](assets/nwe-copy-at-issue-level-highlighted-350x580.png)

   El **Copiar problema** aparece el cuadro.
...
1. (Opcional) En el **Opciones** , anule la selección de cualquiera de los elementos enumerados en la tabla siguiente para eliminarlos del nuevo problema. Todas las opciones están seleccionadas de forma predeterminada.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><span style="line-height: 1.5;">Quita todo lo que hay en la ficha de documentos, incluidas las versiones de los documentos, los documentos vinculados y las carpetas.</span> <br>De forma predeterminada, las revisiones y aprobaciones de documentos no se pueden copiar en otro problema.</td> 
     </tr> 
     <tr> 
...
1. (Opcional) En el **Seleccionar tarea** , seleccione la tarea a la que desea mover el problema.
1. Clic **Copiar problema** o **Copiar problemas** si seleccionó varios problemas en una lista.

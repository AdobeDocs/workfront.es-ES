...
1. Clic [!UICONTROL **Forms personalizado**] y realice una de las acciones siguientes:
   ...
   * Haga clic en **x** a la derecha de cualquier formulario que no desee transferir al proyecto. Esto quita el formulario del proyecto.
...
1. (Opcional) Pase el ratón sobre el nombre de una plantilla y haga clic en **Favoritos** icono ![](assets/favorites-icon-small.png) para marcarlo como favorito para uso futuro.

...
description: Puede exportar el diagrama de Gantt a un PDF. Después de exportar el diagrama de Gantt a PDF, puede imprimirlo o adjuntarlo a un correo electrónico para compartirlo con otros usuarios.
author: Alina
...
1. Asegúrese de haber configurado el [!UICONTROL gráfico Gantt] para que muestre la información adecuada antes de exportarlo.
   ...
   * Haga clic en el icono **Configuración** ![](assets/settings-icon.png) en la esquina superior derecha del gráfico Gantt y seleccione la información que desee ver en el gráfico. Una vez seleccionada, esta información se incluye en el archivo del PDF Gantt exportado.
...
1. Haga clic en el icono de impresora ![](assets/printer-icon.png) en la esquina superior derecha del gráfico Gantt.

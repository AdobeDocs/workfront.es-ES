...
description: Puede exportar el diagrama de Gantt a una PDF. Después de exportar el gráfico Gantt a PDF, puede imprimirlo o adjuntarlo a un correo electrónico para compartirlo con otros usuarios.
author: Alina
...
Puede exportar el [!UICONTROL gráfico Gantt] a un PDF.

Después de exportar el [!UICONTROL gráfico Gantt] a PDF, puede imprimirlo o adjuntarlo a un correo electrónico para compartirlo con otros usuarios.
...
1. Asegúrese de haber configurado el [!UICONTROL gráfico Gantt] para que muestre la información adecuada antes de exportarlo.
   ...
   * Haga clic en el icono **Configuración** ![Icono de configuración](assets/settings-icon.png) en la esquina superior derecha del diagrama de Gantt y seleccione la información que desee ver en el diagrama de Gantt. Una vez seleccionada, esta información se incluye en el archivo Gantt PDF exportado.
     ...
     >[!NOTE]
     >
     > Las asignaciones no se muestran en el [!UICONTROL gráfico Gantt] cuando el [!UICONTROL gráfico Gantt] se exporta a PDF. Cuando se exporta el [!UICONTROL gráfico Gantt] a PDF, las asignaciones solo se muestran en la vista de lista.
...
1. En la sección **Exportar**, seleccione entre las siguientes opciones para indicar si desea exportar sólo lo que ve o todo el [!UICONTROL gráfico Gantt]:
   ...
   * **[!UICONTROL Lo que veo]:** Exporta todas las tareas (incluidas las subtareas) que se muestran en la pantalla antes de exportar un máximo de 500 elementos. (Esto no es lo que se muestra en la sección **[!UICONTROL Previsualización]**; la sección [!UICONTROL Previsualización] contiene solo datos de muestra).
   ...
   * **[!UICONTROL Varias páginas]:** Exporta todo el [!UICONTROL gráfico Gantt], incluso el que no esté visible en la pantalla actual hasta 500 elementos.
     ...
     >[!NOTE]
     >
     >* Puedes usar el menú desplegable **[!UICONTROL Zoom To]** o la herramienta de deslizador para determinar cuánta información se muestra en cada página, como se describe en [Configurar cómo se muestra la información en el [!UICONTROL diagrama de Gantt]](../../../manage-work/gantt-chart/use-the-gantt-chart/configure-info-on-gantt-chart.md). Selecciona una opción más detallada para mostrar más páginas para exportar, o selecciona una opción menos detallada para mostrar menos páginas para exportar.
     >
     >* Si necesitas exportar un [!UICONTROL diagrama de Gantt] que contiene más de 500 elementos, aplica un filtro a la lista antes de ver el [!UICONTROL diagrama de Gantt] para que se muestren menos de 500 elementos o 250 páginas. Para obtener información sobre cómo aplicar un filtro, consulte [Descripción general de filtros](../../../reports-and-dashboards/reports/reporting-elements/filters-overview.md).
     >
     >
...
1. Si el PDF se imprimirá después de exportarlo a PDF, en el menú desplegable **[!UICONTROL Tamaño de página]**, seleccione el tamaño de papel en el que desea imprimir.
...
1. Haga clic en **[!UICONTROL Exportar]**.
   ...
   El PDF del [!UICONTROL Gráfico de Gantt] se crea y se descarga en su ordenador.

   Observe la leyenda que aparece en la parte inferior del archivo exportado. Explica solo las opciones que se han habilitado en su [!UICONTROL Gráfico de Gantt] y que están disponibles en la lista de tareas.

...
La lista de tareas [!UICONTROL Diagrama de Gantt] muestra detalles acerca de las tareas que se encuentran en un proyecto o plantilla.

En una plantilla, la lista de tareas [!UICONTROL Diagrama de Gantt] refleja las actualizaciones realizadas en la lista de tareas de la plantilla en el nivel de tarea. No puede editar el [!UICONTROL gráfico Gantt] asociado a una plantilla.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Acceso de [!UICONTROL Manage] al proyecto y a las tareas </p> <p>Para obtener información sobre cómo solicitar acceso adicional, vea <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Solicitar acceso a los objetos </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Haga clic en el icono **[!UICONTROL Diagrama de Gantt]**.
...
1. (Opcional y condicional) Si ha seleccionado guardar manualmente sus cambios, haga clic en los iconos **[!UICONTROL Deshacer]** o&#x200B;**[!UICONTROL Rehacer]** si desea cancelar o duplicar cualquiera de los cambios.
   ...
   >   * [!DNL Windows]: usa [!UICONTROL Ctrl + Z] para deshacer y [!UICONTROL Ctrl + Y] para rehacer.
   >   
   >
...
1. En el área **[!UICONTROL Tareas]**, haga clic en el icono **[!UICONTROL Diagrama de Gantt]**.
   ...
   La opción **[!UICONTROL Guardar automáticamente]** está seleccionada de forma predeterminada, en cuyo caso todos los cambios se guardan automáticamente.
...
1. Para eliminar una relación de predecesora, haz clic en una línea de predecesora que conecte dos tareas para seleccionarla y, a continuación, pulsa **[!UICONTROL Eliminar]** en el teclado.\
   ![Eliminar_predecesor.png](assets/delete-predecessor-350x152.png)

1. (Opcional y condicional) Si seleccionó guardar los cambios manualmente, haga clic en los iconos **[!UICONTROL Deshacer]** o&#x200B;**[!UICONTROL Rehacer]** si desea cancelar o duplicar cualquiera de los cambios.
...
1. Haga clic en la tarea y arrástrela a la fecha deseada.
   ...
   ![Cambiar fecha_inicial_final.png](assets/change-start-end-date.png)

1. Si cambia la fecha de la tarea de forma que afecte a la restricción de la tarea, haga clic en **[!UICONTROL Aceptar]** para confirmar el cambio de la restricción de la tarea.

   >[!NOTE]
   >
   >Si la tarea tiene una de las restricciones siguientes, el sistema actualiza la [!UICONTROL Restricción de tarea] a [!UICONTROL No comenzar antes] de que si el proyecto está programado desde la [!UICONTROL Fecha de inicio] o [!UICONTROL No finalizar después de] si el proyecto está programado desde la [!UICONTROL Fecha de finalización]:
   >
   >   
   >   
   ...
   >   * [!UICONTROL Última hora disponible]
   >   
   >   
...
1. (Opcional y condicional) Si ha seleccionado guardar los cambios manualmente, haga clic en los iconos **[!UICONTROL Deshacer]** o&#x200B;**[!UICONTROL Rehacer]** si desea cancelar o duplicar cualquiera de los cambios.
...
1. Haga doble clic en el número porcentual dentro de la tarea e introduzca el número.
   ...
   >[!IMPORTANT]
   >
   >Debe tener seleccionado [!UICONTROL % completado] en el cuadro de diálogo [!UICONTROL Opciones] para actualizar el porcentaje completado. Para ello, haga clic en el icono **[!UICONTROL Opciones]** y seleccione **[!UICONTROL % completado]**.
   >
   >
   >![actualizar_porcentaje_completado.png](assets/update-percent-complete-350x175.png)   >
   >
...
Para obtener información acerca de la redistribución de recursos en el [!UICONTROL gráfico Gantt], vea [Nivelar recursos en el [!UICONTROL gráfico Gantt]](../../../manage-work/gantt-chart/use-the-gantt-chart/level-resources-in-gantt.md).

...
1. <span class="preview">En el campo **Opciones predeterminadas**, seleccione las opciones que desee mostrar en este campo de forma predeterminada. Puede elegir más de una opción. Los usuarios pueden quitar las opciones predeterminadas al actualizar este campo.</span>
...
1. (Opcional) Pase el ratón sobre el nombre del campo en la vista de tabla, haga clic en el menú desplegable situado a la derecha del nombre del campo y, a continuación, haga clic en **Editar campo**.
1. Active la configuración **Mostrar valores** para mostrar los valores de cada opción. Los valores son los nombres de cada opción, tal como aparecen en la base de datos de Workfront.

   >[!NOTE]
   >
   >* Workfront asigna valores únicos a cada opción.
   >
   >* Los valores coinciden con el nombre de la opción en formato de minúsculas. Las palabras múltiples se separan con un guion bajo.
   >
   >* Los valores se pueden repetir entre varios campos, pero deben ser únicos para un campo.
   >
   > ![Mostrar alternancia de valor](assets/show-values-toggle-and-choices-with-values.png)

1. (Opcional) Utilice los valores de opción en sus llamadas de API y otras integraciones.
...
1. <span class="preview">En el campo **Opción predeterminada**, seleccione la opción que desee mostrar en este campo de forma predeterminada. Solo puede elegir una opción. Los usuarios pueden eliminar la opción predeterminada al actualizar este campo. </span>
...
Puede utilizar el tipo de campo Personas para agregar un usuario a un registro. Este es un campo de escritura anticipada y solamente puede añadir usuarios de <!--, roles, or teams--> que ya existen en su instancia de Workfront.

>[!TIP]
>
>* Cuando se añade el nombre de un usuario en un campo Personas, su función de trabajo principal y su correo electrónico también se muestran en el campo. Debe tener activada la configuración Ver información de contacto para el objeto Usuarios en su nivel de acceso para poder ver el correo electrónico del usuario.
>
>* Solo los usuarios que se han añadido a Adobe Admin Console se muestran en los campos Personas. Los usuarios de Workfront no se muestran al intentar agregarlos en un campo Personas.
>
...
1. <span class="preview">En el campo **Usuario predeterminado** o **Usuarios predeterminados**, seleccione los usuarios que desee mostrar en este campo de forma predeterminada. </span>

   <span class="preview">Puede elegir más de un usuario si también seleccionó la opción **Permitir varios valores**. </span>

   <span class="preview">Los usuarios pueden quitar los usuarios predeterminados a medida que actualizan este campo.</span>

   >[!TIP]
   >
   ><span class="preview">Al desactivar usuarios seleccionados como predeterminados en esta configuración, se conservan los nombres de los usuarios como predeterminados. No quita el usuario desactivado del valor del campo y no hay ninguna indicación para otros de que el usuario se haya desactivado.</span>
...
Puede utilizar el tipo de campo Id. de registro para mostrar un identificador de solo lectura generado por el sistema para cada registro.

Cuando se crea, el campo de ID de registro se rellena automáticamente con un valor alfanumérico. Puede utilizarlo en campos de fórmula y en integraciones de API para identificar cada registro de forma exclusiva.

No se puede modificar manualmente el valor de un campo de Id. de registro.

1. Comience a crear un campo como se describe en la sección [Crear campos desde cero](#create-fields-from-scratch) de este artículo y, a continuación, seleccione el tipo de campo **Id. de registro**.

   ![Tipo de campo de id. de registro](assets/record-id-field-type.png)
...
1. Haga clic en **Crear**.
   ...
   El nuevo campo de tipo Record ID se agrega como una columna al tipo de registro y sus valores se rellenan previamente con un valor alfanumérico.

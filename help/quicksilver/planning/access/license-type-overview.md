...
Existen limitaciones en cuanto a la cantidad de objetos de Workfront Planning que puede tener. Para obtener más información, consulte [Resumen de las limitaciones de objetos de Adobe Workfront Planning](/help/quicksilver/planning/general/limitations-overview.md).

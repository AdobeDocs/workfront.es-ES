...
1. Agregue un tipo de registro de uno existente que se haya configurado como tipo de registro centralizado a un espacio de trabajo secundario.
...
* Sólo puede eliminar un tipo de registro centralizado si no se ha agregado a un espacio de trabajo secundario. Una vez añadido a otro espacio de trabajo, al intentar eliminarlo del espacio de trabajo original se genera un error.
...
* Los registros que agregue desde un espacio de trabajo secundario se acumulan y se muestran en el espacio de trabajo original. Todos los miembros del espacio de trabajo original obtienen permisos de visualización.
...
* Los campos creados para un tipo de registro centralizado desde el espacio de trabajo original son visibles desde todos los espacios de trabajo en los que se ha añadido el tipo de registro. Los campos de un espacio de trabajo original son de sólo lectura en los espacios de trabajo secundarios.

### Consideraciones sobre los tipos de registros centralizados después de agregarlos a un espacio de trabajo secundario

* Los colaboradores secundarios del espacio de trabajo obtienen permiso de contribución para el tipo de registro centralizado en el espacio de trabajo de su equipo. Pueden agregar y administrar registros en él.

* Los visualizadores de espacio de trabajo secundario obtienen permiso de visualización para el tipo de registro centralizado en el espacio de trabajo de su equipo. No pueden agregarlo y administrarlo registros en.

* Los gestores de espacio de trabajo secundario pueden realizar las siguientes acciones en el tipo de registro añadido desde un tipo de registro centralizado en un espacio de trabajo secundario:
...
* No puede realizar las siguientes acciones en el tipo de registro añadido desde un tipo de registro centralizado en un espacio de trabajo secundario:
...
* Los registros añadidos en espacios de trabajo secundarios son visibles desde los siguientes espacios de trabajo, si tiene permisos de Vista o superiores en estos espacios de trabajo:

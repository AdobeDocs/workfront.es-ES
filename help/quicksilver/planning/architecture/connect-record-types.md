...
1. Haga clic en el icono **+** de la esquina superior derecha de la vista de tabla y, a continuación, en la pestaña **Nueva conexión**.
   ...
   ![Nueva ficha de conexión con las marcas Workfront, AEM y GenStudio](assets/new-connection-tab-with-workfront-aem-options-gens-brands-etc.png)
...
1. Busque un tipo de registro o seleccione una de las siguientes opciones:
   ...
   * **Experience Manager** de la sección **Aplicaciones Adobe** para conectar con AEM Assets o fragmentos de contenido.

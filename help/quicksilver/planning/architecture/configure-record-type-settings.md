...
description: Además de editar un tipo de registro en el cuadro Editar tipo de registro, también puede editar tipos de registros en la página Configuración.
...
En función de las funciones que desee definir para un tipo de registro, puede configurar opciones adicionales mediante uno de los procedimientos siguientes:
...
O
<li><p>Cualquier paquete de flujo de trabajo y un paquete de Planning Prime o Ultimate</p></li>
O
<li>Un paquete de Planning Prime o independiente cuando se adquiere como producto independiente </li>
...
1. Realice una de las siguientes acciones:
   ...
   * Pase el ratón sobre la tarjeta de un tipo de registro y haga clic en el menú **Más** ![Menú más](assets/more-menu.png) en la esquina superior derecha de la tarjeta de tipo de registro; a continuación, haga clic en **Configuración**
     ...
     ![Más opciones de menú de la tarjeta de tipo de registro](assets/more-menu-options-from-record-type-card-with-settings-link.png)
   ...
   * Haga clic en una tarjeta de tipo de registro para abrir la página de tipo de registro, haga clic en el menú **Más** ![Menú Más](assets/more-menu.png) a la derecha del nombre del tipo de registro y, a continuación, haga clic en **Configuración**.
   ...
   ![Configuración del área de trabajo cruzada en la página Configuración](assets/settings-page-cross-workspace-settings.png)

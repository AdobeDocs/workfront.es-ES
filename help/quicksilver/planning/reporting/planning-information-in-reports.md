---
title: Ver información de planificación de Workfront en informes
description: Puede ver la información de Adobe Workfront Planning en los informes al utilizar el panel de lienzo.
author: Alina
...
Puede ver la información de Adobe Workfront Planning en los informes al utilizar el panel de lienzo.
...
## Ver información de planificación en paneles de lienzo

Si participa en la versión beta del panel de lienzo, puede generar informes que hagan referencia a la información de Planning (tipos de registros, registros y campos).

---
title: 'Convierta su primera victoria en un impulso sostenible: un libro de estrategias para el escalado administrado'
description: Obtenga información sobre cómo implementar Adobe Workfront Planning después de la primera implementación correcta.
...
Pero esta también es la fase más frágil de la adopción: avanzar demasiado rápido hacia una gobernanza rígida y arriesgarse a llevar a los equipos de vuelta a las hojas de cálculo; moverse demasiado libremente y recrear la gran expansión que se propuso resolver.

Este manual describe un enfoque equilibrado sobre cómo utilizar Workfront Planning como motor de reconciliación que prioriza la visibilidad primero, permite la innovación local y permite que los estándares empresariales surjan de un éxito operativo real en lugar de imponerse prematuramente.

A continuación se muestran las lecciones aprendidas de nuestra experiencia y algunos consejos sobre qué ver.

## &#x200B;1. La trampa del éxito

A veces puede parecer que la fase más peligrosa de la adopción de Workfront Planning es inmediatamente después del primer caso de uso exitoso o Prueba de concepto. El entusiasmo es alto, pero el miedo a la deuda técnica y a la expansión administrativa puede conducir a dos respuestas igualmente dañinas:

* **Sobregobernanza**: Bloqueando el sistema tan firmemente que los nuevos equipos vuelven a las hojas de cálculo.
...
Para apoyar este esfuerzo, tenga en cuenta lo siguiente:

* **Administrar la velocidad de adopción**: Es natural tener cuidado al expandirse a una nueva herramienta antes de optimizar los entornos existentes. Aunque la elección de simplificar primero proporciona una base muy controlada, puede retrasar el tiempo de respuesta al valor para los equipos listos para alinearse. Creemos que la manera más efectiva de liderar este cambio es reconocer que la visibilidad es el Paso 1; el impulso hacia una herramienta compartida y lista para la empresa (alejándose de la expansión descontrolada de presentaciones y hojas de cálculo) es lo que en última instancia desbloquea los objetivos a largo plazo.

  Recomendamos que, en lugar de un mandato para limpiar primero, asigne una porción menor de recursos a un mantenimiento continuo y una porción significativamente mayor a la solución de necesidades comerciales urgentes.

  Por ejemplo, dedicar un año exclusivamente a &quot;limpiar&quot; taxonomías no genera mucho valor incremental. Sin embargo, ofrecer visibilidad entre equipos proporciona el valor transformativo que necesitan las partes interesadas, a la vez que proporciona la estructura de datos unificada que necesita para gobernar el entorno a lo largo del tiempo.

  Puede lograr visibilidad entre equipos mediante un calendario empresarial unificado o una hoja de ruta consolidada de comercialización.

* **Reconocer la realidad**: Los equipos independientes desarrollan naturalmente sus propios procesos, que a menudo permanecen ocultos en hojas de cálculo en silos. Al hacer que estos procesos sean visibles en un entorno compartido, los pone en el único lugar donde finalmente se pueden abordar y mejorar.

  >[!IMPORTANT]
  >
  >La transición a Workfront Planning no crea un lío; arroja una luz sobre el que ya existe.


* **Reconocer el signo de progreso**: Cuando un equipo pide sus propios campos, no se &quot;expande&quot;. Considéralo un signo de adopción. Significa que el equipo ve Workfront Planning como su espacio de trabajo.
...
Considere los siguientes componentes del modelo de gobernanza de autonomía guiada:

* [Las rutas globales](#the-global-lanes)
* [Las zonas de juegos locales](#the-local-playgrounds-or-the-spokes)

Para obtener más información, consulte:

* [Despliegue su hogar estratégico: una plataforma de lanzamiento de 30 días](/help/quicksilver/planning/best-practices.md/30-day-launchpad.md)
* [Arquitectura de su éxito: modelado de la jerarquía de campañas](/help/quicksilver/planning/best-practices.md/model-campaign-hierarchy.md)

### Las rutas globales

Las siguientes son características de las rutas globales:
...
* **Administrado por**: Centro de excelencia para el administrador de operaciones de marketing.
...
* **Regla**: los equipos pueden innovar aquí. Si más de tres equipos adoptan un campo local, se puede promocionar a un carril global.

## &#x200B;4. Considere la paradoja de la gobernanza: los equipos primero y los estándares seguirán

Un desafío común en la escala de Workfront Planning es decidir qué es lo primero: la gobernanza empresarial o la alineación operativa del equipo.
...
* **Los equipos necesitan relevancia**: la empresa solo obtiene valor cuando sus equipos se están ejecutando activamente. Por lo tanto, la gobernanza debe servir a los equipos proporcionando una estructura que apoye sus necesidades operativas conocidas.

* **La empresa necesita visibilidad**: el liderazgo solo puede tomar decisiones informadas cuando los datos están lo suficientemente limpios como para agregarse. Por lo tanto, los equipos deben servir a la empresa proporcionando los metadatos viables mínimos necesarios para la visibilidad del portafolio.

El objetivo del escalado administrado es encontrar la intersección de estas dos necesidades estandarizando lo suficiente como para proporcionar visibilidad, pero no tanto como para demorar la ejecución del equipo.

Considere las siguientes etapas de creación del modelo de gobernanza:

* [Alinear prioridades: datos frente a visualización](#align-priorities-data-vs-visualization)
* [La fase de observación dirigida por los servicios](#the-service-led-observation-phase)
* [Armonización retroactiva](#retroactive-harmonization)

### Alinear prioridades: datos frente a visualización

Al escalar, reconozca que la definición del valor representa diferencias entre las personas:

* **El administrador o el propietario del producto** valora las taxonomías y clasificaciones unificadas. Su objetivo es una arquitectura de datos limpia que admita la escalabilidad a largo plazo.

* **El inversor o líder** valora la visualización y el insight que se pueden capturar en un calendario global o en una cronología de portafolios. Su objetivo es identificar el momento del rayo que hace que los datos sean procesables.

>[!NOTE]
>
>La estrategia consiste en utilizar la necesidad de visualización de la parte interesada como incentivo para que el equipo cumpla con la necesidad del administrador de estándares de datos. Se obtiene la taxonomía unificada al entregar el calendario que exige el liderazgo.


### La fase de observación dirigida por los servicios

Durante la ampliación temprana, la función del administrador es facilitar este intercambio entre los equipos y la empresa.

Como administrador, puede facilitar este intercambio haciendo lo siguiente:

* **Priorizar la operación sobre la estandarización**: es mejor que los equipos planifiquen activamente en espacios de trabajo en silo que que que se detengan debido a la falta de definiciones globales. Esta actividad es la información sin procesar necesaria para crear estándares sanos en el mundo real.

* **Identificar los mínimos de visibilidad**: Trabaje con liderazgo para identificar los 3-5 campos que deben estar limpios para los informes de empresa (por ejemplo, `Strategic Alignment`, `Start Date`, `Budget`). Concentre su energía de aplicación solo en los campos mínimos de visibilidad.

### Gobernanza como servicio

Una vez que surge un patrón de necesidades conocidas entre los equipos, la empresa puede pasar a consolidar esos patrones en un servicio global. Se trata de la gobernanza como servicio.

Haga lo siguiente para lograr la gobernanza como servicio:

* **Observar patrones exitosos**: identifique las taxonomías ganadoras que los equipos ya han creado y adoptado.

* **Llegue al protocolo de enlace colaborativo**: reúna a los campeones del equipo para refinar sus éxitos locales y convertirlos en un estándar empresarial compartido.

* **Implementar como un servicio**: Despliegue las nuevas rutas globales no como una restricción, sino como una forma de simplificar la creación de informes y la alineación entre equipos para las personas que realizan el trabajo.

>[!IMPORTANT]
>
>Recuerde que la gobernanza debe ser una respuesta al éxito operativo, no un requisito previo para él.

## &#x200B;5. Mecánica de escalado para administrar campos

### El modelo de crecimiento de campo basado en patrones

La aplicación de esta filosofía requiere un enfoque reflexivo de la estructura de datos. Para evitar la expansión descontrolada de la gobernanza, resista el impulso de crear campos globales para cada solicitud individual.

En su lugar, utilice la siguiente ruta de madurez de campo para permitir que el uso en el mundo real guíe los estándares de su empresa:

* **Nivel 1: Experimento local**: El equipo A crea un campo personalizado en su área de trabajo.
...
Llegará un punto en el que los campos ya no son relevantes y debe retirarlos.

Debido a que Workfront Planning no tiene actualmente una función de archivo nativa para los campos, la retirada de un campo local requiere un proceso de retirada parcial deliberado para conservar los datos históricos sin saturar la interfaz de usuario.

Para retirar campos:

1. Realice una migración de datos. Utilice una vista de tabla (o Fusion) para copiar de forma masiva los valores del campo de sombra local en el nuevo campo de carril global. Asegúrese de que los datos se validen y limpien durante este movimiento.

2. Cambie el nombre del campo para obsoleto: cambie el nombre del campo local con un prefijo como `[DEPRECATED]` o `z_` (por ejemplo, `z_Language (Old)`). Esto lleva el campo al final de los selectores de campos e indica a los usuarios que ya no debería ser la fuente de la verdad.

3. Elimine el campo obsoleto de todos los formularios de registro. Este es el paso más crítico. Esto evita que se introduzcan nuevos datos y mantiene los datos antiguos visibles en las vistas de tabla o informes existentes si es necesario.

4. Inicie el periodo de caducidad manteniendo el campo obsoleto (con el prefijo y eliminado de los formularios) durante 30-60 días para garantizar que no se pierdan datos durante la migración. Después de este periodo, si los datos se reconcilian completamente en la ruta global, el campo local se puede eliminar del espacio de trabajo.

## &#x200B;6. Evite la deriva de Workfront

Para evitar que Planning se desorden, haga lo siguiente:

* **Comprenda la capa de abstracción**: todos los campos de Planning deben responder a una pregunta estratégica. Si un campo solo se utiliza para el seguimiento táctico (por ejemplo, si el campo responde a una pregunta como &quot;¿se aprobó esta prueba?&quot;), manténgalo en Workfront.
...
* **El problema**: los equipos (en los radios) se sienten aislados porque solo ven sus propios registros.
...
Las siguientes son ideas para talleres que puede tener:

* [El taller de descubrimiento &quot;Desorden necesario&quot;](#the-necessary-mess-discovery-workshop)
* [Sesión de alineación &quot;Visibilidad estratégica&quot;](#the-strategic-visibility-alignment-session)
* [El escaparate &quot;Spoke-to-global&quot;](#the-spoke-to-global-showcase)
* [Horario de oficina de &quot;Asistencia continua&quot;](#the-ongoing-support-office-hours)

### El taller de descubrimiento &quot;Desorden necesario&quot;

* **Audiencia**: líderes de marketing regional y campeones de operaciones.

* **Objetivo**: Documentar la realidad en silo actual o los datos operativos fragmentados reales.
...
### Sesión de alineación &quot;Visibilidad estratégica&quot;

* **Audiencia**: partes interesadas del marketing de alto nivel (por ejemplo, personas con roles de liderazgo).

* **Objetivo**: replantea la ansiedad de simplificar-primero.

* **El mensaje**: &quot;No necesitamos una taxonomía perfecta para comenzar. Estamos utilizando Workfront Planning como entorno para crear la taxonomía perfecta&quot;.

* **Resultado**: la aprobación para avanzar con Workfront Planning como motor de reconciliación mientras Workfront permanece en su estado actual.

### El escaparate &quot;Spoke-to-global&quot;

* **Audiencia**: nuevos equipos explorando Workfront Planning.

* **Objetivo**: Reduzca la sensación de silo.
...
### Horario de oficina de &quot;Asistencia continua&quot;

* **Audiencia**: Todos los usuarios de Workfront Planning (actuales y potenciales).
...
En las subsecciones siguientes puede encontrar ideas para los principales actores en la administración del modelo de escalado.

### Arquitecto empresarial (Centro de excelencia central para operaciones de marketing)
...
Todas las lecciones aprendidas de una implementación correcta deben generar una lista de comprobación que puede utilizar para implementaciones posteriores.

Los siguientes son ejemplos de lo que debe incluir una lista de comprobación:
...
* [ ] **Asignar a rutas globales**: ¿Qué campos globales existentes pueden satisfacer el 80% de las necesidades futuras del equipo?

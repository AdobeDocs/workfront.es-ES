...
* Registros de Adobe Workfront Planning con objetos de otras aplicaciones.
   ...
   * Adobe Experience Manager
      ...
      * Recursos
        ...
        Puede conectar los siguientes tipos de recursos desde Workfront Planning:
...
Para conectar registros con objetos de Adobe Experience Manager:
...
1. Haga clic en la tarjeta de un tipo de registro para abrir la página del tipo de registro.
1. Seleccione una vista de **Tabla** del menú desplegable **Vista** en la esquina superior izquierda de la página de tipo de registro.
...
1. (Condicional) Después de conectar el tipo de registro seleccionado con objetos de AEM, vaya al campo conectado de un registro y haga clic en el campo o haga clic en **Conectar** para agregar objetos de Experience Manager al registro y, a continuación, haga clic en el icono **+**.

   >[!TIP]
   >
   >  Puede hacer clic en el icono **+** en el campo de objeto vinculado en la página de detalles del registro para conectar recursos al registro.

   Se muestra el cuadro Asesor de contenido.

   ![Cuadro del Asesor de contenido para conexiones de registros de AEM](assets/content-advisor-assets-nothing-selected.png)
...
1. En la ficha **Assets**, haga clic para seleccionar algunos de los siguientes tipos de recursos:
...
1. Cuando termine de elegir recursos o fragmentos de contenido, haga clic en **Seleccionar**. <!-- we might change this to Connect-->
   ...
   * Los recursos de Experience Manager o los fragmentos de contenido seleccionados se agregan al campo de registro vinculado.
   * Los campos vinculados (o campos de búsqueda) se rellenan con información de los objetos conectados de Experience Manager.
     ...
     Si conecta los tipos de registros de GenStudio for Performance Marketing desde GenStudio Workspace en Planning con objetos de AEM, puede ver la información de GenStudio para campañas, regiones, personalidades, productos y canales en AEM.

     Debe tener una licencia de Adobe GenStudio for Performance Marketing además de una licencia de AEM y una licencia de Workfront Planning para ver el espacio de trabajo de GenStudio en Workfront Planning.
...
1. (Opcional y condicional) Vaya al tipo de registro que vinculó a Experience Manager desde y haga clic en el nombre de un recurso en el campo de registro vinculado. Los detalles de Experience Manager del recurso se muestran en una ventana emergente. <!--not sure if this is also possible for fragments??-->
   ...
   * Fecha de modificación
     ...
     >[!TIP]
     >
     >La ventana de detalles del objeto de Experience Manager se muestra desde cualquier lugar de Planning donde se muestre el objeto conectado. Por ejemplo, puede abrir las ventanas de detalles de los objetos AEM desde la ventana de tabla o desde el área Detalles de un registro.

1. (Opcional y condicional) Para abrir la página de registro de fragmentos o recursos de Experience Manager en Experience Manager, vaya a la página de tipo de registro del registro desde el que está vinculando, haga clic en el nombre de un recurso en el campo de registro vinculado para abrir la ventana emergente y, a continuación, haga clic en el icono **Abrir en AEM** ![Abrir recurso en el icono de AEM](assets/open-asset-icon.png) para abrir el recurso. <!--not sure if this is also possible for fragments??-->

   Se abrirá el recurso del Experience Manager en Adobe Experience Manager Assets.

1. (Opcional y condicional) En la vista de tabla del tipo de registro, pase el ratón sobre el encabezado de columna del recurso o fragmento de Experience Manager vinculado, haga clic en el menú desplegable y, a continuación, haga clic en **Editar campos de búsqueda**. <!--not sure if this is also possible for fragments??-->

1. Agregar campos de objeto de Experience Manager Assets desde el área **Campos no seleccionados** <!--not sure if this is also possible for fragments??-->
...
1. (Opcional y condicional) Haga clic en el nombre de un tipo de registro en la ruta de exploración del encabezado de la página de registro para acceder a otro tipo de registro de la misma jerarquía. Deben existir jerarquías para el tipo de registro del registro que está conectando antes de poder verlas en la ruta de exploración. Para obtener más información, vea [Crear jerarquías de área de trabajo](/help/quicksilver/planning/architecture/create-workspace-hierarchies.md).

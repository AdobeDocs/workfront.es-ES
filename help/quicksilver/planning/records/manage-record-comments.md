...
<p><b>NOTA</b></p>
   <p> No todos los clientes tienen la licencia de colaborador de Planning</p>
   </td> 
  </tr>
  <tr> 
...
1. Agregue **@** seguido del nombre de un usuario o de un equipo para etiquetarlos en la actualización. Para obtener más información, vea la sección [Consideraciones acerca de comentar un registro](#considerations-about-commenting-on-a-record) en este artículo.
...
1. Haga clic en **Enviar** para registrar el comentario.
   ...
   Todas las personas con permisos de visualización en el tipo de registro pueden ver el indicador **Nuevo comentario** en la vista de tabla del registro al que agregó el comentario.

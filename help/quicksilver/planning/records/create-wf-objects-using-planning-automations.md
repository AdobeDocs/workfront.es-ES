---
title: Creación de objetos mediante automatizaciones de registros de Planning de Adobe Workfront
description: Después de configurar y activar las automatizaciones en Adobe Workfront Planning, puede utilizarlas para crear objetos en Adobe Workfront o registros en Adobe Workfront Planning. Este artículo describe cómo crear registros u objetos mediante una automatización existente.
...
Por ejemplo, puede utilizar una automatización existente que tome una campaña de Workfront Planning y cree un proyecto en Workfront para rastrear el progreso de esa campaña. El proyecto estaría conectado a la campaña de Workfront Planning en el campo Proyecto conectado de la campaña.

En este artículo se describe cómo crear registros de Workfront Planning u objetos de Workfront mediante una automatización existente.

Para obtener información acerca de cómo crear automatizaciones para un tipo de registro, vea [Configurar automatizaciones de Adobe Workfront Planning para crear registros](/help/quicksilver/planning/records/configure-automations-to-create-records.md).

Después de crear registros u objetos de Workfront mediante automatizaciones, se vincularán automáticamente a los registros desde los que se ejecuta la automatización.

Para obtener más información acerca de los registros conectados, vea [Información general sobre los registros conectados](/help/quicksilver/planning/records/connected-records-overview.md).

Puede crear los siguientes artículos utilizando automatizaciones en Workfront Planning:

* Un registro de Workfront Planning
...
* Cuando su organización utiliza el almacenamiento en la nube heredado de Workfront y Adobe, los elementos creados automáticamente desde Planning se crean mediante el almacenamiento predeterminado seleccionado por el administrador de Workfront en el área de Configuración.
...
En esta sección se describe cómo crear objetos mediante la automatización de clics en Button.
...
1. Haga clic en el botón de automatización en la barra azul.

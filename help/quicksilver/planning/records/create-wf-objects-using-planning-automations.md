...
<tr> 
   ...
   <td> <p>Conceda permisos de contribución o superiores al espacio de trabajo <span class="preview"> y al tipo de registro </span> en el que desea crear objetos mediante las automatizaciones existentes. </p>  

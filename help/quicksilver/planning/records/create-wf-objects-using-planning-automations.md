...
* Para los nuevos objetos de Workfront, el nuevo nombre de objeto es el mismo que el nombre de registro a partir del cual se crea.
* Para nuevos registros de Planning, puede indicar qué campo de registro original se debe utilizar para determinar el nombre del nuevo registro.

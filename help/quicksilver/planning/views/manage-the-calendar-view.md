...
1. Para crear registros en la vista de calendario o editar sus fechas, realice una de las siguientes acciones:
...
1. Actualice los siguientes elementos de vista como se describe en las subsecciones siguientes:
   * [Filtros](#add-filters)
   * [Altura de la fila](#modify-row-height)
...
1. Haga clic en **Añadir condición** y añada la siguiente información:
   ...
   * **Seleccione un campo** para <span class="preview">buscar un campo o </span> haga clic en el menú desplegable para mostrar una lista de campos y selecciónela en la lista

...
title: Vincular recursos y carpetas desde Experience Manager Assets Essentials
...
# Vincular recursos y carpetas desde Experience Manager Assets Essentials
...
Si está en el almacenamiento en la nube de Adobe, consulte [Uso de Adobe Experience Manager con el almacenamiento en la nube de Workfront y Adobe](/help/quicksilver/review-and-approve-work/native-integrations/frame-io/use-aem-with-frame.md).
...
* El administrador de Workfront debe configurar una integración de Experience Manager. Para obtener más información, consulte [Configuración de la integración de Experience Manager Assets Essentials](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/setup-asset-essentials.md).
...
1. Seleccione **Añadir nuevo** y luego seleccione la integración de Experience Manager que configuró el administrador.
   ...
   >[!NOTE]
   >
   >El administrador de Workfront puede elegir cualquier nombre para esta integración, por lo que es posible que no mencione específicamente Experience Manager Assets Essentials.
...
## Vincular una nueva versión de Experience Manager Assets Essentials

Puede extraer un nuevo recurso de Experience Manager Assets Essentials y añadirlo a un recurso existente como una nueva versión. Si el documento ya está vinculado y se agrega una nueva versión en Experience Manager Assets Essentials, la nueva versión aparece automáticamente en Workfront.
...
Los permisos para ver recursos individuales dentro de una carpeta dependen de los permisos de Experience Manager Assets Essentials.
...
* La funcionalidad de Asesor de contenido no está disponible para Assets Essentials. Para vincular recursos y carpetas mediante el Asesor de contenido, consulte [Vincular recursos y carpetas con el Asesor de contenido con tecnología Experience Manager Assets](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/link-to-aem.md).

* Los recursos enviados desde Assets Essentials no cuentan para el almacenamiento general de documentos en Workfront. Los documentos cargados y enviados desde Workfront a Assets Essentials no se contabilizan en el almacenamiento general.

* Los campos de metadatos se asignan por primera vez al enviar un recurso de Workfront a Experience Manager Assets Essentials. Si el administrador de Workfront ha habilitado la sincronización de metadatos de objetos, los campos permanecen actualizados si se modifican en alguna de las aplicaciones.

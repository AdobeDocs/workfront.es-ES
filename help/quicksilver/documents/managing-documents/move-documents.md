...
description: Un usuario con derechos de gestión en un documento puede mover el documento a otro objeto.
author: Courtney
...
Un usuario con derechos de gestión en un documento puede mover el documento a otro objeto.

El usuario también debe tener permisos para agregar documentos al nuevo objeto para completar esta acción. 

Al mover un documento, cualquiera de las siguientes opciones también se moverá con el documento:

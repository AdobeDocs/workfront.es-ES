...
title: Añadir o editar un formulario personalizado en un documento
description: Puede añadir un formulario personalizado a un documento o a una versión de documento para capturar información adicional o metadatos específicos de los recursos.
author: Courtney
...
1. Haga clic en el icono **Resumen** ![Icono de resumen](assets/summary-panel-icon.png) y luego busque la sección **Detalles**.
...
1. Haga clic en el icono **Resumen** ![Icono de resumen](assets/summary-panel-icon.png) y, a continuación, busque la sección **Detalles** cerca de la parte superior.
...
1. En la sección **Detalles** de la derecha, haga clic en **Editar**.
   ![botón de edición en la sección de detalles](assets/edit-custom-form.png)

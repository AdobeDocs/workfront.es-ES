...
## Resumen de documentos en la experiencia de documentos heredados
...
### Abra la vista Resumen en la experiencia de documentos heredados
...
Utilice la sección Detalles para ver información general de alto nivel e interactuar con formularios personalizados.
...
Utilice la sección Versiones para ver el número de versiones creadas para un documento específico. Haga clic en el icono Más para realizar las siguientes acciones:

* Cambiar nombre de versión
* Ver detalles del documento
* Solicitar aprobación para una versión específica
* Abrir en Frame.io
* Descargar la versión
* Compartir la versión
* Eliminar la versión

![Experiencia de versiones de resumen de documentos en nuevos documentos](assets/summary-versions.png)

### Historia

Utilice la sección Historial para ver una lista de todas las actividades relacionadas con el documento.

![Historial de resumen de documento en la nueva experiencia de documentos](assets/summary-history.png)
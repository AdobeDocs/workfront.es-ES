   ...
   <table style="table-layout:auto"> 
    <tbody> 
     ...
     <tr>
      ...
      <td><p>Número de horas durante las cuales se completará la tarjeta.</p><p>Si utiliza la opción de inclusión de la función anterior de [!DNL Workfront] [!UICONTROL Boards], al cambiar la estimación también se cambia el valor de los puntos del artículo en la [!DNL Workfront] objeto.</p><p>Si no elige las funciones anteriores, este campo es solo una entrada manual y el valor no puede ser superior a 99.</p></td>
     </tr>
     <tr>

...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>El nombre del proyecto con un vínculo directamente al proyecto<br>Este vínculo se muestra solamente en los artículos (tareas principales, no subtareas) cuando se utiliza la vista Agile en una iteración; no se muestra cuando se utiliza una vista Agile en un proyecto.</p> </td> 
   <td>✓ </td> 
   <td> </td> 
  </tr> 
  <tr> 
...
1. Vaya al guion gráfico de Agile [!UICONTROL Scrum].

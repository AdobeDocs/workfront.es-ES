...
Cuando se establece, el límite de trabajo en curso muestra un mensaje de advertencia en el panel de historia de [!UICONTROL Kanban] Agile cada vez que se supera el límite de cualquier columna del panel de historia. Este mensaje de advertencia se muestra solo la primera vez que se supera el límite de trabajo en curso. Este mensaje de advertencia no se muestra en ninguna columna que tenga un estado igual a [!UICONTROL Completado].

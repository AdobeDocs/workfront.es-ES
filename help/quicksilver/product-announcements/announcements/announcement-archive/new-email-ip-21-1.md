...
description: En un esfuerzo por aumentar el envío de correo electrónico correcto, hemos añadido nuevas direcciones IP con la versión de producción 21.1 para los clústeres que se enumeran a continuación. Para saber en qué clúster se encuentra su instancia, vaya a Setup > System > Customer Info.
author: Luke
...
En un esfuerzo por aumentar el envío de correo electrónico correcto, hemos añadido nuevas direcciones IP con la versión de producción 21.1 para los clústeres que se enumeran a continuación. Para saber en qué clúster se encuentra la instancia, vaya a Configuración > Sistema > Información del cliente.
...
(Para obtener contexto adicional acerca de la lista de permitidos y otras direcciones IP que podrían haberse añadido a la lista de permitidos, consulte [Configuración de la lista de permitidos del firewall](../../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md).)

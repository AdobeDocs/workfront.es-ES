...
* Una lista de tarjetas, o registro de pendientes de trabajo, con la opción de usar fuentes para conectar tarjetas a tareas y problemas de Workfront
...
Ahora puede agregar tareas o problemas existentes a un flujo de trabajo en paneles de Workfront directamente desde una vista de lista o de informe. Cualquier elemento que agregue al flujo de trabajo se agregará a la lista de tarjetas como tarjetas no planificadas.

Para obtener más información, consulte [Agregar tareas o problemas existentes a un tablero](/help/quicksilver/agile/get-started-with-boards/add-card-from-list-to-board.md).

## Agregar campos personalizados a las tarjetas de un tablero

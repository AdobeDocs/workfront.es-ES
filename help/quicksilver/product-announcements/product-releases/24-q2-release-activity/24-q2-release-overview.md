            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 28 de marzo de 2024</p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 14 de marzo de 2024</p>
                            </li>
                            <li>
                                <p>Producción para clientes de: con la versión 24.4 (11 de abril de 2024)</p>
                            </li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: martes, 26 de febrero de 2024</p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: viernes, 29 de febrero de 2024</p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 24.3 (14 de marzo de 2024)</p>
                            </li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: viernes, 22 de febrero de 2024</p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: viernes, 08 de febrero de 2024</p>
                            </li>
                            <li>
                ...
                <tr>
                    <td>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Configurar un período de tiempo</p>
                            </li>
                        </ul>
                        </p>
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: miércoles, 02 de enero de 2024</p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 24.2 (15 de febrero de 2024)</p>
                            </li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: martes, 11 de marzo de 2024</p>
                            </li>
                            <li>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: 6 de octubre de 2022</p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 24.2 (15 de febrero de 2024)</p>
                            </li>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: viernes, 11 de abril de 2024</p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión de vista previa: martes, 01 de abril de 2024</p>
                            </li>
                            <li>
                                <p>Producción para todos los clientes: con la versión 24.4 (11 de abril de 2024)</p>
                            </li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: sábado, 01 de marzo de 2024</p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 24.3 (14 de marzo de 2024)</p>
                            </li>
                ...
                <tr>
                    <td>
                        ...
                        <ul>
                            <li>
                                <p>Se puede hacer clic en el nombre de un comentarista para ver su nombre, función y dirección de correo electrónico en un cuadro de información. Esta información puede ayudarle a identificar al usuario correcto si tiene más de uno con el mismo nombre. Al hacer clic en el nombre del comentarista en el cuadro de información, se abrirá su perfil de usuario.</p>
                            </li>
                            <li>
                                <p>Su nombre de usuario aparecerá resaltado en los comentarios en los que se le haya etiquetado, cuando se le mencione en el texto del comentario.</p>
                            </li>
                        </ul>
                    </td>
                    <td><p><b>Disponible en estas fechas:</b></p>

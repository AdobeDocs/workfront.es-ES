...
description: Esta página ofrece información sobre la funcionalidad para los Adobe Workfront Goals en la nueva experiencia de Adobe Workfront que se lanzará al entorno de producción con la versión 23.1.
author: Courtney
...
Para obtener una lista de todos los cambios disponibles en todas las áreas de Workfront en este punto del ciclo de la versión 23.1, consulte [Información general sobre la versión 23.1](/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-release-overview.md).
...
Los objetivos individuales se abren en su propia página y se han añadido las siguientes secciones en el panel izquierdo para facilitar la navegación y la actualización:</p>
                        ...
                        <li><b>Actualizaciones</b>: vea, publique o responda a actualizaciones en la meta, de forma similar al área Actualizaciones en otros objetos de Workfront. 

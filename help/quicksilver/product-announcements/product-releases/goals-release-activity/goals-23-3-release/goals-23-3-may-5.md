...
## Actualiza las mejoras de la sección

Las mejoras en la sección de actualizaciones de los objetivos están disponibles dentro del periodo de tiempo de la versión 23.3, a la vez que las actualizaciones que se están publicando en la nueva experiencia de comentarios beta. Estas mejoras estarán disponibles en el entorno de producción poco después de su lanzamiento de la versión preliminar.

Las mejoras de comentarios disponibles para los objetivos son las mismas que se publicaron con la nueva experiencia de comentarios beta para otros objetos de Workfront.

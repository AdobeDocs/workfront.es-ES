...
description: Esta página ofrece información sobre la funcionalidad para los Adobe Workfront Goals en la nueva experiencia de Adobe Workfront que se lanzará al entorno de producción con la versión 21.2.
author: Luke
...
Esta página ofrece información sobre la funcionalidad para los Adobe Workfront Goals en la nueva experiencia de Adobe Workfront que se lanzará al entorno de producción con la versión 21.2.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../../product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-19.md#top" class="MCXref xref" xrefformat="{para}">Editar metas de periodos anteriores en Workfront Goals</a> <span class="uitext" style="color: #dc143c;">Nuevo en vista previa!</span></p> <p>Para ayudarle a administrar sus metas de forma más eficaz, hemos introducido una mejora que le permite editar las metas de cualquier período de tiempo, incluidos las metas anteriores. Antes de esta mejora, solo se podían actualizar o crear metas dentro del lapso de tiempo actual o futuro.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: 22 de abril de 2021</p> <p>Versión de producción: con la versión 21.2</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../../product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-19.md#an" class="MCXref xref" xrefformat="{para}">Lista de metas actualizada para las metas de Workfront</a> <span class="uitext" style="color: #dc143c;">Novedades en vista previa!</span></p> <p>Para crear una experiencia completa para usted, hemos introducido varias actualizaciones en la Lista de metas en Workfront Goals. La nueva lista se ve y se siente más cercana al resto de las listas de Workfront. Algunas mejoras que puede ver en la nueva lista de metas son las siguientes:</p> 
    <ul> 
     <li> <p>Contraer y expandir las metas se administra desde el icono superior izquierdo de la barra de herramientas. Se ha eliminado el icono "Expandir metas".</p> </li> 
     <li> <p>La funcionalidad de los filtros coincide con la de la sección Alineación de metas. Puede mostrar temporalmente los elementos ocultos por el filtro y, a continuación, volver a aplicarlo para excluirlos de la visualización.</p> </li> 
     <li> <p>Se ha actualizado el nombre de algunas de las columnas.</p> </li> 
    </ul> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: 22 de abril de 2021</p> <p>Versión de producción: con la versión 21.2</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../../product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-19.md#share" class="MCXref xref" xrefformat="{para}">Compartir una meta en Workfront Goals </a> <span class="uitext" style="color: #dc143c;">Novedad en la vista previa!</span></p> <p>Ahora puede compartir una meta que haya creado o que se haya compartido con usted y controlar quién tiene acceso para administrar la meta. Antes de esta mejora, todos los usuarios tenían acceso para ver y administrar todas las metas del sistema. Ahora, pueden ver todas las metas en el sistema de forma predeterminada, pero solo pueden administrar las metas para las que se les han concedido permisos o las metas que han creado.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: 22 de abril de 2021</p> <p>Versión de producción: con la versión 21.2</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: 8 de abril de 2021</p> <p>Versión de producción: con la versión 21.2</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: 18 de febrero de 2021</p> <p>Versión de producción: 4 de marzo de 2021</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
 </tbody> 
</table>

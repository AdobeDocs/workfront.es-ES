...
# Actividad de la versión de Adobe Workfront Goals 21.1: semana del martes, 11 de enero de 2021

Esta página describe todas las mejoras realizadas con la versión 21.1 para Adobe Workfront Goals en el entorno de vista previa para la semana del martes, 11 de enero de 2021. Estas mejoras estarán disponibles en el entorno de producción en el primer trimestre de 21.1.
...
Hemos actualizado los nombres del campo Progreso de la meta para que coincida con el de la condición del proyecto. Para ello, hemos realizado los siguientes cambios:
...
Para crear una experiencia familiar en todos los productos de Workfront, hemos rediseñado la navegación principal y las listas de metas en Workfront Goals. Este nuevo diseño es coherente con la forma en que interactúa con el resto de las áreas y listas de Workfront e incluye las siguientes funciones:
...
Para mejorar su interacción con ella y hacerla más fácil de usar, hemos rediseñado la sección de Alineación de metas para Workfront Goals. Algunas de las mejoras incluyen las siguientes:

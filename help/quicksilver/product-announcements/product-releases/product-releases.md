    ...
    <tr data-mc-conditions="">
      ...
      <td>
        <ul>
          ...
          <li><a href="/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md" class="MCXref xref" xrefformat="{para}">Actividad de la versión de Adobe Workfront Planning: índice de artículos</a></li>
        </ul>
      </td>
    </tr>
    <tr data-mc-conditions="">

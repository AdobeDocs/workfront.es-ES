...
description: Esta página describe todas las mejoras de List realizadas con la versión 2019.4. Estas mejoras estarán disponibles en el entorno de producción el martes, 11 de noviembre de 2019.
author: Luke
...
Esta página describe todas las mejoras de List realizadas con la versión 2019.4. Estas mejoras estarán disponibles en el entorno de producción el martes, 11 de noviembre de 2019.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td><strong>Se ha actualizado el aspecto de las nuevas listas</strong> <p>Las listas de proyectos, tareas y horas ahora tienen una apariencia actualizada. Otras listas que se planificaron para actualizarse con la versión 2019.4 se actualizarán con una versión futura.</p> <p>Algunas de las actualizaciones incluyen las siguientes:</p> 
    <ul> 
     <li>Un diseño más limpio, de tipo cuadrícula</li> 
     <li>Colores y fuentes actualizadas</li> 
     <li>Los encabezados de columna son más fáciles de leer</li> 
     <li>La edición en línea es más fácil de leer</li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td><strong>Se ha aplicado un nuevo diseño a las listas de Informes, Tareas de plantilla, Portafolios y más</strong> <p>Importante: Estas mejoras se eliminaron del entorno de vista previa el 8 de noviembre de 2019 y no se incluirán en la versión 2019.4 para Producción. Estas mejoras se volverán a añadir al entorno de vista previa después de la versión 2019.4 en Producción y se pondrán a disposición de Producción en una versión futura.</p> <p>El nuevo diseño de lista ya está disponible en las siguientes listas:</p> 
    <ul> 
     <li>Informes </li> 
     <li>Problemas</li> 
     <li>Temas de la cola </li> 
  ...
  <tr> 
   <td> 
    <div> 
     <strong>Se ha añadido una nueva ventana de ayuda conceptual a los filtros rápidos</strong> 
  ...
  <tr> 
   <td> 
    <div> 
     ...
     <p>Los recordatorios de métodos abreviados del teclado ahora están disponibles en el cuadro de búsqueda de filtros rápidos en listas para facilitar el acceso a los filtros. </p> 

...
title: 2019.2 Integración y mejoras en la aplicación móvil
...
# 2019.2 Integración y mejoras en la aplicación móvil
...
* Administrar la configuración de notificaciones de Workfront para Microsoft Teams
...
## Se ha actualizado Workfront para la integración con Adobe Creative Cloud
...
El aspecto de todas las vistas de lista se ha actualizado ahora tanto en las aplicaciones de iOS como en las de Android. Esta nueva apariencia le permite identificar rápidamente los elementos de la lista en cada pestaña, así como expandir y contraer agrupaciones desde la pestaña Inicio.

...
description: Esta página describe todos los cambios más recientes disponibles en el entorno de vista previa con la versión Beta 5 2018.3. La funcionalidad estará disponible en el entorno de vista previa el 21 de septiembre de 2018. Estará disponible en el entorno de producción en noviembre de 2018.
author: Luke
...
Esta página describe todos los cambios más recientes disponibles en el entorno de vista previa con la versión Beta 5 2018.3. La funcionalidad estará disponible en el entorno de vista previa el 21 de septiembre de 2018. Estará disponible en el entorno de producción en noviembre de 2018.
...
* [Rastrear aprobaciones enviadas en el área de inicio](#track-approvals-you-ve-submitted-in-the-home-area)
* [Reemplazo de herramientas basadas en Flash en Workfront](#replacement-of-flash-based-tools-in-workfront)
* [Permitir que los usuarios con licencia de trabajo tengan acceso a la subpestaña Programación de un proyecto](#allowing-work-license-users-to-access-the-scheduling-subtab-of-a-project)
...
* [Datos del Planificador de recursos en la exportación del caso empresarial](#resource-planner-data-in-the-business-case-export)
* [Habilitar anulación de tarifa de facturación a nivel de compañía](#enable-company-level-billing-rate-override)
* [Aprobaciones simplificadas basadas en roles](#simplified-role-based-approvals)
* [Informe de utilización: rellena las horas presupuestadas desde el nuevo área de presupuesto de recursos](#utilization-report-populates-budgeted-hours-from-new-resource-budgeting-area)
...
* [Acciones más rápidamente accesibles en la lista de comentarios del visor de revisión](#actions-more-quickly-accessible-in-the-comment-list-in-the-proofing-viewer)
...
* [Pruebas de zoom y desplazamiento de vídeo en el visor de revisión](#zoom-and-pan-video-proofs-in-the-proofing-viewer)
* [Fondo más claro en el visor de revisión](#lighter-background-in-the-proofing-viewer)
* [Mejor visibilidad cuando se edita un comentario en el visor de revisión](#better-visibility-when-a-comment-has-been-edited-in-the-proofing-viewer)
* [Ver el número de comentarios asociados con una acción en la lista de comentarios del visor de revisión](#view-the-number-of-comments-associated-with-an-action-in-the-comment-list-in-the-proofing-viewer)
...
* [Abrir el sitio web asociado desde una revisión de sitio web interactiva o estática](#opening-the-associated-website-from-an-interactive-or-static-website-proof)
...
Para obtener información sobre cómo ver la información de las horas en el Planificador de recursos, consulte [Resumen del Planificador de recursos](../../../../resource-mgmt/resource-planning/get-started-resource-planner.md).
...
Si habilita esta configuración, las tarifas de facturación en la empresa anulan las tarifas de rol históricas en el proyecto.
...
Para obtener más información, consulte [Acciones de uso en comentarios sobre pruebas](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/use-actions-on-comments-in-viewer.md).
...
Para obtener más información, consulte esta sección  [Compartir la dirección URL](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md#sharing-the-url) en el artículo  [Compartir una revisión del visor de revisión](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md).
...
Para obtener más información, consulte [Compartir una revisión agregándole usuarios](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md#sharing-with-individual-users) en [Compartir una revisión del visor de revisiones](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md).

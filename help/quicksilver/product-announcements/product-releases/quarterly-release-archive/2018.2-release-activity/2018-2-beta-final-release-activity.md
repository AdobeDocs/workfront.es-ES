...
title: 2018.2 Actividad de la versión final de beta
description: En esta página se describen todos los cambios disponibles más recientemente en el entorno de vista previa con la versión final de beta 2018.2. La funcionalidad se publicó en el entorno de vista previa el 20 de junio de 2018. Estará disponible en el entorno de producción en julio de 2018.
author: Luke
...
# 2018.2 Actividad de la versión final de beta

En esta página se describen todos los cambios disponibles más recientemente en el entorno de vista previa con la versión final de beta 2018.2. La funcionalidad se publicó en el entorno de vista previa el 20 de junio de 2018. Estará disponible en el entorno de producción en julio de 2018.
...
Los administradores de Workfront ahora tienen la opción de elegir los servicios de entrega de correo al configurar Workfront para permitir a los usuarios hacer comentarios sobre los objetos a través de respuestas de correo electrónico. Workfront se puede configurar para que utilice el servicio de correo electrónico predeterminado o una cuenta de correo electrónico POP.
...
* Crear automáticamente nuevos proyectos de Workfront cuando una oportunidad de Salesforce llegue a una fase determinada, cuando se añada un nuevo producto a una oportunidad o cuando se actualice el tipo de cuenta.
* Crear solicitudes de Workfront a partir de una oportunidad o cuenta de Salesforce.

Esta integración estará disponible para todos los clientes que dispongan de una Workfront Pro Edition o superior y será gratuita.
...
También se pueden configurar las siguientes notificaciones de Workfront para que se envíen a Slack:

* Cuando alguien le etiquete en un comentario o una actualización.
* Cuando se le asigne una nueva tarea o un problema.
* Cuando se le solicite que apruebe un elemento.

Antes de esta mejora, no podía recibir notificaciones de Workfront en Slack.

Para obtener más información sobre las notificaciones de Workfront en Slack, consulte [Recepción de notificaciones de Adobe Workfront en Slack](../../../../workfront-integrations-and-apps/using-workfront-with-slack/receive-workfront-notifications-in-slack.md).

## Mejoras para móviles {#mobile-improvements}

Las siguientes nuevas funciones se publicarán en las tiendas de móviles en el momento de la versión de producción 18.2:

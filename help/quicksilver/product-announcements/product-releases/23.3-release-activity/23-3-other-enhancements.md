---
title: Otras mejoras sobre la versión 23.3
description: Otras mejoras sobre la versión 23.3
author: Lisa
...
# Otras mejoras sobre la versión 23.3

Esta página describe todas las demás mejoras realizadas con la versión 23.3 de. Estas mejoras estaban disponibles en el entorno de producción con la versión 23.3 de 20 y 21 de julio de 2023.
...
Para permitir mejor que los usuarios de todos los tipos utilicen Workfront para sus necesidades específicas, Inicio ha recibido una actualización importante. La nueva experiencia de Inicio ofrece personalización visual y de contenido para su página de Inicio, lo que proporciona la flexibilidad para mostrar solo la información que sea más relevante para su trabajo. Con Nueva página de inicio, puede:

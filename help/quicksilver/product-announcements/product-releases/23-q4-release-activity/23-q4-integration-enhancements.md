...
En esta página se describen todas las mejoras de integración realizadas con la versión del cuarto trimestre de 2023 en el entorno de vista previa. Estas mejoras estaban disponibles en el entorno de producción con la versión 23.10.
...
* Ahora la ventana Enviar a muestra hasta 500 sitios, carpetas y documentos.
* Los resultados de búsqueda ahora muestran diferentes iconos para los sitios y carpetas de SharePoint, lo que deja claro qué resultados son sitios y cuáles son carpetas. Los archivos no muestran ningún icono.
...
## Actualizaciones para arrastrar y soltar para integraciones de documentos

Se han realizado algunas mejoras en la experiencia del usuario al arrastrar y soltar un archivo en una carpeta vinculada.

* Para una mejor transparencia en el proceso, se ha añadido un indicador de &quot;En movimiento&quot; que se muestra mientras el archivo se encuentra en proceso de movimiento a la carpeta vinculada.
...
Estos cambios afectan a todas las integraciones de documentos, incluidos Adobe Experience Manager y SharePoint.

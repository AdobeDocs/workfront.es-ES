---
title: Información general de la versión del cuatro trimestre de 2023
description: Información general de la versión del cuatro trimestre de 2023
author: Becky
...
# Información general de la versión del cuatro trimestre de 2023

En esta página se proporciona información sobre la funcionalidad que se incluye en la versión del cuarto trimestre de 2023. Estas mejoras están planificadas para que estén disponibles en el entorno de producción para todos los clientes con la versión 23.10 del 26 y 27 de octubre de 2023.
...
El seminario web de la versión 23.10 fue el viernes, 05 de octubre de 2023. Puede [registrarse en el seminario web para ver una grabación bajo demanda aquí](https://webinars.on24.com/adobe_workfront/whatsnewin2310?partnerref=releasenotes).

Las <span class="preview">funciones fuera de ciclo que se enviaron a producción antes de la fecha de publicación del cuarto trimestre de 2023) aparecen resaltadas en amarillo.</span>

>[!IMPORTANT]
>
>La versión 23.3 incluía la opción de pasar su organización a versiones mensuales. Por lo tanto, Workfront está cambiando el esquema de numeración de versiones para tener en cuenta las versiones mensuales y trimestrales.
>
>* Si estás en la pista **versión rápida (mensual)**, la versión posterior a la 23.3 es la **23.8**, el 31 de agosto de 2023.
> * Si se encuentra en el seguimiento de la versión **trimestral**, la versión posterior a la 23.3 es la **23.10**, en la semana del 26 de octubre de 2023.
> 
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 12 de octubre de 2023</p>
                            </li>
                            <li>
                                <p><span class="preview">Producción para todos los clientes: viernes, 12 de octubre de 2023</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>            
                 <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 05 de octubre de 2023</p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 23.10</p>
                            </li>
                            <li>
                                <p>Producción para la versión trimestral: con la versión 23.10</p>
                            </li>
                        </ul>
                    </td>
                </tr>
                 <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 14 de septiembre de 2023</p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 23.9</p>
                            </li>
                            <li>
                                <p>Producción para la versión trimestral: con la versión 23.10</p>
                            </li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: martes, 21 de agosto de 2023</p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 03 de agosto de 2023</p>
                            </li>
                            <li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: jueves, 13 de septiembre de 2023<br /></p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 23.9</p>
                            </li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            ...
                            <li>
                                <p>Producción para la versión rápida: con la versión 23.8</p>
                            </li>
                            <li>
                                <p>Producción para la versión trimestral: con la versión 23.10</p>
                            </li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">Producción para todos los clientes: viernes, 31 de agosto de 2023</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 24 de agosto de 2023<br /></p>
                            </li>
                            <li>
                                <p><span class="preview">Producción para todos los clientes: viernes, 31 de agosto de 2023</span></p>
                            </li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: viernes, 12 de octubre de 2023<br /></p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 23.10</p>
                            </li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: jueves, 26 de julio de 2023<br /></p>
                            </li>
                            <li>
                                <p>Producción para la versión rápida: con la versión 23.8</p>
                            </li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: periodo de tiempo de la versión a lo largo del cuarto trimestre de 2023<br /></p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible en estas fechas:</b></p>
                        <ul>
                            <li>
                                <p>Versión preliminar: periodo de tiempo de la versión a lo largo del cuarto trimestre de 2023</p>
                            </li>
                            <li>
...
La versión 17 de la API se publicó el 12 de octubre de 2023. Para la versión 17 de la API, hemos modificado algunos recursos y puntos finales. Algunos de los cambios admiten nuevas funciones y otros facilitan el uso de la información disponible a través de la API.

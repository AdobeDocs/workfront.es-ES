...
* [Mejoras de actualización de flujo](#update-stream-enhancements)
...
<tbody>
    ...
    <tr>
        <td>
           ...
           [!BADGE In production &#x200B;]{type=Informative}
            <p>Ahora puede crear reglas de negocio y aplicar validación a estos objetos adicionales: Compañía, Iteración, Categoría de Recurso No Laboral, Rol de Trabajo, Usuario, Asignación, Pool de Recursos, Tiempo Apagado, Documento y Hora.</p>
        </td>
        <td>
    ...
    <tr>
        <td>
            ...
            [!BADGE In production &#x200B;]{type=Informative}
            <p>Para ampliar las capacidades de la funcionalidad de promoción de entornos, hemos añadido más objetos.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Evitar mover tareas cuando hay horas registradas</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>Versión de vista previa: viernes, 21 de noviembre de 2024</li>
                <li>Producción para versión rápida: con la versión 24.12 (12 de diciembre de 2024)</li>
                <li>Versión de producción para todos los clientes: con la versión 25.1 (viernes, 16 de enero de 2025)</li>
            </ul>
        </td>
    </tr>    
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Ahora está disponible el filtrado en campos de escritura anticipada nativos</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li>Producción para versión rápida: con la versión 24.11 (14 de noviembre de 2024)</li>
                <li>Versión de producción para todos los clientes: con la versión 25.1 (viernes, 16 de enero de 2025)</li>
            </ul>
        </td>
    </tr>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            [!BADGE In production &#x200B;]{type=Informative}
            <p>El creador de un tablero es el propietario de forma predeterminada. El propietario del tablero es la única persona que puede eliminar dicho tablero o actualizar sus filtros en el panel Configurar.</p>
            <p>Se ha añadido la funcionalidad para permitir que los administradores del sistema de Workfront cambien el propietario de una placa. El propietario actual de un tablero también puede cambiar el propietario de ese tablero específico. Esta funcionalidad está disponible en tableros básicos, retrospectivos y kanban, pero no en tableros dinámicos.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-document-mgmt-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Nuevo estado Retirado disponible para las aprobaciones de versiones de documentos</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
            <p>Cuando se añade una nueva versión a un documento con aprobaciones pendientes, la aprobación de la versión anterior ahora se muestra como "Retirada", lo que indica que el proceso de aprobación anterior se ha cerrado debido a la adición de la nueva versión.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            <ul>
                <li>Mostrar tareas posteriores</li>
    ...
    <tr>
        <td>
            ...
            [!BADGE In production &#x200B;]{type=Informative}
            <p>Puede utilizar Ponerme al día para reducir el tiempo que tarda en buscar información sobre proyectos activos.</p>
            <p>Con la tecnología del Asistente de inteligencia artificial de Workfront, Ponerme al día resume las actualizaciones, los documentos cargados y otros cambios importantes sobre sus proyectos en los siguientes plazos: 24 horas, 3 días o 7 días.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
    ...
    <tr>
        <td>
            ...
            <p>Ahora puede ver actualizaciones en tiempo real en la página Detalles de una tarea o problema. También puede ver si otros usuarios están viendo la página al mismo tiempo que usted con indicadores de presencia en tiempo real.</p>
        </td>
        [!BADGE In production &#x200B;]{type=Informative}
        <td>
            <p><b>Disponible en estas fechas:</b></p>
    ...
    <tr>
        <td>
            ...
            <ul>
                ...
                <li>Iniciar el visor de pruebas</li>
                <li>Y mucho más</li>
            </ul>
        </td>
        <td>
    ...
    <tr>
        <td>
            ...
            <ul>
                <li>Usa filtros para encontrar tu trabajo</li>
                <li>Aplica campos personalizados como el estado y el nivel de enfoque para identificar el trabajo de alta prioridad</li>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Actualizaciones de la lista de trabajo de prioridades</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
            <p>Hemos actualizado la lista de trabajo de prioridades para mejorar las capacidades y alinearlas con otras áreas de la aplicación.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Vaya a la página Detalles de un proyecto desde Prioridades.</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
...
<tr>
    ...
    <tr>
        <td>
            ...
            [!BADGE In production &#x200B;]{type=Informative}
            <p>Estamos presentando una nueva extensión del navegador, la herramienta de revisión de Adobe Workfront, para sustituir la extensión del navegador heredada para revisar el contenido ZIP interactivo. La nueva herramienta de revisión de Adobe Workfront admite la revisión del contenido ZIP en todos los navegadores comunes.</p>
            <p>La extensión del navegador heredada se eliminará el 28 de febrero de 2025.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            [!BADGE In production &#x200B;]{type=Informative}
            <p>Hemos añadido compatibilidad con una serie de nuevas entidades en Data Connect, incluidas algunas entidades específicas de agencias.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
                <li>Versión de vista previa: jueves, 15 de enero de 2025</li>
                <li>Lanzamiento de producción para todos los clientes: 15 de enero de 2025</li>
            </ul>
        </td>
    </tr>
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-report-and-dashboard-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Límite de 25 informes, páginas externas o calendarios en paneles</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-report-and-dashboard-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Botón de creación de cuenta de lector por primera vez para Data Connect</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
...
<tbody>
    ...
    <tr>
        <td>
            ...
            Experiencia de comentarios actualizada en el widget Menciones en el área Inicio y Mis actualizaciones</a></p>
            <p>Estamos actualizando la experiencia de comentarios en el widget Menciones en Inicio y la sección Menciones en el área Mis actualizaciones. Ahora, la misma experiencia en el área Actualizaciones de la mayoría de los objetos de Workfront también está disponible en el widget Menciones y en la sección Menciones de Mis actualizaciones.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
                <li>Versión de vista previa: viernes, 19 de diciembre de 2024</li>
                <li>Lanzamiento de producción para todos los clientes de Home: por anunciar</li>
                <li>Versión de producción para todos los clientes de Mis actualizaciones: 19 de junio de 2025</li>
            </ul>
        </td>
    </tr>
</tbody>
...
<tbody>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">
            El Asistente de inteligencia artificial ahora puede trabajar con proyectos, tareas y problemas</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
    ...
    <tr>
        <td>
            ...
            Actualizaciones de aspecto y sensación durante el primer trimestre de 2025</a></p>
...
>
>El conjunto de documentación de Fusion actual ya no se está actualizando y se eliminará en un futuro próximo.
...
Las nuevas funciones de Workfront Planning están disponibles en el entorno de producción. Para obtener más información sobre las funciones más recientes, consulte [Actividad de la versión del primer trimestre de 2025 de Adobe Workfront Planning](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q1.md).

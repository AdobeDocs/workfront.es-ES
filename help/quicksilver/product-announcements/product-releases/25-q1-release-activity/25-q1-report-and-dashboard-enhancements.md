...
A los administradores que acceden a Data Connect por primera vez se les presenta la opción de crear una nueva cuenta de lector de Snowflake haciendo clic en un solo botón. El proceso tarda unos minutos en completarse, pero no requiere ninguna acción adicional.

Para obtener más información sobre la configuración de Data Connect, consulte [Crear una cuenta de lector para Snowflake](/help/quicksilver/reports-and-dashboards/data-lake/create-a-reader-account.md).

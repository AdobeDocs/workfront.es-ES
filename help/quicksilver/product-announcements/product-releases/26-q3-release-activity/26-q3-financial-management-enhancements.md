---
title: Mejoras de Financial Management del tercer trimestre de 2026
description: Mejoras de Financial Management del tercer trimestre de 2026
author: Becky
...
## Agregar una tarjeta de tarifa a una plantilla
...
Para obtener más información, consulte [Adjuntar una tarjeta de tarifa a una plantilla](/help/quicksilver/manage-work/projects/create-and-manage-templates/attach-rate-card-to-template.md).

## Agregar tarifas de facturación entre las tarifas existentes en una tarjeta de tarifas
...
Anteriormente, solo se podían agregar tasas en la parte inferior de la lista.
...
## Los atributos de tipo de cambio no se pueden editar una vez que se utilizan en tipos de cambio

...
## Nueva apariencia para Adobe Workfront Fusion

Hemos actualizado el aspecto de Workfront Fusion para que refleje mejor el aspecto de otros productos de Adobe. Este cambio en el aspecto más limpio permite una experiencia más coherente al trabajar con distintos productos de Adobe.

Esta actualización también ofrece mejoras de rendimiento para una navegación más rápida.

El nuevo aspecto no afecta a la funcionalidad de Adobe Workfront Fusion. Todos los botones, pestañas y otras herramientas se encuentran en la misma ubicación, por lo que no es necesario cambiar ninguno de los comportamientos o flujos de trabajo existentes.

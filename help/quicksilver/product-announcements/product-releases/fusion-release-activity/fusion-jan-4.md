...
## Actualizaciones del conector de correo electrónico Microsoft 365

Para expandir las formas en que puede utilizar el conector de correo electrónico Microsoft 365, hemos añadido algunos módulos nuevos:

* Buscar mensajes
* Obtener un mensaje
* Eliminar un mensaje
* Actualizar un mensaje
* Archivos adjuntos de lista
* Descargar un archivo adjunto
* Añadir un archivo adjunto
* Realizar una llamada de API

También hemos eliminado el módulo Iterate attachment . Puede combinar el módulo List attachment con el módulo Iterator para iterar los archivos adjuntos.

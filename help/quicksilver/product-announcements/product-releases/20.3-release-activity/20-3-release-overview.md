...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#for" class="MCXref xref">Para administradores: la nueva página de grupos facilita la creación y administración de grupos</a> </p> <p>Los administradores de grupos pueden administrar grupos más fácilmente ahora que todo lo que necesitan está en la nueva página Grupos. Ya no es necesario desplazarse entre los distintos cuadros de superposición y las páginas de configuración para crear y modificar grupos.</p> </td> 
   <td> <p><strong>Disponible en estas fechas:</strong> </p> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-project-management-enhancements.md#set" class="MCXref xref">Para administradores: establezca las preferencias del proyecto en el nivel de grupo</a> </p> <p>Para dar más autonomía a los administradores de grupos y permitir una mayor personalización de los flujos de trabajo a nivel de grupo, ahora puede definir las preferencias del proyecto a nivel de grupo, para los grupos que administre. Al crear un proyecto, las preferencias del grupo surtirán efecto antes que las del sistema.</p> </td> 
   <td> <p><strong>Disponible en estas fechas:</strong> </p> <p>Versión preliminar beta: 10 de julio de 2020</p> <p>Versión de producción: con la versión 20.3 <strong>(temporalmente no disponible para la mayoría de los clientes en los clústeres 1, 2, 3 y 5)</strong></p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#group" class="MCXref xref">Los administradores de grupos pueden crear y administrar procesos de aprobación</a> </p> <p>Para permitir una mayor autonomía y control de los flujos de trabajo de sus grupos, un administrador de grupos ahora puede acceder al área Proceso de aprobación en Configuración y crear y editar los procesos de aprobación para un grupo que administra. Estos procesos de aprobación se basan en los estados de ese grupo.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#new2" class="MCXref xref">Nuevo para administradores: Brand Workfront para grupos, equipos, funciones y usuarios específicos</a> </p> <p>Ahora puede utilizar una plantilla de diseño para cambiar los logotipos en el área de navegación superior y en el menú principal para grupos, equipos, funciones y usuarios específicos que tengan su propia marca.</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/scenario-planner-release-activity/sp-release-20-3.md" class="MCXref xref" data-mc-conditions="QuicksilverOrClassic.Quicksilver">Planificador de escenarios de Workfront con la versión 20.3: 14 de agosto de 2020</a> </p> <p>Con el planificador de escenarios, cree y compare varios escenarios hipotéticos para elegir la mejor ruta a seguir. Y cuando cambien sus prioridades, vuelva a planificar de forma iterativa sin que ello afecte al trabajo en curso.</p> </td> 
   <td> <p>Versión preliminar beta: N/D</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-agile-enhancements.md#agile" class="MCXref xref">Los paneles Agile cargan 50 elementos de trabajo al mismo tiempo</a> </p> <p>Para aumentar la velocidad y el rendimiento de las herramientas Agile, ahora se cargan hasta 50 tarjetas en varias ubicaciones. Si hay más de 50 elementos de trabajo en un panel Agile, aparece un botón en la parte inferior del panel o registro de pendientes, que le permite cargar elementos de trabajo adicionales.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: 19 de junio de 2020</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponible en estas fechas:</strong> <p>Versión preliminar beta: del 2 de julio al 22 de septiembre (en un despliegue gradual)</p> <p>Versión de producción: del 2 al 21 de julio de 2020 (en un despliegue gradual)</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 5 de junio de 2020</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-proof-enhancements.md#new" class="MCXref xref">Nueva apariencia para la barra de herramientas de Documento</a> </p> <p>La barra de herramientas del área Documento ahora tiene la misma apariencia que la barra de herramientas para proyectos, tareas y problemas en la nueva experiencia de Workfront.</p> <p>Además, la opción Nueva versión ahora está en el menú desplegable Añadir nueva tanto en la nueva experiencia de Workfront como en la versión clásica.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-proof-enhancements.md#create" class="MCXref xref">Crear una prueba avanzada a partir de la lista de documentos</a> </p> <p>Para facilitar la configuración de un flujo de trabajo al convertir un documento existente en una prueba, utilice el nuevo menú desplegable Crear prueba para configurar el flujo de trabajo de revisión desde la lista de documentos.</p> <p>Anteriormente, se tenía que generar la revisión y, a continuación, ir al área Flujo de trabajo de la corrección para configurar el flujo de trabajo.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: con la versión 20.3</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
 </tbody> 
</table>

### Integración y mejoras en la aplicación móvil {#integration-and-mobile-enhancements}
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-mobile-enhancements.md#zoom" class="MCXref xref">Integración de zoom en el flujo de actualizaciones</a> </p> <p>Haga que sus reuniones de vídeo formen parte de lo que hace en Workfront iniciando reuniones de Zoom desde el área de Actualizaciones. Haga clic en el icono de Zoom para insertar una dirección URL de reunión en un comentario y etiquetar a los compañeros para notificarles la reunión. Para unirse, simplemente puede hacer clic en el vínculo.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-mobile-enhancements.md#new" class="MCXref xref">Nuevo asistente virtual móvil</a> </p> <p>Con esta versión, llega el nuevo asistente virtual para la aplicación móvil de Workfront a Android y a iOS.</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#share" class="MCXref xref">Compartir un calendario con un vínculo privado</a> </p> <p>Para aliviar la carga que supone compartir calendarios en Workfront, puede compartir un vínculo privado que lleva a los usuarios directamente al calendario. El calendario debe compartirse con el usuario y este tiene que iniciar sesión para verlo.</p> <p>Anteriormente, se podía compartir una dirección URL pública que no requería iniciar la sesión para verla.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: 16 de julio de 2020</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#new" class="MCXref xref">Nuevo área de borradores al crear solicitudes</a> </p> <p>Para ofrecerle una mayor flexibilidad a la hora de trabajar con solicitudes, Workfront guarda ahora automáticamente todas las solicitudes que crea como borrador en la nueva área Borradores. Si no tiene toda la información necesaria para completar la nueva solicitud, puede dejarla como borrador, volver a ella y terminarla más tarde. Workfront guarda una solicitud por tema de la cola en la nueva área Borradores. Las solicitudes de borrador se pueden guardar durante el tiempo que las necesite hasta que esté listo para completarlas y enviarlas. También puede quitar o cambiar la posición del área Borradores del panel izquierdo mediante una plantilla de diseño.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: con la versión 20.3 </p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#expand" class="MCXref xref">Expandir o contraer elementos en la plantilla de horas</a> </p> <p>Para ayudarle a administrar fácilmente las plantillas de horas con varios elementos, ahora puede expandir o contraer todos los elementos con solo hacer clic en un botón.</p> <p>Anteriormente, tenía que hacer clic en cada elemento individualmente.</p> </td> 
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 2 de julio de 2020</p> <p>Versión de producción: 16 de julio de 2020</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponible en estas fechas:</strong> <p>Versión de vista previa beta: 3 de junio de 2020</p> <p>Versión de producción: 18 de junio de 2020</p> <p><strong>Disponible en estos entornos:</strong> </p> <p>La nueva experiencia de Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 

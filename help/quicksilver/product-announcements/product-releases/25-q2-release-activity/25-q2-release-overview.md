...
<!--    <tr>
    ...
    <tr>
        <td>
            ...
            <p>El visor de pruebas de escritorio se ha actualizado a la versión 2.1.45. Esta actualización permite al visor utilizar
            <ul><li>Electrón versión 35</li><li>Chromium versión 134</li><ul></p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
    ...
    <tr>
        <td>
            ...
            <p>Ahora puede editar varios documentos a la vez en un informe de documento. Puede editar las descripciones y actualizar formularios personalizados.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
...
<tbody>
    <tr>
        <td>
            ...
            <p>Existen varias mejoras disponibles para la funcionalidad de prueba en la aplicación móvil Adobe Workfront:
            <ul>
            <li>Ahora puede abrir un archivo de prueba desde su aplicación de correo electrónico móvil, desde un vínculo que se compartió con usted. Anteriormente, los enlaces de correos electrónicos no estaban soportados y tenías que acceder a las pruebas de la aplicación móvil Workfront.</li>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li>Producción para liberación rápida: con la versión 25.3 (marzo de 2025)</li>
                <li>Versión de producción para todos los clientes: con la versión 25.4 (abril de 2025)</li>
            </ul>
        </td>
    </tr>                          
...
<tbody>
    <tr>
        <td>
            ...
            <p>Ahora puede acceder a los datos para las aprobaciones y decisiones de documentos en Data Connect. Este conjunto de datos une las aprobaciones de documentos de las funciones de prueba Workfront y las aprobaciones de Frame.io que se están produciendo en documentos Workfront. Ahora podrá ilustrar el tiempo del ciclo, el número de ciclos y los impactos de la escala de tiempo para las aprobaciones tardías a través de sus visualizaciones de BI.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li>Esta función se lanzará a Producción en una implementación de tres fases: Comenzando con la versión 25.4 (10 de abril de 2025) y terminando el 17 de abril de 2024</li>
            </ul>
        </td>
    </tr>                          
</tbody>
...
<tbody>
    <tr>
        <td>
            ...
            [!BADGE In production ]{type=Informative}
            <p>Workfront ahora tiene versiones de suscripciones a eventos. La nueva versión no es un cambio en la API de Workfront, sino un cambio en la funcionalidad de suscripción a eventos. Puede cambiar las suscripciones a eventos a la nueva versión sin crear un intervalo en la suscripción de eventos</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
    ...
    <tr>
        <td>
            ...
            <p>En el segundo trimestre de 2025 se están realizando actualizaciones menores de la apariencia y el aspecto de varias áreas de la aplicación Adobe Workfront. Revise las notas de la versión individuales para ver fechas de lanzamiento específicas.</p>
        </td>
        <td>
            <p><b>Disponible en estas fechas:</b></p>
            <ul>
                <li>Versión preliminar: a lo largo del segundo trimestre de 2025</li>
...
A medida que mejoramos la plataforma de Workfront, es crucial mantener nuestras API actualizadas. Esto garantiza un rendimiento y seguridad óptimos y admite nuevas capacidades. Por lo tanto, estamos desaprobando las versiones de API Workfront 2-15.

* **Septiembre 2025**: las versiones de API 2-14, que actualmente no son compatibles, quedarán obsoletas. Después de esta fecha, estas versiones ya no serán accesibles.
* **Diciembre de 2025**: La versión 15 de la API quedará obsoleta.

#### Se está eliminando la vista de Agile heredada en un proyecto

La vista de Agile heredada en un proyecto se eliminará de Workfront con la versión 25.3 el 13 de marzo de 2025. Aún podrá ver sus tareas en una vista de Agile en un proyecto haciendo clic en el icono Tableros. Las herramientas de Agile heredadas existentes siguen estando disponibles en el área de Equipos.

La siguiente imagen muestra la opción de Agile heredada que se eliminará:
...
Las nuevas funciones de Workfront Planning están disponibles en el entorno de producción. Para obtener más información sobre las características más recientes, vea [actividad de versión de Adobe Workfront Planning Second Quarter 2025](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q2.md).
...
Para obtener información sobre las actualizaciones de mantenimiento realizadas durante el segundo trimestre de 2025, vea [Actualizaciones de mantenimiento de Workfront](https://experienceleague.adobe.com/es/docs/workfront-known-issues/releases/current-updates).

 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <!--
     ...
     -->
     <span style="color: #ff0000;">Eliminado de la versión</span></p> <p>Para tener un mayor control sobre cómo mostrar los resultados de la lista, ahora puede indicar si desea que los resultados de la agrupación se expandan o se contraigan de forma predeterminada al mostrar la lista o el informe. Esta opción está disponible dentro del generador de grupos en una lista o informe.</p> </td>

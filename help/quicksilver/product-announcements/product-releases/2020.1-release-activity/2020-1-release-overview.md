...
Para descargar esta página en formato de PDF, ve [aquí](https://documentation.my.workfront.com/library/a/9f5c9e44-c9a9-4f33-beec-9e5dc2e0fdc2).

Algunas funciones se lanzaron antes de la versión 2020.1. Para ver lo que se publicó antes de la versión 2020.1, consulte [Otras características de Workfront Classic lanzadas a producción antes de la versión 2020.1](../../../product-announcements/product-releases/2020.1-release-activity/prior-to-2020-1.md).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#limit" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Limitar la capacidad de los usuarios para editar los controles Filtrar, Ver y Agrupar en listas e informes</a><!--
   ...
   <td> <p>Versión preliminar de Beta: 17 de enero de 2020</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 14 de marzo de 2020</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 27 de febrero de 2020</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#highligh" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Resaltar elementos coincidentes en listas al usar los filtros rápidos</a><!--
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#new4" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Nueva opción para indicar cómo mostrar los resultados de agrupación en las listas</a> <!--
     ...
     --><span style="color: #ff0000;">Eliminada de la versión</span></p> <p>Para tener más control sobre cómo mostrar los resultados de la lista, ahora puede indicar si desea que los resultados de la agrupación se expandan o se contraigan de forma predeterminada al mostrar la lista o el informe. Esta opción está disponible dentro del generador de grupos en una lista o informe.</p> </td> 
   <td> <p>Versión preliminar de Beta: 17 de enero de 2020</p> <p>Versión de producción: N/D</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 8 de enero de 2020</p> <p>Versión de producción: 8 de enero de 2020</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#updated" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Se ha actualizado el aspecto de las nuevas listas</a><!--
     ...
     --><span style="color: #ff0000;">(Algunas actualizaciones de lista se eliminaron de la versión)</span> </p> <p>Las listas de proyectos, tareas y horas ahora tienen un aspecto actualizado. </p> <p>Cuando estas funciones se lanzaron originalmente a Vista previa, estaban disponibles para todos los informes y listas, excepto las listas de las áreas de Configuración e Informes. Estas funciones ahora solo están disponibles para listas de Proyectos, Tareas y Horas.</p> </td> 
   <td> <p>Versión de vista previa de Beta: 20 de diciembre de 2019</p> <p>Versión de producción planificada: con la versión 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Versión de vista previa de Beta: 14 de marzo de 2020</p> <p>Versión de producción: por determinar (esta función estará disponible en el entorno de producción poco después de la versión 2020.1).</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Versión preliminar de Beta: 31 de enero de 2020</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 14 de marzo de 2020</p> <p>Versión de producción: 26 de marzo de 2020</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 27 de febrero de 2020</p> <p>Versión de producción: 26 de marzo de 2020</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-project-enhancements.md#quote" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Citar un comentario anterior en un comentario o respuesta de actualización</a><!--
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 14 de febrero de 2020</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Versión de vista previa de Beta: 6 de diciembre de 2019</p> <p>Versión de producción planificada: con la versión 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Versión de vista previa de Beta: 6 de marzo de 2020</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-proofing-enhancements.md#document" class="MCXref xref" xrefformat="{para}">Icono de documento eliminado del visor de revisión</a> </p> <p>Se ha eliminado el icono del documento alineado con el nombre de la prueba en el visualizador de pruebas. Este icono se utiliza para ir a los detalles del documento.</p> <p>Ahora puede hacer clic en el nombre de la prueba para ir a la página de detalles del documento.</p> <p>Este icono se ha eliminado debido a un cambio en la nueva experiencia de Workfront: vínculo a las rutas de exploración nota de la versión.</p> </td> 
   <td> <p>Versión preliminar de Beta: 30 de enero de 2020</p> <p>Versión de producción planificada: con la versión 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Versión de vista previa de Beta: N/D</p> <p>Versión de producción: con la versión 2020.1</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versión de vista previa de Beta: 10 de marzo de 2020</p> <p>Versión de producción: con la versión <span style="color: #ff0000;"> de 2020.1 (se eliminó de la versión)</span></p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-other-enhancements.md#the" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Se ha eliminado el Optimizador de Portfolio de Flash</a><!--
  ...
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-other-enhancements.md#workfron" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Se ha actualizado el comportamiento de la cookie de Workfront para mantener la compatibilidad con Chrome</a><!--
     ...
     --> </p> <p>Para mantener la compatibilidad con una próxima actualización de Google Chrome (Chrome v80), hemos actualizado Workfront Platform para garantizar que las cookies se envíen correctamente con las solicitudes. </p> <p>Esta actualización de Chrome cambia el valor predeterminado del atributo de cookie SameSite. Si desea probar cómo se comportará la instancia de Workfront después de la actualización de Google Chrome, ajuste los indicadores en Chrome y habilite las siguientes opciones: </p> 
    <ul> 
     <li>"SameSite con cookies predeterminadas" </li> 
     <li>"Las cookies sin SameSite debe ser seguras"</li> 
    </ul> </td> 
   <td> <p>Versión de vista previa de Beta: 29 de enero de 2020</p> <p>Versión de producción: 30 de enero de 2020</p> </td> 
  </tr> 
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-other-enhancements.md#workfron2" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Comentarios de Workfront sincronizados con Jira</a><!--
   ...
   <td> <p>Versión de vista previa de Beta: 20 de diciembre de 2019</p> <p>Versión de producción: 20 de diciembre de 2019</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Versión 11 de la API incluida en la versión 2020.1. Para obtener información sobre novedades y actualizaciones, consulte [Novedades de la versión 11](../../../wf-api/api/new-api-version-11.md) de la API [Novedades de la versión 11](https://experience.workfront.com/s/article/What-s-new-in-API-version-11-1760875145) de la API.
...
* [Agregando dominios adicionales a la lista de permitidos necesaria para acceder a Workfront](#adding-additional-domains-to-the-allowlist-required-for-accessing-workfront)
* [Workfront One](#workfront-one)
* [Seminario web sobre la versión 2020.1](#2020-1-release-webinar)
* [Seminario web de hoja de ruta del producto en el primer trimestre](#q1-product-roadmap-webinar)

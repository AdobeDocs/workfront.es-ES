...
Para obtener información sobre el lapso de tiempo de lanzamiento y todas las funcionalidades disponibles con la versión 2020.1, consulte [Información general sobre la versión 2020.1](../../../product-announcements/product-releases/2020.1-release-activity/2020-1-release-overview.md).
 ...
 <tbody> 
  ...
  <tr> 
   <td>Menú Más en el área Actualizaciones <p>Utilice el menú Más de una actualización para:</p> 
    ...
    </ul> <p>Para obtener más información, consulte <a href="../../../workfront-basics/updating-work-items-and-viewing-updates/update-work.md" class="MCXref xref" xrefformat="{para}">Trabajo de actualización</a>.</p> 
    <div class="workfront_plans"> 
     <p><strong>Disponible en estos entornos:</strong> </p> 
     <ul> 
      <li>Workfront Classic</li> 

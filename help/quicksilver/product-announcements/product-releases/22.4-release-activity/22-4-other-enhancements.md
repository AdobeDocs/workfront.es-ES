---
title: Otras mejoras de la versión 22.4
description: Otras mejoras de la versión 22.4
author: Luke
draft: Probably
...
# Otras mejoras de la versión 22.4

En esta página se describen todas las demás mejoras implementadas con la versión 22.4 en el entorno de vista previa. Estas mejoras estarán disponibles la semana del 3 de octubre de 2022.
...
[Descargue Adobe Workfront para InDesign desde el Marketplace hoy mismo](https://exchange.adobe.com/apps/cc/108938/adobe-workfront-for-indesign).
...
## Sincronización de metadatos de objetos con la integración nativa de Experience Manager Assets
...
Para permitir que los metadatos de objeto se sincronicen automáticamente, debe habilitar el conmutador Sincronizar metadatos de objeto para sus integraciones en Configuración > Integraciones de Experience Manager.
...
Para obtener más información, consulte [Envío de documentos a Experience Manager Assets o Assets Essentials](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/send-to-aem.md).

## Descripción del equipo ampliada

En el área Equipos, ya es posible ver la descripción completa del equipo haciendo clic en la descripción para mostrarla en una ventana emergente. Se puede hacer clic en cualquier dirección URL de la descripción en la ventana emergente y hacer clic en el texto de la descripción para editarlo (si tiene acceso para editar la configuración del equipo).

Anteriormente, la única manera de ver todo el contenido era desplazarse por la descripción en un área estrecha.

Esta mejora en la descripción se aplica tanto a los equipos Agile como a los que no lo son.
...
>[!NOTE]
>
>Esta función se introdujo originalmente en la vista previa durante el ciclo de lanzamiento de la versión 22.3.

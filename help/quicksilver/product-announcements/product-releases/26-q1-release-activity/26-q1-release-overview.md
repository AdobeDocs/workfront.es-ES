---
title: Información general de la versión del primer trimestre de 2026
description: En esta página se ofrece información sobre la funcionalidad incluida en la versión del primer trimestre de 2026. Se prevé que estas mejoras estén disponibles en el entorno de producción durante todo el trimestre.
author: Courtney
...
Las mejoras de esta página están disponibles en el entorno de vista previa. Esta página se actualizará con mejoras adicionales a medida que se acerque la fecha prevista para el lanzamiento de la versión del primer trimestre de 2026.
...
>|----|----|
>| <ul><li>25.11 (13 de noviembre de 2025)</li><li>25.12 (11 de diciembre de 2025)</li><li>26.1 (14 de enero de 2026)</li></ul> | <ul><li>26.1 (15 de enero de 2026)</li></ul> |
>
>Tenga en cuenta que, para la versión final de cada trimestre (26.1 este trimestre), los usuarios de programación de versiones rápidas recibirán la versión un día antes.
>
...
<table style="table-layout:auto">
  <tbody>
   <tr>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Administrar prioridades en la plantilla de diseño</a>
            <p><span class="preview">Temporalmente no disponible en el entorno de vista previa</span></p>
            <p>Ahora puede habilitar o deshabilitar las prioridades para usuarios específicos en la plantilla de diseño. Si anteriormente tenía las prioridades deshabilitadas para su organización, permanecerán deshabilitadas en la plantilla de diseño con este cambio.</p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2025</td>
        <td>15 de enero de 2025</td>
    </tr>  
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Buscar conflictos de varios formularios en los campos personalizados calculados</a>
            <p>Para proporcionar visibilidad sobre los objetos que pueden verse afectados al editar una expresión en campos personalizados, se ha añadido una opción para comprobar si hay conflictos. Este cuadro de diálogo muestra todos los objetos que pueden verse afectados por el cambio de la fórmula, agrupados por tipo de objeto. Puede navegar a los detalles de cada objeto y revisar los campos para decidir si el campo se debe quitar de cualquiera de los formularios o la expresión debe permanecer sin cambios.</p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2025</td>
        <td>15 de enero de 2025</td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Fecha de entrada e ingresado por identificador almacenado en objetos personalizados</a><p>[!BADGE Off schedule]{type=Neutral}</p>
            <p>La fecha de entrada e ID de Introducido por ahora se guardan en formularios, campos y secciones personalizados. Puede utilizar estas opciones de datos en los informes como filtros, vistas o agrupaciones. Para mostrarlos en la lista de formularios, campos o secciones personalizados en la configuración, añada la fecha de entrada e Introducido por: Nombre como columnas en una vista nueva o existente.</p>
        </td>
    ...
    <tr>
        <td>
            ...
            <p>Cuando hay un gran número de campos personalizados en el sistema, la administración de esos campos en formularios e informes personalizados puede resultar complicada. Ahora puede marcar los campos personalizados como inactivos con el nuevo indicador <b>Activo</b>. Este indicador está disponible al trabajar con un campo en un formulario personalizado o cuando se añade o edita un campo de la lista Campos. </p>
        </td>
        <td>30 de octubre de 2025</td>
        <td>13 de noviembre de 2025</td>
        <td>15 de enero de 2026</td>
...
<table style="table-layout:auto">
  <tbody>
    ...
    -->
       ...
       <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}">Elija un proyecto de Workfront al enviar una revisión en Adobe Express<p>[!BADGE Off schedule]{type=Neutral}</p> </a>
            <p>Puede elegir un proyecto de Workfront al que enviar una prueba. Esto mantiene todos los recursos y pruebas relevantes organizados dentro del mismo proyecto.</p>
        </td>
        <td>15 de diciembre de 2025</td>
        <td>15 de diciembre de 2025</td>
        <td>15 de diciembre de 2025</td>
    </tr> 
     <tr>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}">Adobe Experience Manager ya está disponible con la integración de Frame.io <p>[!BADGE Off schedule]{type=Neutral}</p> </a>
            <p>Ahora puede utilizar Experience Manager Assets para administrar y almacenar los recursos digitales que hayan pasado por el ciclo de revisión y aprobación. Esta integración le permite aprovechar las capacidades de Adobe Experience Manager, Frame.io y Workfront para optimizar los procesos de colaboración y administración de contenido. </p>
        </td>
        <td>30 de octubre de 2025</td>
        <td>30 de octubre de 2025</td>
        <td>30 de octubre de 2025</td>
  ...
  <tbody>
   <tr>
        ...
        <td><strong>Trimestralmente</strong></td>
         ...
         <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-home.md" class="MCXref xref" xrefformat="{para}">Actualización del widget Menciones en Inicio</a>
            <p>Hemos realizado las siguientes mejoras en el widget Menciones de Inicio: <ul><li>La misma experiencia en el área de Actualizaciones de la mayoría de los objetos de Workfront ahora también está disponible en el widget Menciones de Inicio. </li><li>El widget Menciones ahora contiene los comentarios que el usuario ha realizado o en los que se ha etiquetado durante las últimas dos semanas.</li><ul></p>
        </td>
        <td>17 de diciembre de 2025</td>
  ...
  <tbody>
   <tr>
        ...
        <td><strong>Trimestralmente</strong></td>
         ...
         <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-integrations.md" class="MCXref xref" xrefformat="{para}">Elección de un proyecto de Workfront al enviar una revisión en Creative Cloud Express</a><p>[!BADGE Off schedule]{type=Neutral}</p>
            <p>Puede elegir un proyecto de Workfront al que enviar una prueba. Esto mantiene todos los recursos y pruebas relevantes organizados dentro del mismo proyecto. </p>
        </td>
        <td>15 de diciembre de 2025</td>
        <td>15 de diciembre de 2025</td>
        <td>15 de diciembre de 2025</td>
         ...
         <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-integrations.md" class="MCXref xref" xrefformat="{para}">Se ha actualizado el selector de recursos para la integración nativa de Adobe Workfront para Experience Manager Assets </a>
            <p>Hemos actualizado el selector de recursos en la integración de Adobe Workfront para Experience Manager Assets. Con esta actualización, ahora puede seleccionar y extraer colecciones de AEM directamente en Workfront. </p>
        </td>
        <td>20 de noviembre de 2025</td>
        <td>11 de diciembre de 2025</td>
        <td>15 de enero de 2026</td>
    </tr>   
    <!--
     <tr>
...
<table style="table-layout:auto">
 ...
 <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Actualizaciones de moneda en paneles de lienzo</a>
            <p>Hemos realizado las siguientes actualizaciones para los campos de moneda:<ul><li>Cuando se definen varias monedas en Workfront, ahora puede elegir una moneda predeterminada para el panel durante la creación. </li><li>Al crear un informe, puede bloquear un campo de moneda. Esto garantiza que la preferencia de moneda a nivel de panel no afecte a la visualización de estos valores.</li><li>Al ver un panel, los usuarios pueden alternar entre cualquier moneda definida en Workfront. Estos cambios se aplican a todo el tablero, excepto a los campos de moneda bloqueados.</li></ul></p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
 ...
 <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}"> Resultados de tabla de búsqueda rápida en paneles de lienzo</a>
            <p>Hemos añadido una búsqueda rápida a los informes de tabla. Esta búsqueda funciona en todas las páginas, por lo que puede encontrar datos aunque no estén visibles actualmente.</p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Nueva opción Mostrar total para gráficos circulares</a>
            <p>Hemos introducido la nueva opción Mostrar total que convierte los gráficos circulares en gráficos de anillo. Esta función permite a los usuarios mostrar un valor central que representa el total de todos los segmentos del gráfico.</p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Nuevas opciones de configuración para gráficos circulares en paneles de lienzo</a>
            <p>Hemos introducido dos nuevas opciones de configuración para los gráficos circulares: <ul><li>Ocultar etiquetas de segmento: ahora puede elegir ocultar las etiquetas de segmento en un gráfico circular si son demasiado largas y afectan a la legibilidad del gráfico.</li><li>Ocultar y cambiar la posición de la leyenda del gráfico: ahora puede ocultar la leyenda de un gráfico circular. También puede establecer la posición de la leyenda en la parte derecha (predeterminado), izquierda, superior o inferior del gráfico. </li></ul></p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Mejoras en el recuento de agrupación de paneles de lienzo</a>
            <p>Hemos actualizado la barra de agrupación en los paneles de lienzo para mostrar el recuento de registros de la página actual y el recuento general de registros de la agrupación en todas las páginas. </p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Nueva característica de líneas de referencia en los informes de los paneles de lienzo</a>
            <p>Ahora puede definir una línea de referencia en los gráficos de barras, columnas y líneas para establecer un objetivo o umbral para los cuatro informes basados en series. </p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Personalizar etiquetas de eje en informes de gráficos en paneles de lienzo</a>
            <p>Ahora puede personalizar las etiquetas de eje en los informes de gráficos. Esta nueva función le permite introducir una etiqueta de eje de reemplazo para mostrar en lugar del objeto y la ruta de campo predeterminados. Además, puede optar por ocultar completamente las etiquetas de eje.</p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
     ...
     <tr>
        ...
        <td>23 de octubre de 2025</td>
        <td>23 de octubre de 2025</td>
        <td>23 de octubre de 2025</td>
    </tr>   
       <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}">Eliminación de las opciones de campo de los filtros de informe</a>
       ...
       <tr>
        <td>
            ...
            <p>Para evitar retrasos en el tiempo de carga y mejorar el rendimiento general en los paneles de lienzo, hemos aplicado límites en la cantidad de componentes de panel que se pueden añadir a un panel:
            <ul>
            <li>Informes por panel: límite de 25</li>
            ...
            <li>Indicaciones de filtro a nivel de panel: límite de 10</li>
            </ul></p>
        </td>
       <td>6 de noviembre de 2025</td>
        <td>13 de noviembre de 2025</td>
...
<table style="table-layout:auto">
  <tbody>
   <tr>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md" class="MCXref xref" xrefformat="{para}">Añadir campos personalizados a la lista de solicitudes y al widget Mis solicitudes</a>
            <p>Para facilitarle la visualización de la información que necesita, hemos añadido la capacidad de añadir campos personalizados como columnas a la lista de solicitudes y al widget Mis solicitudes en Inicio. Ahora puede añadir campos de formularios personalizados como una columna, y las solicitudes que tengan información en ese campo mostrarán esa información en la lista o widget.</p><p>Esta funcionalidad solo está disponible en la nueva experiencia de Solicitudes.</p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md" class="MCXref xref" xrefformat="{para}">El comodín del usuario actual ya está disponible en el filtro de Solicitudes</a>
            <p>Para facilitar el filtrado de las solicitudes que se le aplican, hemos creado un comodín de usuario actual. Ahora, al filtrar, puede seleccionar “Yo (usuario con sesión iniciada)”. El filtro se aplica al usuario que está viendo la lista de solicitudes.   </p>
        </td>
        <td>18 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
    ...
    <tr>
        <td>
            ...
            <p>Para facilitar la creación de solicitudes, se ha creado el relleno de formulario con tecnología de IA. Ahora, puede pegar una indicación o cargar un documento en un formulario de solicitud, y la AI extraerá la información relevante y rellenará el formulario.  </p>
        </td>
        <td>11 de diciembre de 2025</td>
        <td>11 de diciembre de 2025</td>
        <td>11 de diciembre de 2025</td>
    ...
    <tr>
        ...
        <td>4 de diciembre de 2025</td>
        <td>14 de enero de 2026</td>
        <td>15 de enero de 2026</td>
    </tr> 
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md" class="MCXref xref" xrefformat="{para}">Guardar borradores de solicitudes en la nueva experiencia de solicitud</a>
        ...
        <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md" class="MCXref xref" xrefformat="{para}">Cree nuevas solicitudes copiando las solicitudes enviadas anteriormente en la nueva experiencia de solicitud</a>
            <p>Para facilitar el envío de solicitudes, se ha añadido la capacidad de copiar solicitudes a la nueva experiencia de solicitud. Ahora puede copiar una solicitud, editar cualquier campo y enviarla como una solicitud nueva. </p>
        </td>
        <td>20 de noviembre de 2025</td>
        <td>11 de diciembre de 2025</td>
        <td>15 de enero de 2026</td>
...
<table>
        ...
        <td><strong>Trimestralmente</strong></td>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-other.md" class="MCXref xref" xrefformat="{para}">Actualizaciones de apariencia durante el periodo de tiempo del primer trimestre de 2026</a>
                        <p>En el periodo de tiempo de la versión del primer trimestre de 2026 se realizarán actualizaciones menores de la apariencia de varias áreas de la aplicación de Adobe Workfront. </p>
                    </td>
                    <td><p>Durante el periodo de tiempo de la versión del primer trimestre de 2026<br /></p>
                    <td colspan="2"><p>Versión rápida: un mínimo de una semana después del lanzamiento a Vista previa (a menos que se especifique lo contrario)</p>
                            </li>
                        </ul>
                    </td>
                </tr>
...
#### Obsolescencia de la moneda de anulación en las funciones con la versión 25.11

Como parte de la simplificación del modelo financiero, el 30 de octubre en Vista previa dejaremos de utilizar la moneda de anulación en las funciones del puesto, y en Producción, para todos los clientes, con la versión 25.11. Este cambio afecta a la forma en que se configuran las divisas y las tarifas en las funciones del área de Configuración.

* Los campos **Anular moneda** de una función ya no estarán disponibles.
* Cada función tendrá una sola moneda con su costo asociado y tasa de facturación.
* Se migrarán automáticamente todas las monedas de anulación actuales y sus valores de tipo de cambio para que se conviertan en la única divisa y tipo de cambio de dicha función.

## Modernización de interfaces

Estamos actualizando la interfaz a través de Adobe Workfront para mejorar la experiencia del usuario y unificarla con otras aplicaciones de Adobe. Estos cambios se lanzan fuera de la programación de la versión estándar. Para obtener una lista de estos cambios, consulte [Modernización de la interfaz](/help/quicksilver/product-announcements/product-releases/interface-modernization/interface-modernization.md).
...
El visor de revisión de escritorio se ha actualizado a la versión 2.1.52 y corrige varios errores.

La actualización de la versión 2.1.51 incluía actualizaciones de las herramientas internas y no afectaba a la funcionalidad para el usuario final.

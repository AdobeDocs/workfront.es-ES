...
* Editar proyectos en línea en la vista de tabla de una página de registros conectada
* Se ha agregado el vínculo Nueva fila a la parte inferior de la vista de tabla al ver proyectos conectados, donde puede agregar nuevos proyectos sin plantilla
* Ya no puede crear páginas de registros conectadas para portafolios y programas de Workfront. Solo puede crear páginas de registros conectados para proyectos de Workfront.

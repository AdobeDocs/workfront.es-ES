...
Para obtener más información acerca de los tokens heredados, vea [¿Puedo volver a activar los tokens heredados de Exchange Online?](https://learn.microsoft.com/en-us/office/dev/add-ins/outlook/faq-nested-app-auth-outlook-legacy-tokens#can-i-turn-exchange-online-legacy-tokens-back-on) en la documentación de Microsoft.

...
title: 'Convertir correos electrónicos de Google Workspace en objetos y actualizaciones de  [!DNL Adobe Workfront] '
description: Puede convertir correos electrónicos normales que no sean de Workfront en objetos y actualizaciones de  [!DNL Adobe Workfront]  sin salir de Gmail.
author: Becky
...
# Convertir correos electrónicos de Google Workspace en objetos y actualizaciones de [!DNL Adobe Workfront] 
...
Puede convertir correos electrónicos normales que no sean de [!DNL Workfront] en objetos y actualizaciones de [!DNL Adobe Workfront] sin salir de [!DNL G Mail]. Para obtener más información, consulte los siguientes artículos:

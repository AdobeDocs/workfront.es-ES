...
title: Acceso [!DNL Adobe Workfront] objetos de un vínculo compartido en [!DNL Slack]
description: Cuando los vínculos a [!DNL Adobe Workfront] los objetos se comparten con usted en un canal de Slack, puede ver información adicional sobre ellos en Slack, una vez que haya instalado y configurado [!DNL Workfront] para Slack.
author: Becky

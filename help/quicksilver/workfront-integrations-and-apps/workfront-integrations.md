...
description: Adobe Workfront ofrece integraciones con otras aplicaciones comunes, como [!DNL Adobe Creative Cloud], [!DNL Salesforce], Jira y Slack. Este artículo vincula a la documentación de todas las integraciones que se ofrecen actualmente.
...
* [[!DNL Adobe Workfront] información general sobre integraciones integradas](../workfront-integrations-and-apps/built-in-integrations-non-admin.md)
* [[!DNL Adobe Workfront] métodos de integración](../workfront-integrations-and-apps/built-in-vs-api-vs-fusion.md)

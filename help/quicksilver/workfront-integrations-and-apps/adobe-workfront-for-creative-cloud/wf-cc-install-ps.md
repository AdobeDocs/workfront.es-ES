...
Puede instalar el [!DNL Adobe Workfront for Photoshop] complemento de [!DNL Adobe Marketplace]. El complemento es compatible con los siguientes idiomas:
...
## Instale el [!DNL Adobe Workfront for Photoshop] complemento para su organización
...
## Instale el [!DNL Adobe Workfront for Photoshop] complemento individualmente
...
1. En el **[!UICONTROL Panel de complementos]**, elija la **[!UICONTROL Complementos]** pestaña y buscar **[!UICONTROL Workfront para Adobe Photoshop]**.

   >[!TIP]
   >
   >   Si no ve el complemento después de abrirlo desde el [!UICONTROL Panel de complementos]Sin embargo, podría estar detrás de la aplicación de Photoshop. Intente minimizar Photoshop para encontrar el complemento.
...
1. Introduzca su dominio y haga clic en **[!UICONTROL Iniciar sesión]**. Se abre una página del explorador. Es posible que tenga que dar permiso a Photoshop para abrir el explorador.
...
1. Volver atrás a [!UICONTROL Adobe Photoshop] para ver tu trabajo.

...
# Carga de pruebas desde [!DNL Illustrator]
...
* Debe instalar [!DNL Adobe Workfront for design and video] para poder cargar pruebas desde [!DNL Illustrator].
...
1. (Opcional) Escriba un comentario en el área **[!UICONTROL Actualizaciones]**.
   ...
   ![Agregar comentario a la aprobación automatizada](assets/add-comment-automated-approval.png)

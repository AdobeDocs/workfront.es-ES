...
1. En el explorador, introduzca sus credenciales de [!DNL Workfront] y haga clic en **[!UICONTROL Iniciar sesión]**. Si su empresa utiliza un inicio de sesión único (SSO), se le redirigirá a la página de su proveedor de SSO para iniciar sesión.
   ...
   >[!NOTE]
   >
   >Es posible que no se le pida que introduzca sus credenciales de [!DNL Adobe] si ha iniciado sesión recientemente.
...
1. Elimine la carpeta que almacena el dominio del complemento.
   ...
   >[!TIP]
   >
   >En un Mac, vaya a Finder y presione **Comando+Mayús+.** para mostrar las carpetas ocultas, vaya a **/Users/username/Library/Application Support** y, a continuación, elimine la carpeta **Workfront**. Debe reemplazar `username` con su nombre de usuario de Mac.

...
* Anuncios del producto {#product-announcements}
   ...
   * Versiones de productos {#product-releases}
      ...
      * Actividad de la versión {#fusion-release} de Adobe Workfront Fusion
         ...
         * [Actividad de la versión de Workfront Fusion: Semana del sábado, 01 de septiembre de 2023](/help/quicksilver/product-announcements/product-releases/fusion-release-activity/fusion-2023-9-1.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 11 de julio de 2022](product-announcements/product-releases/fusion-release-activity/fusion-july-11-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 27 de junio de 2022](product-announcements/product-releases/fusion-release-activity/fusion-jun-27-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 20 de junio de 2022](product-announcements/product-releases/fusion-release-activity/fusion-jun-20-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 16 de mayo de 2022](product-announcements/product-releases/fusion-release-activity/fusion-may-16-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 09 de mayo de 2022](product-announcements/product-releases/fusion-release-activity/fusion-may-9-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 25 de abril de 2022](product-announcements/product-releases/fusion-release-activity/fusion-apr-25-22.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 28 de febrero de 2022](product-announcements/product-releases/fusion-release-activity/fusion-feb-28-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 21 de febrero de 2022](product-announcements/product-releases/fusion-release-activity/fusion-feb-21-22.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 14 de febrero de 2022](product-announcements/product-releases/fusion-release-activity/fusion-feb-14-22.md)
         ...
         * [Actividad en la versión de Workfront Fusion: semana del martes, 29 de noviembre de 2021](product-announcements/product-releases/fusion-release-activity/fusion-nov-29-21.md)
         * [Actividad en la versión de Workfront Fusion: semana del martes, 15 de noviembre de 2021](product-announcements/product-releases/fusion-release-activity/fusion-nov-15-21.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 30 de agosto de 2021](product-announcements/product-releases/fusion-release-activity/fusion-aug-30-21.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 23 de agosto de 2021](product-announcements/product-releases/fusion-release-activity/fusion-aug-23-21.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 17 de mayo de 2021](product-announcements/product-releases/fusion-release-activity/fusion-may-17.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 10 de mayo de 2021](product-announcements/product-releases/fusion-release-activity/fusion-may-10.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 26 de abril de 2021](product-announcements/product-releases/fusion-release-activity/fusion-apr-26.md)
         * [Actividad de la versión de Workfront Fusion: semana del martes, 19 de abril de 2021](product-announcements/product-releases/fusion-release-activity/fusion-apr-19.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 01 de febrero de 2021](product-announcements/product-releases/fusion-release-activity/fusion-feb-1.md)
         * [Actividad de la versión de Workfront Fusion: Semana del martes, 25 de enero de 2021](product-announcements/product-releases/fusion-release-activity/fusion-jan-25.md)
         * [Actividad de la versión de Workfront Fusion: Semana del martes, 18 de enero de 2021](product-announcements/product-releases/fusion-release-activity/fusion-jan-18.md)
         * [Actividad de la versión de Workfront Fusion: Semana del martes, 11 de enero de 2021](product-announcements/product-releases/fusion-release-activity/fusion-jan-11.md)
         ...
         * [Actividad de la versión de Workfront Fusion: semana del martes, 24 de agosto de 2020](product-announcements/product-releases/fusion-release-activity/fusion-release-archive/fusion-release-archive-2020/fusion-aug-24.md)
         ...
         * [Actividad en la versión de Workfront Fusion: semana del martes, 16 de noviembre de 2020](product-announcements/product-releases/fusion-release-activity/fusion-release-archive/fusion-release-archive-2020/fusion-nov-16.md)
         * [Actividad en la versión de Workfront Fusion: semana del martes, 30 de noviembre de 2020](product-announcements/product-releases/fusion-release-activity/fusion-release-archive/fusion-release-archive-2020/fusion-nov-30.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * [Plantilla de tabla de accesos de Fusion](/help/quicksilver/workfront-fusion/fusion-access-table-template.md)
   * Introducción a Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      ...
      * [Información general de Workfront Fusion](workfront-fusion/get-started/workfront-fusion-overview.md)
      * [Navegar por la nueva experiencia en Workfront Fusion](workfront-fusion/get-started/new-fusion-ui.md)
      * [Términos básicos en Adobe Workfront Fusion](workfront-fusion/get-started/basic-terms.md)
      * Escenarios de práctica de compilación {#practice-scenarios-in-workfront-fusion}
         * [Crear escenarios de práctica](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/create-practice-scenarios.md)
         * [Crear un escenario básico en  [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/create-simple-scenario.md)
         * [Añadir un módulo de activador a un escenario básico en  [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/add-trigger-to-simple-scenario.md)
         * [Usar una función para actualizar un proyecto en un escenario simple en [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/update-a-project-simple-scenario.md)
      ...
      * [Uso de archivos grandes en Fusion](/help/quicksilver/workfront-fusion/get-started/fusion-large-files.md)
   ...
   * Adobe Workfront Fusion en Adobe Experience Cloud {#fusion-in-experience-cloud}
      ...
      * [Agregar usuarios a Adobe Workfront Fusion mediante Adobe Admin Console](/help/quicksilver/workfront-fusion/fusion-in-admin-console/add-fusion-users-admin-console.md)
   ...
   * Errores en Adobe Workfront Fusion {#errors-in-fusion}
      ...
      * [Control de errores de lanzamiento en Adobe Workfront Fusion](workfront-fusion/errors/throw.md)
   ...
   * Módulos en Adobe Workfront Fusion {#modules-in-fusion}
      ...
      * [Elegir dónde se inicia un módulo de activador en Adobe Workfront Fusion](workfront-fusion/modules/choose-where-trigger-module-starts.md)
      ...
      * [Módulo del agregador en Adobe Workfront Fusion](workfront-fusion/modules/aggregator-module.md)
      * [Módulo Enrutador de Adobe Workfront Fusion](workfront-fusion/modules/router-module.md)
      * [Módulo del iterador en Adobe Workfront Fusion](workfront-fusion/modules/iterator-module.md)
   ...
   * Escenarios en Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * [Información general sobre los escenarios de Adobe Workfront Fusion](workfront-fusion/scenarios/scenario-overview.md)
      ...
      * [El panel de ajustes de escenarios en Adobe Workfront Fusion](workfront-fusion/scenarios/scenario-settings-panel.md)
   ...
   * Aplicaciones de Workfront Fusion y sus módulos {#fusion-apps-and-modules}
      ...
      * [Adobe de módulos de User Management](workfront-fusion/apps-and-their-modules/adobe-user-management-modules.md)
      * [Módulos de Airtable](workfront-fusion/apps-and-their-modules/airtable-modules.md)
      ...
      * [Módulos de archivo](workfront-fusion/apps-and-their-modules/archive-modules.md)
      ...
      * [Módulos de Box](workfront-fusion/apps-and-their-modules/box-modules.md)
      ...
      * [Módulos de [!DNL Draft.js]](/help/quicksilver/workfront-fusion/apps-and-their-modules/draft-js-modules.md)
      ...
      * [Cifrador de datos](workfront-fusion/apps-and-their-modules/encryptor-modules.md)
      ...
      * [Módulos GitHub](workfront-fusion/apps-and-their-modules/github.md)
      ...
      * [Módulos Formularios de Google](workfront-fusion/apps-and-their-modules/google-forms-modules.md)
      * [Módulos de Google Sheets](workfront-fusion/apps-and-their-modules/google-sheets-modules.md)
      * [Módulos de Google Slides](workfront-fusion/apps-and-their-modules/google-slides-modules.md)
      ...
      * [Módulos de Microsoft Office 365 Excel](workfront-fusion/apps-and-their-modules/microsoft-365-excel-modules.md)
      ...
      * [Módulos de [!DNL OpenAI(ChatGPT & DALL-E)]](workfront-fusion/apps-and-their-modules/openai-chatgpt-modules.md)
      * [Módulos de Qualtrics](workfront-fusion/apps-and-their-modules/qualtrics-modules.md)
      * [Módulos Quickbase](workfront-fusion/apps-and-their-modules/quickbase-modules.md)
      ...
      * [Módulos de ServiceNow](workfront-fusion/apps-and-their-modules/servicenow-modules.md)
      ...
      * [Módulos de Widen](workfront-fusion/apps-and-their-modules/widen-modules.md)

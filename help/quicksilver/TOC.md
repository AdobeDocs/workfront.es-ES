...
* Anuncios de productos {#product-announcements}
   ...
   * Versiones de productos {#product-releases}
      ...
      * Versión del primer trimestre de 2026 {#release-26-q1}
         ...
         * [Mejoras de documentos y aprobación del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md)
         ...
         * [Mejoras en las integraciones del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-integrations.md)
         * [Mejoras del proyecto del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-projects.md)
         * [Mejoras en los informes del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md)
         ...
         * [Primer trimestre de 2026 Otras mejoras](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-other.md)
      * Versión del cuarto trimestre de 2025 {#release-25-q4}
         ...
         * [Mejoras en los paneles del cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-dashboards.md)
         * [Mejoras de documentos y pruebas del cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-document-and-proof.md)
      ...
      * Versión del tercer trimestre de 2025 {#release-25-q3}
         ...
         * [Mejoras de corrección y administración de documentos](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-document-mgmt-enhancements.md)
         * [Mejoras en el proyecto](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-project-enhancements.md)
      ...
      * Actividad de la versión de disponibilidad limitada de Adobe Workfront{#limited-availability-release-activity}
         * [Actividad de la versión de funciones de disponibilidad limitada de Adobe Workfront](/help/quicksilver/product-announcements/product-releases/limited-availability-release-activity/limited-availability-release-activity-article-index.md)
...
* Administración y configuración {#administration-and-setup}
   ...
   * Configuración de Workfront {#set-up-wf}
      ...
      * Configurar valores predeterminados del sistema {#configure-system-defaults}
         ...
         * [Importación de tarjetas de tasa desde una plantilla](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/import-rate-cards.md)
...
* Conceptos básicos de Adobe Workfront {#basics}
   ...
   * Navegar por Adobe Workfront {#navigate}
      ...
      * [Agregar un tablero en el panel izquierdo de un objeto o área de Workfront](workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/create-custom-tabs.md)
...
* Agile {#agile}
   ...
   * Introducción a los tableros en Adobe Workfront {#boards-in-workfront}
      ...
      * [Administrar la vista de administración de tableros](/help/quicksilver/agile/get-started-with-boards/manage-boards-admin-view.md)
...
* Administrar trabajo {#manage-work}
   ...
   * Proyectos {#projects}
      ...
      * Definir un caso comercial {#define-business-case}
         ...
         * [Resumen de áreas de caso comercial](manage-work/projects/define-a-business-case/areas-of-business-case.md)
   ...
   * Administración de portafolios {#portfolio-management}
      ...
      * Información general sobre Portfolio en Adobe Workfront {#portfolio-overview-in-adobe-workfront}
         * [Portfolios: índice de artículos](manage-work/portfolios/portfolios-overview/portfolio-overview-1.md)
      ...
      * Administrar proyectos en Portfolio Optimizer {#manage-projects-in-portfolio-optimizer}
         * [Administrar proyectos en Portfolio Optimizer: índice de artículos](manage-work/portfolios/portfolio-optimizer/manage-projects-in-portfolio-optimizer.md)
...
* Equipos y grupos {#teams-groups}
   ...
   * Trabajar con grupos y equipos {#work-with-groups-teams}
      ...
      * [Grupos vs. equipos en Workfront](people-teams-and-groups/work-with-groups-and-teams/understanding-differences-and-similarities-between-groups-and-teams.md)
...
* Informes {#reporting}
   ...
   * Paneles de control de lienzo {#canvas-dashboards}
      ...
      * Administrar informes {#manage-reports}
         ...
         * [Duplicación de un informe en un panel de lienzo](/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-reports/duplicate-a-report.md)
...
* Revisar y aprobar el trabajo {#review-and-approve-work}
   ...
   * Aprobación unificada {#document-reviews-and-approvals}
      ...
      * [Información general sobre permisos y acceso al almacenamiento empresarial de Adobe](/help/quicksilver/review-and-approve-work/esm-access-permissions.md)
      * Configuración y administración de aprobaciones de recursos y documentos {#manage-asset-review-and-approval}
         * [Configurar y administrar aprobaciones unificadas: índice de artículos](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/set-up-and-manage-doc-asset-approvals-toc.md)
         * [Crear revisores de IA](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/set-up-ai-reviewer.md)
         ...
         * [Uso conjunto de aprobaciones unificadas y pruebas](review-and-approve-work/document-reviews-and-approvals/doc-approvals-and-proofing.md)
      ...
      * Revisión y aprobación de recursos y documentos {#review-and-approve-documents}
         ...
         * [Ver puntuación y comentarios del revisor de IA](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/view-ai-reviewer-feedback.md)
...
* Planificador de escenarios de Adobe Workfront {#scenario-planner}
   ...
   * [Solicitar permisos para un plan en el Scenario Planner](scenario-planner/request-access-to-plan.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * Arquitectura de Adobe Workfront Planning {#adobe-workfront-planning-architecture}
      ...
      * [Información general sobre jerarquías y rutas](planning/architecture/hierarchy-and-breadcrumb-overview.md)
      * [Crear jerarquías de Workspace](planning/architecture/create-workspace-hierarchies.md)
      ...
      * [Información general sobre tipos de registros entre espacios de trabajo](planning/architecture/cross-workspace-record-types-overview.md)
   ...
   * Registros de Adobe Workfront Planning {#adobe-workfront-planning-records}
      ...
      * [Agregar una página Registros conectados a un registro](planning/records/add-a-connected-records-page-to-a-record.md)
   ...
   * Adobe Workfront Planning and Gen Studio para la integración de marketing de rendimiento {#planning-and-genstudio-integration}
      * [Integración de Adobe Workfront Planning y Adobe GenStudio for Performance Marketing: índice de artículo](planning/planning-and-genstudio-integration/planning-and-genstudio-integration-article-index.md)
      * [Introducción a la integración de Adobe Workfront Planning y Adobe GenStudio for Performance Marketing](planning/planning-and-genstudio-integration/get-started-with-workfront-planning-and-genstudio-integration.md)
   ...
   * Planificación de Adobe Workfront independiente {#planning-standalone}
      * [Adobe Workfront Planning Standalone: índice de artículos](planning/planning-sta/planning-sta-article-index.md)
      * [Introducción a Adobe Workfront Planning Standalone](planning/planning-sta/get-started-with-planning-sta.md)
* Integraciones de Adobe Workfront {#adobe-workfront-integrations}
   ...
   * Adobe Workfront para Outlook {#workfront-for-outlook}
      * [Adobe Workfront for Outlook: índice de artículos](workfront-integrations-and-apps/using-workfront-with-outlook/workfront-for-outlook.md)

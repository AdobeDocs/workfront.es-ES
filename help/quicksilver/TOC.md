...
* Anuncios de productos {#product-announcements}
   ...
   * Versiones de productos {#product-releases}
      ...
      * Versión 23.2 {#release-23-2}
         ...
         * [Actividad de la versión 23.2: Semana del 27 de febrero de 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-27.md)
   ...
   * Programas beta {#beta}
      ...
      * Lienzo de informes beta {#reporting-canvas-beta}
         * [Resumen de lienzo de informes beta](product-announcements/betas/reporting-canvas-beta/reporting-canvas-beta-overview.md)
         * [Lienzo de informes beta: actividad de versión](product-announcements/betas/reporting-canvas-beta/reporting-canvas-release-activity.md)
* Administración y configuración {#administration-and-setup}
   ...
   * Introducción a la administración {#get-started-administration}
      * [Introducción a](administration-and-setup/get-started-wf-administration/get-started-with-wf-administration.md)
      ...
      * [Administrar las licencias](administration-and-setup/get-started-wf-administration/manage-available-licenses-in-your-system.md)
   ...
   * Configuración de Workfront {#set-up-wf}
      ...
      * Configuración organizativa {#organization-setup}
         ...
         * [Crear y administrar roles](administration-and-setup/set-up-workfront/organizational-setup/create-manage-job-roles.md)
   ...
   * Agregar usuarios {#add-users}
      * [Adición de usuarios a Workfront](administration-and-setup/add-users/add-users.md)
   ...
   * Personalizar Adobe Workfront {#customize}
      ...
      * Formularios personalizados {#custom-forms}
         ...
         * [Colocar campos y widgets personalizados](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
         * [Uso compartido para campos y widgets personalizados](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
         * [Reutilización de un campo o widget personalizado](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
         * [Agregar lógica de visualización y omitir lógica](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
   ...
   * Administrar Adobe Workfront {#manage-wf}
      ...
      * Tasas de cambio {#exchange-rates}
         ...
         * [Configurar tasas de cambio](administration-and-setup/manage-workfront/exchange-rates/set-up-exchange-rates.md)
   ...
   * Configuración de integraciones {#configure-integrations}
      ...
      * [Configurar asignación de metadatos](administration-and-setup/configure-integrations/set-up-metadata-mapping.md)
...
* Conceptos básicos de Adobe Workfront {#basics}
   ...
   * Actualizar elementos de trabajo y ver actualizaciones {#update-work-items-view-updates}
      ...
      * [Información general de la pestaña Actualizaciones](workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md)
...
* Agile {#agile}
   ...
   * Agile en proyectos {#agile-in-projects}
      * [Agile en proyectos](agile/agile-in-projects/agile-in-projects.md)
      * [Proyecto de Agile](agile/agile-in-projects/use-agile-on-a-project.md)
...
* Documentos {#documents}
   ...
   * Integraciones de Workfront y Experience Manager Assets {#wf-aem-integrations}
      ...
      * Adobe Workfront para Experience Manager Assets y Assets Essentials {#wf-aem-essentials}
         ...
         * [Información general sobre integraciones de Adobe Experience Manager Assets](documents/adobe-workfront-for-experience-manager-assets-essentials/aem-asset-integrations.md)
         ...
         * [Visualización de metadatos asignados para Experience Manager Assets o Assets Essentials](documents/adobe-workfront-for-experience-manager-assets-essentials/view-asset-metadata.md)
...
* Administración de recursos {#manage-resources}
   ...
   * Administración de recursos {#resource-management}
      ...
      * [Migración de la programación de recursos al Distribuidor de cargas de trabajo](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
   ...
   * Revisión {#proofing}
      ...
      * Revisión de pruebas en Adobe Workfront {#review-proofs-in-workfront}
         ...
         * Revisión de una revisión {#review-a-proof}
            * [Revisión de una revisión](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-a-proof.md)

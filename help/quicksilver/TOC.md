...
* Conceptos básicos de Adobe Workfront {#basics}
   ...
   * Navegar por Adobe Workfront {#navigate}
      ...
      * [Resumen de objetos [!DNL Adobe Workfront]](workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md)
   ...
   * Actualizar elementos de trabajo y ver actualizaciones {#update-work-items-view-updates}
      ...
      * [Creación de tareas personales](workfront-basics/updating-work-items-and-viewing-updates/create-personal-tasks.md)
...
* Administrar trabajo {#manage-work}
   ...
   * Tareas {#tasks}
      ...
      * Información de tarea {#task-information}
         ...
         * [Resumen de las fechas proyectadas y estimadas](manage-work/tasks/task-information/differentiate-projected-estimated-dates.md)
...
* Revisar y aprobar el trabajo {#review-and-approve-work}
   ...
   * Revisión {#proofing}
      ...
      * Resumen de revisión {#proofing-overview}
         * [Resumen de revisión: índice del artículo](review-and-approve-work/proofing/proofing-overview/proofing-basics.md)
      ...
      * Administrar revisiones en Adobe Workfront {#manage-proofs-in-workfront}
         ...
         * Administrar plazos de revisión {#manage-proof-deadlines}
            * [Administrar plazos de prueba: índice de artículos](review-and-approve-work/proofing/managing-proofs-within-workfront/manage-proof-deadlines/manage-proof-deadlines.md)
         ...
         * Administrar revisiones automatizadas {#manage-automated-proofs}
            * [Administrar pruebas automatizadas: índice de artículos](review-and-approve-work/proofing/managing-proofs-within-workfront/manage-automated-proofs/manage-automated-proofs.md)
      ...
      * Usar el Visor de corrección de escritorio {#use-the-desktop-proofing-viewer}
         * [Uso del Visor de corrección de escritorio: índice del artículo](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/use-desktop-proofing-viewer.md)
      ...
      * Revisar revisiones en Adobe Workfront {#review-proofs-in-workfront}
         ...
         * Tomar una decisión sobre una revisión {#make-decision-on-proof}
            * [Tomar una decisión sobre una prueba: índice de artículos](review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decision-on-proof.md)
      ...
      * Sugerencias, trucos y solución de problemas para la revisión en Adobe Workfront {#ttt-proofing-in-workfront}
         * [Sugerencias, trucos y solución de problemas para la revisión en Adobe Workfront: índice de artículos](review-and-approve-work/proofing/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-proofing.md)
         ...
         * [El nombre del documento cambió después de la carga y contiene un carácter no válido](review-and-approve-work/proofing/tips-tricks-and-troubleshooting/document-to-proof-name.md)
         * [Probar un PowerPoint con un vídeo incrustado](review-and-approve-work/proofing/tips-tricks-and-troubleshooting/powerpoint-with-video.md)
...
* Planificación de Adobe Workfront {#adobe-workfront-planning}
   ...
   * Información general de Adobe Workfront Planning {#adobe-workfront-planning-general-information}
      ...
      * [Prácticas recomendadas de Adobe Workfront Planning](planning/general/planning-best-practices.md)
   ...
   * Campos de Adobe Workfront Planning {#adobe-workfront-planning-fields}
      ...
      * [Resumen del campo principal](planning/fields/primary-field-overview.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Introducción a Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      ...
      * [Navegue por la nueva experiencia en Workfront Fusion](workfront-fusion/get-started/new-fusion-ui.md)
      ...
      * Escenarios de práctica de compilación {#practice-scenarios-in-workfront-fusion}
         ...
         * [Agregar un módulo de déclencheur a un escenario básico en  [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/add-trigger-to-simple-scenario.md)
         ...
         * [Agregar un filtro a un escenario básico en  [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/add-filter-simple-scenario.md)
         * [Agregar un webhook a un escenario básico en  [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/get-started/build-practice-scenarios/add-a-webhook.md)
...
* Integraciones de Adobe Workfront {#adobe-workfront-integrations}
   ...
   * Adobe Workfront para el Creative Cloud {#workfront-for-creative-cloud}
      ...
      * Cargar documentos y pruebas con el complemento de Adobe Workfront para aplicaciones de Creative Cloud {#upload-docs-proofs-wf-cc}
         ...
         * [Cargar pruebas de  [!DNL Illustrator]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-proofs-ai.md)
         * [Cargar documentos de  [!DNL Illustrator]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-ai-docs.md)

...
* Anuncios del producto {#product-announcements}
   ...
   * Versiones de productos {#product-releases}
      ...
      * Versión 23.3 {#release-23-3}
         * [Información general sobre la versión 23.3](product-announcements/product-releases/23.3-release-activity/23-3-release-overview.md)
         * [semana de actividad de la versión 23.3 del 10 de abril de 2023](product-announcements/product-releases/23.3-release-activity/23-3-apr-10.md)
         * [semana de actividad de la versión 23.3 del 17 de abril de 2023](product-announcements/product-releases/23.3-release-activity/23-3-apr-17.md)
         * [semana de actividad de la versión 23.3 del 24 de abril de 2023](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-apr-24.md)
         * [semana de actividad de la versión 23.3 del 1 de mayo de 2023](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-may-4.md)
         * [semana de actividad de la versión 23.3 del 8 de mayo de 2023](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-may-10.md)
         * [semana de actividad de la versión 23.3 del 15 de mayo de 2023](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-may-15.md)
         * [Actualizaciones de aspecto durante el lapso de tiempo de la versión 23.3](product-announcements/product-releases/23.3-release-activity/23-3-look-and-feel-updates.md)
      ...
      * Actividad de la versión de objetivos de Adobe Workfront {#goals-release}
         ...
         * Objetivos con la versión 23.3 {#goals-23-3}
            * [Objetivos de Adobe Workfront con la versión 23.3](product-announcements/product-releases/goals-release-activity/goals-23-3-release/goals-23-3-release.md)
            * [Actividad de la versión 23.3 de objetivos de Adobe Workfront: Semana del 1 de mayo de 2023](product-announcements/product-releases/goals-release-activity/goals-23-3-release/goals-23-3-may-5.md)
         * Objetivos con la versión 23.2 {#goals-23-2}
            * [Objetivos de Adobe Workfront con la versión 23.2](product-announcements/product-releases/goals-release-activity/goals-23-2-release/goals-23-2-release.md)
            * [Actividad de la versión 23.2 de los objetivos de Adobe Workfront: Semana del 20 de marzo de 2023](product-announcements/product-releases/goals-release-activity/goals-23-2-release/goals-march.md)
      ...
      * Actividad de la versión de prueba de Workfront {#proof-release}
         * Prueba con la versión 23.3 {#proof-23-3-release}
            * [Prueba de Adobe Workfront con la versión 23.3](/help/quicksilver/product-announcements/product-releases/workfront-proof-release-activity/proof-23-3-release/proof-23-3-overview.md)
            * [Actividad de la versión Adobe Workfront Proof 23.3: Semana del 8 de mayo de 2023](/help/quicksilver/product-announcements/product-releases/workfront-proof-release-activity/proof-23-3-release/proof-23-3-may-8.md)
   ...
   * Programas beta {#beta}
      ...
      * Nueva experiencia de comentarios beta {#new-commenting-experience-beta}
         * [Nueva información de experiencia beta de comentarios](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-information.md)
         ...
         * [Nueva actividad de versión de experiencia beta de comentarios](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-release-activity.md)
* Administración y configuración {#administration-and-setup}
   ...
   * Agregar usuarios {#add-users}
      ...
      * Funcionamiento de los nuevos niveles de acceso {#access-levels}
         ...
         * [Información general sobre los nuevos niveles de acceso](administration-and-setup/add-users/how-access-levels-work/access-level-overview.md)
         ...
         * [Acceso a objetos y áreas por parte de las nuevas licencias](administration-and-setup/add-users/how-access-levels-work/access-to-objects-areas-license-types.md)
         * [Funcionalidad disponible para cada tipo de objeto para nuevos niveles de acceso](administration-and-setup/add-users/how-access-levels-work/functionality-available-for-objects.md)
      * Funcionamiento de los niveles de acceso {#legacy-access-levels}
         ...
         * [Información general de acceso](administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md)
...
* Conceptos básicos de Adobe Workfront {#basics}
   ...
   * Sugerencias, trucos y resolución de problemas para conceptos básicos de Adobe Workfront {#tips-tricks-for-basics}
      ...
      * [El filtro Proyectos en los que estoy activo incluye resultados inesperados](workfront-basics/tips-tricks-and-troubleshooting/projects-im-on-filter-including-unexpected-results.md)
* Agile {#agile}
...
* Revisar y aprobar el trabajo {#review-and-approve-work}
   ...
   * Sugerencias, trucos y resolución de problemas para aprobaciones {#ttt-approvals}
      * [Sugerencias, trucos y resolución de problemas para aprobaciones](review-and-approve-work/tips-tricks-troubleshooting-approvals/tips-tricks-troubleshooting-approvals.md)
      * [Ver el número de decisiones de prueba y documento de todos los usuarios](review-and-approve-work/tips-tricks-troubleshooting-approvals/view-number-of-decisions-for-users.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Aplicaciones de Workfront Fusion y sus módulos {#fusion-apps-and-modules}
      ...
      * [Módulos de aire](workfront-fusion/apps-and-their-modules/airtable-modules.md)

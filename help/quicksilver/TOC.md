...
* Anuncios del producto {#product-announcements}
  ...
  * Versiones del producto {#product-releases}
    * [Información general de versiones del producto](product-announcements/product-releases/product-releases.md)
    ...
    * Versión del cuarto trimestre de 2026 {#release-26-q4}
      ...
      * [Cuarto trimestre de 2026 Solicitud de mejoras](/help/quicksilver/product-announcements/product-releases/26-q4-release-activity/26-q4-requests.md)
      ...
      * [Cuarto trimestre de 2026 Otras mejoras](/help/quicksilver/product-announcements/product-releases/26-q4-release-activity/26-q4-other.md)
    * Versión del tercer trimestre de 2026 {#release-26-q3}
      ...
      * [Mejoras de IA en el tercer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-ai.md)
      ...
      * [Mejoras en la administración de recursos del tercer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-resource-mgmt.md)
    ...
    * Versión del segundo trimestre de 2026 {#release-26-q2}
      ...
      * [Mejoras en los documentos del segundo trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md)
      * [Mejoras en operaciones empresariales del segundo trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-enterprise-operations-enhancements.md)
      ...
      * [Mejoras en los informes del segundo trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md)
      * [Segundo trimestre de 2026 Solicitud de mejoras](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-requests.md)
    ...
    * Versión del primer trimestre de 2026 {#release-26-q1}
      * [Información general de la versión del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-release-overview.md)
      ...
      * [Mejoras en la aprobación y en los documentos del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md)
      * [Mejoras en el Inicio del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-home.md)
      * [Mejoras en la integración del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-integrations.md)
      * [Mejoras en los proyectos del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-projects.md)
      * [Mejoras en la creación de informes del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md)
      * [Mejoras en las solicitudes del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md)
      * [Otras mejoras del primer trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-other.md)
    * Versión del cuarto trimestre de 2025 {#release-25-q4}
      ...
      * [Mejoras del administrador en el cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-admin-and-setup.md)
      * [Mejoras en la panel del cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-dashboards.md)
      * [Mejoras en documentos y revisión del cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-document-and-proof.md)
      * [Mejoras en la página de inicio en el cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-home.md)
      ...
      * [Mejoras en la administración de recursos del cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-resource-mgmt.md)
      ...
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del cuarto trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-look-and-feel-updates.md)
    * Versión del tercer trimestre de 2025 {#release-25-q3}
      ...
      * [Mejoras de revisión y administración de documentos](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-document-mgmt-enhancements.md)
      * {hide-from-toc}[Mejoras en el proyecto](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-project-enhancements.md)
      * [Mejoras en el Inicio](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-home-enhancements.md)
      ...
      * [Mejoras en notificaciones y actualizaciones](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-update-and-notification-enhancements.md)
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del tercer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-look-and-feel-updates.md)
    * Versión del segundo trimestre de 2025 {#release-25-q2}
      ...
      * [Mejoras de administrador en la versión del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-administrator-enhancements.md)
      * [Mejoras de administración de documentos del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-document-mgmt-enhancements.md)
      * [Mejoras en aplicaciones móviles del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-mobile-enhancements.md)
      * [Mejoras en los proyectos del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-project-enhancements.md)
      * [Mejoras en la creación de informes del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-reporting-enhancements.md)
      * [Otras mejoras durante el periodo de tiempo de la versión del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-other-enhancements.md)
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del segundo trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q2-release-activity/25-q2-look-and-feel-updates.md)
    * Versión del primer trimestre de 2025 {#release-25-q1}
      ...
      * [Mejoras de administrador del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md)
      * [Mejoras en los tableros del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-boards-enhancements.md)
      * [Mejoras de administración de documentos del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-document-mgmt-enhancements.md)
      * [Mejoras en el inicio del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md)
      * [Mejoras en los proyectos del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-project-enhancements.md)
      * [Mejoras de la revisión del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-proofing-enhancements.md)
      ...
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del primer trimestre de 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-look-and-feel-updates.md)
    * Versión del cuarto trimestre de 2024 {#release-24-q4}
      * [Información general sobre la versión del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-release-overview.md)
      * [Mejoras de administrador del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-administrator-enhancements.md)
      * [Mejoras de administración de documentos del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-document-mgmt-enhancements.md)
      * [Mejoras en la integración del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-integration-enhancements.md)
      * [Mejoras en el inicio del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-home-enhancements.md)
      * [Mejoras en los proyectos del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-project-enhancements.md)
      * [Mejoras de revisión del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-proofing-enhancements.md)
      * [Mejoras en informes y paneles del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-report-and-dashboard-enhancements.md)
      ...
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del cuarto trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-look-and-feel-updates.md)
    * Versión del tercer trimestre de 2024 {#release-24-q3}
      * [Información general de la versión del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-release-overview.md)
      * [Mejoras para administradores del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-administrator-enhancements.md)
      * [Mejoras de administración financiera del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-financial-mgmt-enhancements.md)
      * [Mejoras en la integración del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-integration-enhancements.md)
      * [Mejoras en los proyectos del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-project-enhancements.md)
      * [Mejoras de revisión del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-proofing-enhancements.md)
      ...
      * [Otras mejoras durante el período de tiempo de la versión del tercer trimestre de 2024](product-announcements/product-releases/24-q3-release-activity/24-q3-other-enhancements.md)
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del tercer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-look-and-feel-updates.md)
    * Versión del segundo trimestre de 2024 {#release-24-q2}
      ...
      * [Mejoras de administrador del segundo trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-administrator-enhancements.md)
      * [Mejoras de administración de documentos del segundo trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-document-mgmt-enhancements.md)
      * [Mejoras en el inicio del segundo trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-home-enhancements.md)
      * [Mejoras en la integración del segundo trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-integration-enhancements.md)
      * [Mejoras en los proyectos del segundo trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-project-enhancements.md)
      ...
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del segundo trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-look-and-feel-updates.md)
    * Versión del primer trimestre de 2024 {#release-24-q1}
      * [Información general de la versión del primer trimestre de 2024](product-announcements/product-releases/24-q1-release-activity/24-q1-release-overview.md)
      * [Mejoras de administrador del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-administrator-enhancements.md)
      * [Mejoras de administración de documentos del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-document-mgmt-enhancements.md)
      * [Mejoras en los tableros del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-boards-enhancements.md)
      * [Mejoras en el inicio del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-home-enhancements.md)
      * [Mejoras en la integración del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-integration-enhancements.md)
      * [Mejoras en los proyectos del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-project-enhancements.md)
      * [Mejoras en las notificaciones y flujos de actualización del primer trimestre de 2024](/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-update-stream-enhancements.md)
    * Versión del cuarto trimestre de 2023 {#release-23-q4}
      * [Información general sobre la versión del cuarto trimestre de 2023](product-announcements/product-releases/23-q4-release-activity/23-q4-release-overview.md)
      * [Mejoras de administrador del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-admin-enhancements.md)
      * [Mejoras en los tableros del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-boards-enhancements.md)
      * [Mejoras de administración financiera del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-financial-mgmt-enhancements.md)
      * [Mejoras en el inicio del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-home-enhancements.md)
      * [Mejoras en la integración del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-integration-enhancements.md)
      * [Mejoras en los proyectos del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-project-enhancements.md)
      * [Otras mejoras del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-other-enhancements.md)
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión del cuarto trimestre de 2023](/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-look-and-feel-updates.md)
    * Versión 23.3 {#release-23-3}
      ...
      * [23.3 Mejoras en Administración financiera](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-finance-enhancements.md)
      ...
      * [23.3 Mejoras en aplicaciones móviles](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-mobile-enhancements.md)
    ...
    * Versión 23.2 {#release-23-2}
      ...
      * [23.2 Mejoras en los informes y paneles](product-announcements/product-releases/23.2-release-activity/23-2-reports-dashboards.md)
      * [23.2 Mejoras para dispositivos móviles](product-announcements/product-releases/23.2-release-activity/23-2-mobile-enhancements.md)
    ...
    * Versión 23.1 {#release-23-1}
      ...
      * [23.1 Mejoras en la administración de proyectos y recursos](product-announcements/product-releases/23.1-release-activity/23-1-project-enhancements.md)
    ...
    * Versión 22.4 {#release-22-4}
      ...
      * [22.4 Mejoras para administradores](product-announcements/product-releases/22.4-release-activity/22-4-administrator-enhancements.md)
      * [22.4 Mejoras del proyecto](product-announcements/product-releases/22.4-release-activity/22-4-project-enhancements.md)
      * [22.4 Mejoras en Agile](product-announcements/product-releases/22.4-release-activity/22-4-agile-enhancements.md)
    ...
    * Versión 22.3 {#release-22-3}
      ...
      * [22.3 Mejoras para administradores](product-announcements/product-releases/22.3-release-activity/22-3-admin-enhancements.md)
      ...
      * [22.3 Mejoras en la administración de recursos](product-announcements/product-releases/22.3-release-activity/22-3-resource-management-enhancements.md)
      * [22.3 Mejoras en la creación de informes](product-announcements/product-releases/22.3-release-activity/22-3-reporting-enhancements.md)
      * [Actualizaciones de apariencia durante el periodo de tiempo de la versión 22.3](product-announcements/product-releases/22.3-release-activity/22-3-look-and-feel-updates.md)
    * Versión 22.2 {#release-22-2}
      ...
      * [22.2 Mejoras para administradores](product-announcements/product-releases/22.2-release-activity/22-2-admin-enhancements.md)
      * [22.2 Mejoras en los proyectos](product-announcements/product-releases/22.2-release-activity/22-2-project-enhancements.md)
      * [22.2 Mejoras en la administración de recursos](product-announcements/product-releases/22.2-release-activity/22-2-resource-management-enhancements.md)
      * [22.2 Mejoras en el inicio](product-announcements/product-releases/22.2-release-activity/22-2-home-enhancements.md)
      * [22.2 Mejoras para dispositivos móviles](product-announcements/product-releases/22.2-release-activity/22-2-mobile-enhancements.md)
    ...
    * Versión 22.1 {#release-22-1}
      * [Información general sobre la versión 22.1](product-announcements/product-releases/22.1-release-activity/22-1-release-overview.md)
      * [22.1 Mejoras para administradores](product-announcements/product-releases/22.1-release-activity/22-1-admin-enhancements.md)
      * [22.1 Mejoras del proyecto](product-announcements/product-releases/22.1-release-activity/22-1-project-enhancements.md)
      * [22.1 Mejoras en la administración de recursos](product-announcements/product-releases/22.1-release-activity/22-1-resource-mgt-enhancements.md)
      * [22.1 Mejoras de las solicitudes](product-announcements/product-releases/22.1-release-activity/22-1-requests-enhancements.md)
      ...
      * [22.1 Mejoras en la aplicación móvil](product-announcements/product-releases/22.1-release-activity/22-1-mobile-enhancements.md)
    * Versión 21.4 {#release-21-4}
      * [Información general sobre la versión 21.4](product-announcements/product-releases/21.4-release-activity/21-4-release-overview.md)
      * [21.4 Mejoras para administradores](product-announcements/product-releases/21.4-release-activity/21-4-admin-enhancements.md)
      ...
      * [21.4 Mejoras en la creación de informes](product-announcements/product-releases/21.4-release-activity/21-4-reporting-enhancements.md)
    ...
    * Versión 21.2 {#release-21-2}
      * [Información general sobre la versión 21.2](product-announcements/product-releases/21.2-release-activity/21-2-release-overview.md)
      ...
      * [21.2 Mejoras en la administración de recursos](product-announcements/product-releases/21.2-release-activity/21-2-resource-management-enhancements.md)
    ...
    * Versión 21.1 {#release-21-1}
      ...
      * [21.1 Mejoras para administradores](product-announcements/product-releases/21.1-release-activity/21-1-admin-enhancements.md)
      ...
      * [21.1 Mejoras de análisis mejorado](product-announcements/product-releases/21.1-release-activity/21-1-enhanced-analytics-improvements.md)
    ...
    * Actividad de la versión del planificador de escenarios de Adobe Workfront {#scenario-planner-release}
      ...
      * [Planificador de escenarios de Workfront con la versión 20.3: 14 de agosto de 2020](product-announcements/product-releases/scenario-planner-release-activity/sp-release-20-3.md)
    * Actividad de la versión de Adobe Workfront Goals {#goals-release}
    ...
    * Actividad de la versión de Workfront Proof {#proof-release}
      * Proof, versión 23.3 {#proof-23-3-release}
    ...
    * Modernización de interfaces {#interface-modernization}
    ...
    * Archivo de versión trimestral {#quarterly-release}
      ...
      * Versión 20.4 {#release-20-4}
        ...
        * [20.4 Mejoras de Proof](product-announcements/product-releases/20.4-release-activity/20-4-proof-enhancements.md)
        * [20.4 Mejoras en aplicaciones móviles e integración](product-announcements/product-releases/20.4-release-activity/20-4-mobile-enhancements.md)
      ...
      * Versión 20.3 {#release-20-3}
        ...
        * [20.3 Mejoras en la administración de recursos](product-announcements/product-releases/20.3-release-activity/20-3-resource-management-enhancements.md)
        ...
        * [20.3 Mejoras de Proof](product-announcements/product-releases/20.3-release-activity/20-3-proof-enhancements.md)
      ...
      * Versión 20.2 {#release-20-2}
        * [Información general de la versión 2020.2](product-announcements/product-releases/2020.2.-release-activity/2020-2-release-overview.md)
        * [2020.2 Mejoras para dispositivos móviles](product-announcements/product-releases/2020.2.-release-activity/2020-2-mobile-enhancements.md)
        * [2020.2 Otras mejoras](product-announcements/product-releases/2020.2.-release-activity/2020-2-other-enhancements.md)
        * [2020.2 Mejoras en los proyectos](product-announcements/product-releases/2020.2.-release-activity/2020-2-project-enhancements.md)
        ...
        * [Mejoras en la administración de recursos de la versión 2020.2: equilibrador de carga](product-announcements/product-releases/2020.2.-release-activity/2020-2-resource-management.md)
      * Versión 20.1 {#release-20-1}
        ...
        * [2020.1 Mejoras para dispositivos móviles](product-announcements/product-releases/2020.1-release-activity/2020-1-mobile-enhancements.md)
        * [2020.1 Otras mejoras](product-announcements/product-releases/2020.1-release-activity/2020-1-other-enhancements.md)
        * [2020.1 Mejoras en los proyectos](product-announcements/product-releases/2020.1-release-activity/2020-1-project-enhancements.md)
        * [2020.1 Mejoras de revisión](product-announcements/product-releases/2020.1-release-activity/2020-1-proofing-enhancements.md)
        * [2020.1 Mejoras en la administración de recursos](product-announcements/product-releases/2020.1-release-activity/2020-1-resource-management-enhancements.md)
      ...
      * Versión 2019.4 {#release-19-4}
        ...
        * [2019.4 Mejoras en la aplicación móvil](product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/2019-4-mobile-enhancements.md)
        * [Otras mejoras de la versión 2019.4](product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/2019-4-other-enhancements.md)
        * [2019.4 Mejoras en la administración de recursos](product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/2019-4-resource-management-enhancements.md)
      ...
      * Versión 2019.3 {#release-19-3}
        ...
        * [2019.3 Mejoras en el inicio](product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-home-enhancements.md)
      ...
      * Versión 2019.2 {#release-19-2}
        ...
        * [2019.2 Mejoras para administradores](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019-2-administrator-enhancements.md)
        * [2019.2 Mejoras de Agile](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019-2-agile-enhancements.md)
        * [2019.2 Integración y mejoras en la aplicación móvil](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019-2-integration-enhancements.md)
        ...
        * [2019.2 Mejoras de revisión](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019-2-proofing-enhancements.md)
        * [2019.2 Mejoras en la administración de recursos](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019-2-resource-management-enhancements.md)
      * Versión 2019.1 {#release-19-1}
        ...
        * [2019.1 Mejoras en aplicaciones móviles e integración](product-announcements/product-releases/quarterly-release-archive/2019.1-release-activity/2019-1-mbl-intgrtn-enhncmnts.md)
        * [2019.1 Mejoras en los proyectos](product-announcements/product-releases/quarterly-release-archive/2019.1-release-activity/2019-1-project-enhancements.md)
        * [2019.1 Mejoras de revisión](product-announcements/product-releases/quarterly-release-archive/2019.1-release-activity/2019-1-proofing-enhancements.md)
        * [2019.1 Mejoras en la administración de recursos](product-announcements/product-releases/quarterly-release-archive/2019.1-release-activity/2019-1-rsrc-mngmnt-enhncmnts.md)
      * Versión 2018.3 {#release-18-3}
        ...
        * [Actividad de la versión 2018.3 Beta 1](product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-1-release-activity.md)
        ...
        * [Actividad de la versión 2018.3 Beta 4](product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-4-release-activity.md)
        ...
        * [Versión beta final 2018.3](product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-final.md)
      * Versión 2018.2 {#release-18-2}
        ...
        * [Actividad de la versión 2018.2 beta 1](product-announcements/product-releases/quarterly-release-archive/2018.2-release-activity/2018-2-beta-1-release-activity.md)
        ...
        * [Actividad de la versión 2018.2 beta 4](product-announcements/product-releases/quarterly-release-archive/2018.2-release-activity/2018-2-beta-4-release-activity.md)
        * [Actividad de la versión 2018.2 beta 5](product-announcements/product-releases/quarterly-release-archive/2018.2-release-activity/2018-2-beta-5-release-activity.md)
        * [Actividad de la versión 2018.2 beta final](product-announcements/product-releases/quarterly-release-archive/2018.2-release-activity/2018-2-beta-final-release-activity.md)
      * Versión 2018.1 {#release-18-1}
        ...
        * [Actividad de la versión 2018.1 beta 2](product-announcements/product-releases/quarterly-release-archive/2018.1-release-activity/2018-1-beta-2-release-activity.md)
        * [Actividad de la versión 2018.1 beta 3](product-announcements/product-releases/quarterly-release-archive/2018.1-release-activity/2018-1-beta-3-release-activity.md)
        * [Actividad de la versión 2018.1 beta 4](product-announcements/product-releases/quarterly-release-archive/2018.1-release-activity/2018-1-beta-4-release-activity.md)
        * [Actividad de la versión 2018.1 beta final](product-announcements/product-releases/quarterly-release-archive/2018.1-release-activity/2018-1-beta-final-release-activity.md)
      * Versión 2017.3 {#release-17-3}
        ...
        * [Actividad de la versión 2017.3 beta final](product-announcements/product-releases/quarterly-release-archive/2017.3-release-activity/2017-3-beta-final-release-activity.md)
      ...
      * Versión 2017.2 {#release-17-2}
        ...
        * [Versión 2017.2 beta final](product-announcements/product-releases/quarterly-release-archive/2017.2-release-activity/2017-2-beta-final.md)
      ...
      * Versión de Workfront R1 {#r1-release}
        * [La versión de Workfront R1](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/workfront-r1-release.md)
  ...
  * Anuncios {#announcements}
    ...
    * [Guía de obsolescencia de análisis mejorado](product-announcements/announcements/enhanced-analytics-deprecation.md)
    ...
    * Archivo de anuncios {#announcement-archive}
      ...
      * [Eliminación de suplantación de identidad por correo electrónico y respuesta POP](product-announcements/announcements/announcement-archive/email-spoofing-pop-reply-message.md)
  ...
  * Programas beta {#beta}
    ...
    * Beta de los paneles de lienzo {#canvas-dashboards-beta}
      ...
      * {hide-from-toc}[Resumen de la versión beta del lienzo de informes](product-announcements/betas/canvas-dashboards-beta/reporting-canvas-beta-overview.md)
      * {hide-from-toc}[Paneles de lienzo beta: actividad de la versión](product-announcements/betas/canvas-dashboards-beta/canvas-dashboards-release-activity.md)
    * Nueva experiencia de comentarios en beta {#new-commenting-experience-beta}
      * {hide-from-toc}[Nueva información sobre la experiencia beta de comentarios](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-information.md)
      * {hide-from-toc}[Nueva experiencia para comentar](product-announcements/betas/new-commenting-experience-beta/unified-commenting-experience.md)
      * {hide-from-toc}[Nueva actividad para la versión de la experiencia de comentarios](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-release-activity.md)
      * {hide-from-toc}[Preguntas frecuentes sobre la nueva experiencia de comentarios](product-announcements/betas/new-commenting-experience-beta/new-commenting-faq.md)
* Administración y configuración {#administration-and-setup}
  ...
  * Introducción a la administración {#get-started-administration}
    * [Introducción a los administración: índice de artículos](administration-and-setup/get-started-wf-administration/get-started-with-wf-administration.md)
    ...
    * [Configuración de conceptos básicos](administration-and-setup/get-started-wf-administration/configure-basic-info.md)
  ...
  * Configurar Workfront {#set-up-wf}
    ...
    * Configurar valores predeterminados del sistema {#configure-system-defaults}
      * [Configuración de los valores predeterminados del sistema: índice de artículos](administration-and-setup/set-up-workfront/configure-system-defaults/configure-system-defaults.md)
      * [Configurar las preferencias de proyecto](administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md)
    ...
    * Configurar las preferencias de horarios y plantillas de horas {#configure-timesheets-schedules}
      ...
      * [Preferencias de horas y plantillas de horas](administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md)
    ...
    * Configuración de la organización {#organization-setup}
      ...
      * [Anular tarifas de facturación de función](administration-and-setup/set-up-workfront/organizational-setup/override-job-role-billing-rates-company-level.md)
    * Fuentes de actualización rastreada por el sistema {#system-tracked-updates}
    ...
    * Entornos de prueba de Adobe Workfront {#testing-environments}
      ...
      * [Entorno de vista previa de zona protegida](administration-and-setup/set-up-workfront/workfront-testing-environments/wf-preview-sandbox-environment.md)
      * [Entorno de actualización de zona protegida personalizado](administration-and-setup/set-up-workfront/workfront-testing-environments/wf-custom-refresh-sandbox-environment.md)
      * [Información general sobre la promoción del entorno](/help/quicksilver/administration-and-setup/set-up-workfront/workfront-testing-environments/environment-promotion-in-wf.md)
  ...
  * Administración de usuarios {#add-users}
    * [Administración de usuarios: índice de artículos](administration-and-setup/add-users/add-users.md)
    ...
    * Configurar acceso a Workfront {#configure-access}
      * [Configurar acceso](administration-and-setup/add-users/configure-and-grant-access/configure-access.md)
      * [Crear y modificar niveles de acceso personalizados](administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md)
      ...
      * [Conceder acceso administrativo a determinadas áreas](administration-and-setup/add-users/configure-and-grant-access/grant-users-admin-access-certain-areas.md)
      ...
      * [Concesión de acceso a informes, paneles y calendarios](administration-and-setup/add-users/configure-and-grant-access/grant-access-reports-dashboards-calendars.md)
      * [Concesión de acceso a los portafolios](administration-and-setup/add-users/configure-and-grant-access/grant-access-portfolios.md)
      ...
      * [Concesión de acceso a filtros, vistas y agrupaciones](administration-and-setup/add-users/configure-and-grant-access/grant-access-fvg.md)
      * [Concesión de acceso al planificador de escenarios](administration-and-setup/add-users/configure-and-grant-access/grant-access-sp.md)
    ...
    * Inicio de sesión único en Workfront {#sso}
      ...
      * [Configurar Workfront con SAML 2.0](administration-and-setup/add-users/single-sign-on/configure-workfront-saml-2.md)
      * [Actualizar metadatos de SAML 2.0 en el proveedor de identidad](administration-and-setup/add-users/single-sign-on/update-saml-2-metadata-ip.md)
  ...
  * Personalizar Adobe Workfront {#customize}
    ...
    * Promoción de la marca personalizada en Adobe Workfront {#custom-branding}
      * [Promoción de la marca personalizada](administration-and-setup/customize-workfront/brand-workfront/brand-workfront.md)
      * [Personalizar su instancia](administration-and-setup/customize-workfront/brand-workfront/brand-your-workfront-instance.md)
    ...
    * Plantillas de diseño {#layout-templates}
      ...
      * [Personalizar menú principal](administration-and-setup/customize-workfront/use-layout-templates/customize-main-menu.md)
      ...
      * [Personalizar panel izquierdo](administration-and-setup/customize-workfront/use-layout-templates/customize-left-panel.md)
      ...
      * [Personalizar la vista de detalles](administration-and-setup/customize-workfront/use-layout-templates/customize-details-view-layout-template.md)
      ...
      * [Personalizar la nueva página de inicio](administration-and-setup/customize-workfront/use-layout-templates/customize-new-home-layout-template.md)
      * [Personalizar las páginas ancladas](administration-and-setup/customize-workfront/use-layout-templates/customize-pinned-pages.md)
      ...
      * [Personalizar la terminología de la interfaz de usuario](administration-and-setup/customize-workfront/use-layout-templates/customize-terminology.md)
      ...
      * [Personalizar Workfront](administration-and-setup/customize-workfront/use-layout-templates/brand-wf-using-a-layout-template.md)
      ...
      * [Acceso administrativo para las plantillas de diseño](administration-and-setup/customize-workfront/use-layout-templates/grant-admin-access-layout-template.md)
    ...
    * Formularios personalizados {#custom-forms}
      ...
      * Diseño de un formulario personalizado {#design-a-form}
        * [Diseñar un formulario: índice de artículos](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form-toc.md)
        ...
        * [Diseñar un formulario a partir de una copia](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-from-copy.md)
    ...
    * Estados y etiquetas de prioridad {#statuses-priority-labels}
      ...
      * [Enumerar todos los estados de proyectos](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/project-statuses.md)
      ...
      * [Enumerar todos los estados de las tareas](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/task-statuses.md)
      * [Estados de las tareas](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/system-task-statuses.md)
      ...
      * [Enumerar objetos pendientes mediante un estado determinado](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/list-objects-pending-approval-certain-status.md)
      ...
      * [Crear y personalizar la gravedad de los problemas](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/create-customize-issue-severities.md)
    * Procesos de aprobación y páginas de hitos {#approvals-milestones}
      ...
      * [La forma en que afectan los cambios a los procesos de aprobación asignados](administration-and-setup/customize-workfront/configure-approval-milestone-processes/how-changes-affect-group-approvals.md)
    ...
    * Crear y administrar condiciones personalizadas {#custom-conditions}
      ...
      * [Crear o editar una condición](administration-and-setup/customize-workfront/create-manage-custom-conditions/create-edit-custom-conditions.md)
  ...
  * Administrar Adobe Workfront {#manage-wf}
    ...
    * Configurar la funcionalidad de revisión {#configure-proofing}
      ...
      * [Acceso a la revisión](administration-and-setup/manage-workfront/configure-proofing/access-to-proofing-functionality.md)
      * [Visor de revisión de escritorio](administration-and-setup/manage-workfront/configure-proofing/install-desktop-proofing-viewer-org.md)
      * [Funciones de revisión](administration-and-setup/manage-workfront/configure-proofing/configure-default-proofing-roles.md)
      ...
      * [Uso compartido de revisión](administration-and-setup/manage-workfront/configure-proofing/configure-sharing-settings-users.md)
    ...
    * Correos electrónicos {#emails}
      ...
      * [Configurar notificaciones de eventos](administration-and-setup/manage-workfront/emails/configure-event-notifications-for-everyone-in-the-system.md)
      ...
      * [Modificar la configuración de notificaciones por correo electrónico de los usuarios](administration-and-setup/manage-workfront/emails/modify-email-notification-settings-user-profiles.md)
      ...
      * [Invitaciones por correo electrónico a los nuevos usuarios](administration-and-setup/manage-workfront/emails/manage-email-invitations.md)
    * Seguridad {#security}
      ...
      * [Eliminación de opciones de inicio de sesión único](administration-and-setup/manage-workfront/security/removal-various-sso-options.md)
      ...
      * [Evitar usuarios duplicados](administration-and-setup/manage-workfront/security/prevent-duplicate-users.md)
      ...
      * {hide-from-toc}[Resumen de autenticación mejorada](administration-and-setup/manage-workfront/security/get-started-enhanced-authentication.md)
      * {hide-from-toc}[Actualizar metadatos de SAML 2.0 en el IDP al usar autenticación mejorada](administration-and-setup/add-users/single-sign-on/update-saml-2-metadata-ip-eauth.md)
    ...
    * Diagnósticos {#diagnostics}
      ...
      * [Utilice diagnósticos para activar automatizaciones](administration-and-setup/manage-workfront/run-diagnostics/use-diagnostics-to-trigger-automated-processes.md)
    * Kick-Starts {#kick-starts}
      * [Kick-Starts](administration-and-setup/manage-workfront/using-kick-starts/kick-starts.md)
      * [Exportar datos de Workfront mediante Kick-Start](administration-and-setup/manage-workfront/using-kick-starts/export-data-from-wf-via-kick-starts.md)
      * [Importar datos mediante una plantilla de Kick-Start](administration-and-setup/manage-workfront/using-kick-starts/import-data-via-kickstarts.md)
      ...
      * [Escenario de Kick-Start: compañía y grupo](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-company-group-role-user-prep.md)
      * [Escenario de Kick-Start: importar campos personalizados de varias opciones a Workfront](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-multiple-option-custom-field-import.md)
      * [Escenario de Kick-Start: importación de objetos](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-simple-project-task-import-prep.md)
  ...
  * Administrar grupos {#manage-groups}
    ...
    * Crear y administrar grupos {#create-manage-groups}
      ...
      * [Ver y administrar los detalles de grupo](administration-and-setup/manage-groups/create-and-manage-groups/view-and-manage-a-groups-details.md)
      ...
      * [Configurar preferencias de proyecto de grupo](administration-and-setup/manage-groups/create-and-manage-groups/configure-project-preferences-group.md)
      * [Configurar preferencias de tareas y problemas de grupo](administration-and-setup/manage-groups/create-and-manage-groups/configure-task-issue-preferences-group.md)
      * [Desbloquear configuración de las preferencias del subgrupo](administration-and-setup/manage-groups/create-and-manage-groups/lock-or-unlock-a-group-preference.md)
      ...
      * [Configurar preferencias de horas y plantilla de horas](administration-and-setup/manage-groups/create-and-manage-groups/lock-or-unlock-a-group-timesheet-hour-preference.md)
    ...
    * Crear y administrar subgrupos {#create-manage-subgroups}
      ...
      * [Ver y administrar los integrantes de subgrupos](administration-and-setup/manage-groups/create-and-manage-subgroups/view-and-manage-subgroup-members.md)
    * Funciones de un grupo {#group-roles}
      * [Funciones de un grupo](administration-and-setup/manage-groups/group-roles/group-roles.md)
      * [Administradores de grupos](administration-and-setup/manage-groups/group-roles/group-administrators.md)
      * [Asignar un administrador de grupos](administration-and-setup/manage-groups/group-roles/assign-user-as-group-administrator.md)
      * [Funcionalidades del administrador de grupos](administration-and-setup/manage-groups/group-roles/group-actions-allowed-different-types-admins.md)
    ...
    * Administrar estados de grupo {#group-statuses}
      ...
      * [Desbloquear la configuración de un grupo de estados](administration-and-setup/manage-groups/manage-group-statuses/lock-or-unlock-a-custom-group-status.md)
    ...
    * Trabajar con objetos de un grupo {#group-objects}
      ...
      * [Administrar compañías de grupo](administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-companies.md)
      ...
      * [Administrar horarios de grupo](administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-schedules.md)
      * [Administrar perfiles de plantillas de horas de grupo](administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-timesheet-profiles.md)
  ...
  * Administrar operaciones empresariales {#manage-enterprise-operations}
  ...
  * Configurar integraciones {#configure-integrations}
    ...
    * [Configurar el conector heredado de Workfront con Adobe Experience Manager](administration-and-setup/configure-integrations/configure-workfront-aem.md)
    ...
    * [Habilitar Adobe Workfront en Outlook](administration-and-setup/configure-integrations/enable-workfront-for-outlook.md)
    ...
    * [Configurar integración de SharePoint](administration-and-setup/configure-integrations/configure-sharepoint-integration.md)
  ...
  * Administración en Adobe Admin Console {#admin-in-admin-console}
    ...
    * [Prepararse para Adobe Admin Console](administration-and-setup/adobe-admin-console/prep-for-admin-console.md)
  ...
  * Sugerencias, trucos y solución de problemas para la administración y la configuración {#admin-setup-tips}
    ...
    * [Error de autenticación SAML 2.0](administration-and-setup/tips-tricks-and-troubleshooting/error-message-saml-2-auth-failed-userid-not-found.md)
    * [SAML 2.0: StatusCode principal](administration-and-setup/tips-tricks-and-troubleshooting/error-message-saml-2-error-primary-statuscode.md)
    * [SAML 2.0: No se encontró el identificador de usuario](administration-and-setup/tips-tricks-and-troubleshooting/error-message-saml-2-error-user-identifier-not-found.md)
    * [Este campo se utiliza en una configuración de varios formularios](administration-and-setup/tips-tricks-and-troubleshooting/error-message-field-used-in-multi-form-config.md)
    ...
    * [Falta la licencia externa en los niveles de acceso](administration-and-setup/tips-tricks-and-troubleshooting/external-user-license-type-missing-from-access-levels.md)
    ...
    * [Evitar la suplantación de identidad y añadir registros SPF](administration-and-setup/tips-tricks-and-troubleshooting/prevent-spoofing-add-wf-spf-records.md)
    ...
    * [No se ha aceptado el correo electrónico no autenticado](administration-and-setup/tips-tricks-and-troubleshooting/unauthenticated-email-not-accepted-domains-dmarc-policy.md)
    ...
    * {hide-from-toc}[Actualizar opciones de actualización automática en los niveles de acceso](administration-and-setup/tips-tricks-and-troubleshooting/update-auto-upgrade-in-access-levels.md)
* Conceptos básicos de Adobe Workfront {#basics}
  ...
  * Navegar por Adobe Workfront {#navigate}
    ...
    * [Adobe Unified Experience en Workfront](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/adobe-unified-experience.md)
    ...
    * [Añadir un panel en el panel izquierdo de un objeto o área de Workfront](workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/create-custom-tabs.md)
  ...
  * Prioridades {#priorities}
    ...
    * [Personalizar las columnas de lista de trabajo](/help/quicksilver/workfront-basics/priorities/customize-worklist-columns.md)
  ...
  * Inicio {#home}
    ...
    * {hide-from-toc}[Pasar del hogar heredado al nuevo hogar](/help/quicksilver/workfront-basics/using-home/new-home/move-to-new-home.md)
    * Usar el área Inicio {#use-home-area}
      * [Usar el área Inicio: índice de artículos](workfront-basics/using-home/using-the-home-area/use-the-home-area.md)
      ...
      * [Información general de filtros de widget en Inicio](workfront-basics/using-home/using-the-home-area/widget-filter-overview-home.md)
      ...
      * [Administrar solicitudes de trabajo y equipo en el área Inicio](workfront-basics/using-home/using-the-home-area/manage-work-and-team-requests-home.md)
      ...
      * [Crear elementos de trabajo y proyectos desde el área Inicio](workfront-basics/using-home/using-the-home-area/create-work-items-in-home.md)
      * [Crear y administrar un elemento personal pendiente](workfront-basics/using-home/using-the-home-area/manage-to-do-in-home.md)
  ...
  * Usar notificaciones {#use-notifications}
    ...
    * {hide-from-toc}[Información general sobre notificaciones de Experience Cloud](/help/quicksilver/workfront-basics/using-notifications/exp-cloud-notifications-overview.md)
  ...
  * Conceder y solicitar permisos a objetos {#grant-request-object-permissions}
    * [Conceder y solicitar permisos a objetos: índice de artículos](workfront-basics/grant-and-request-access-to-objects/grant-and-request-access-to-objects.md)
  ...
  * Administrar su cuenta y perfil {#manage-account-profile}
    ...
    * Configurar su perfil de usuario {#configure-user-profile}
      * [Configurar su perfil de usuario](workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/configure-user-profile.md)
    ...
    * Administrar su cuenta de Adobe Workfront {#manage-workfront-account}
      ...
      * {hide-from-toc}[Restablecer la contraseña de un usuario con autenticación mejorada](workfront-basics/manage-your-account-and-profile/managing-your-workfront-account/reset-user-password-eauth.md)
  ...
  * Aplicaciones móviles {#mobile-apps}
    ...
    * Usar las aplicaciones móviles de Adobe Workfront {#use-workfront-mobile-app}
      * [Usar la aplicación móvil de Adobe Workfront](workfront-basics/mobile-apps/using-the-workfront-mobile-app/use-the-mobile-app.md)
      ...
      * [Sea un comprobador beta de iOS](workfront-basics/mobile-apps/using-the-workfront-mobile-app/ios-beta-tester.md)
      * [Widgets del área de inicio](workfront-basics/mobile-apps/using-the-workfront-mobile-app/home-area-widgets-mobile.md)
      * [La sección Mi trabajo en la aplicación móvil](workfront-basics/mobile-apps/using-the-workfront-mobile-app/my-work-section-mobile.md)
      ...
      * [Compartir y descargar pruebas en la aplicación móvil Adobe Workfront](workfront-basics/mobile-apps/using-the-workfront-mobile-app/share-proofs-mobile.md)
      ...
      * [Configurar Adobe Workfront para MobileIron](workfront-basics/mobile-apps/using-the-workfront-mobile-app/wf-mobileiron-configs.md)
    ...
    * Usar Adobe Workfront View {#use-workfront-view}
      * [Usar Adobe Workfront View](workfront-basics/mobile-apps/using-workfront-view/use-workfront-view.md)
      ...
      * [Filtrar listas de proyectos en Adobe Workfront View](workfront-basics/mobile-apps/using-workfront-view/filter-project-lists-in-workfront-view.md)
    ...
    * Sugerencias, trucos y solución de problemas para la aplicación móvil de Adobe Workfront {#tips-tricks-for-mobile-apps}
      * [Sugerencias, trucos y solución de problemas para la aplicación móvil de Adobe Workfront](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/tips-tricks-and-troubleshooting-mobile.md)
  ...
  * Sugerencias, trucos y solución de problemas para Adobe Workfront Basics {#tips-tricks-for-basics}
    ...
    * [Póngase en contacto con atención al cliente](workfront-basics/tips-tricks-and-troubleshooting/contact-customer-support.md)
    * [La comunidad de Adobe Workfront](workfront-basics/tips-tricks-and-troubleshooting/workfront-community.md)
    * [El sitio del estado de Adobe Workfront](workfront-basics/tips-tricks-and-troubleshooting/understand-the-status-site.md)
    ...
    * [Tener varias pestañas del explorador abiertas hace que Workfront cierre la sesión](workfront-basics/tips-tricks-and-troubleshooting/multiple-browser-tabs-cause-logout.md)
...
* Agile {#agile}
  ...
  * Introducción a los tableros en Adobe Workfront {#boards-in-workfront}
    ...
    * [Administrar la vista de administración del tablero](/help/quicksilver/agile/get-started-with-boards/manage-boards-admin-view.md)
  ...
  * Utilice las herramientas de planificación Agile en tableros {#agile-planning-boards}
    * [Información general sobre las herramientas de planificación de Agile: índice del artículo](agile/use-boards-agile-planning-tools/agile-planning-tools-overview.md)
  ...
  * Kanban en un equipo Agile {#kanban}
    ...
    * [Añadir historias y problemas desde el tablero Kanban](agile/use-kanban-in-an-agile-team/add-story-from-kanban-board.md)
  ...
  * Scrum en un equipo Agile {#scrum}
    ...
    * Tablero de Scrum {#scrum-board}
      ...
      * [Clasificar historias por color en el tablero de Scrum](agile/use-scrum-in-an-agile-team/scrum-board/categorize-stories-by-color.md)
      ...
      * [Administrar historias y problemas en el tablero de Scrum](agile/use-scrum-in-an-agile-team/scrum-board/manage-scrum-board.md)
      ...
      * [Ver y editar la información de historia en el tablero de Scrum](agile/use-scrum-in-an-agile-team/scrum-board/view-and-edit-story-info.md)
...
* Documentos {#documents}
  ...
  * Administrar documentos {#manage-documents}
    ...
    * {hide-from-toc}[Agregar generador en detalles de documento de Workfront](/help/quicksilver/documents/managing-documents/app-builder-doc-details.md)
  ...
  * Adobe Cloud Drive {#adobe-cloud-drive}
    ...
    * [Información general sobre Adobe Cloud Drive](documents/adobe-cloud-drive/adobe-cloud-drive-overview.md)
    * [Instalar Adobe Cloud Drive](documents/adobe-cloud-drive/install-adobe-cloud-drive.md)
  ...
  * Migración desde los conectores heredados o mejorados {#migrate-from-legacy-enhanced-connectors}
    ...
    * [Migración desde el conector heredado o mejorado a la integración de Workfront para Adobe Experience Manager as a Cloud Service](documents/workfront-and-experience-manager-integrations/legacy-enhanced-connector-migration/migrate-to-workfont-integration.md)
...
* Administración del trabajo {#manage-work}
  ...
  * Proyectos {#projects}
    ...
    * Planificar un proyecto {#plan-a-project}
      ...
      * [Información general sobre la fecha de inicio real del proyecto](manage-work/projects/planning-a-project/project-actual-start-date.md)
    ...
    * Crear proyectos {#create-projects}
      ...
      * [Crear y ver instantáneas de proyectos](manage-work/projects/create-projects/create-snapshots.md)
    ...
    * Administrar proyectos {#manage-projects}
      ...
      * [Recalcular cronologías del proyecto](manage-work/projects/manage-projects/recalculate-project-timeline.md)
      ...
      * [Eliminar usuarios del proyecto](manage-work/projects/manage-projects/remove-users-from-projects.md)
      ...
      * [Administración de un proyecto de Agile en la vista de tablero](manage-work/projects/manage-projects/manage-projects-in-agile-view.md)
    ...
    * Crear y administrar plantillas de proyecto {#create-and-manage-project-templates}
      ...
      * [Modificar tareas de plantilla](manage-work/projects/create-and-manage-templates/edit-template-task.md)
      * [Eliminar una tarea de plantilla](manage-work/projects/create-and-manage-templates/delete-template-tasks.md)
      * [Crear una plantilla desde el proyecto](manage-work/projects/create-and-manage-templates/create-template-from-project.md)
    ...
    * Definición de un caso empresarial {#define-business-case}
      * [Definir un caso empresarial: índice de artículos](manage-work/projects/define-a-business-case/define-business-case.md)
      * [Información general de áreas de caso empresarial](manage-work/projects/define-a-business-case/areas-of-business-case.md)
      * [Creación de un caso empresarial para un proyecto](manage-work/projects/define-a-business-case/create-business-case.md)
      * [Aprobación de un caso empresarial](manage-work/projects/define-a-business-case/approve-business-case.md)
    ...
    * Finanzas del proyecto {#project-finances}
      ...
      * [Información general sobre la anulación de tarifas de facturación y el cálculo de ingresos en un proyecto](manage-work/projects/project-finances/override-role-billing-rates-and-calculate-project-revenue.md)
    ...
    * Sugerencias, trucos y resolución de problemas para proyectos {#tips-tricks-troubleshooting-for-projects}
  ...
  * Tareas {#tasks}
    ...
    * Información sobre las tareas {#task-information}
      * [Información de tareas: índice de artículos](manage-work/tasks/task-information/task-information.md)
      ...
      * [Actualizar prioridad de la tarea](manage-work/tasks/task-information/task-priority.md)
      * [Información general sobre el porcentaje completado del proyecto](manage-work/tasks/task-information/project-percent-complete.md)
      * [Información general sobre las horas planificadas](manage-work/tasks/task-information/planned-hours.md)
      * [Información general sobre el esfuerzo laboral](manage-work/tasks/task-information/work-effort.md)
    ...
    * Duración y tipos de duración de la tarea {#task-duration-and-duration-types}
      * [Duración y tipos de duración de la tarea: índice de artículos](manage-work/tasks/taskdurtn/task-duration-duration-type.md)
      * [Información general sobre la duración y el tipo de tarea](manage-work/tasks/taskdurtn/task-duration-and-duration-type.md)
    ...
    * Usar predecesoras de tareas {#use-task-predecessors}
      * [Usar predecesoras de tareas: índice de artículos](manage-work/tasks/use-prdcssrs/use-task-predecessors.md)
  ...
  * Problemas {#issues}
    ...
    * Convertir problemas {#convert-issues}
      * [Convertir problemas: índice de artículos](manage-work/issues/convert-issues/convert-issues-overview.md)
    ...
    * Información del problema {#issue-information}
      * [Información del problema: índice del artículo](manage-work/issues/issue-information/issue-info-overview.md)
      ...
      * [Información general sobre el problema Fecha planificada de finalización](manage-work/issues/issue-information/issue-planned-completion-date.md)
    ...
    * Administración de problemas {#manage-issues}
  ...
  * El gráfico Gantt {#the-gantt-chart}
    ...
    * Información general sobre el gráfico Gantt {#gantt-chart-overview}
      ...
      * [Recursos de nivel en el gráfico Gantt](manage-work/gantt-chart/use-the-gantt-chart/level-resources-in-gantt.md)
  ...
  * Administración de portafolios {#portfolio-management}
    ...
    * Información general sobre Portafolio en Adobe Workfront {#portfolio-overview-in-adobe-workfront}
      * [Portafolios: índice de artículos](manage-work/portfolios/portfolios-overview/portfolio-overview-1.md)
      * [Navegación dentro de un portafolio](manage-work/portfolios/portfolios-overview/navigate-within-portfolio.md)
      * [Información general sobre la administración de portafolios](manage-work/portfolios/portfolios-overview/portfolio-managament-overview.md)
    ...
    * Crear y administrar programas {#create-and-manage-programs}
      * [Información general de programas](manage-work/portfolios/create-and-manage-programs/programs-overview.md)
      * [Crear y administrar programas: índice de artículos](manage-work/portfolios/create-and-manage-programs/create-and-manage-programs.md)
    ...
    * Administrar proyectos en el Optimizador de portafolios {#manage-projects-in-portfolio-optimizer}
      * [Administrar proyectos en el optimizador de portafolios: índice de artículos](manage-work/portfolios/portfolio-optimizer/manage-projects-in-portfolio-optimizer.md)
  ...
  * Solicitudes {#requests}
    ...
    * Crear solicitudes {#create-requests}
      ...
      * [Crear y enviar solicitudes](manage-work/requests/create-requests/create-submit-requests.md)
      ...
      * [Compartir un vínculo en una cola de solicitudes](manage-work/requests/create-requests/share-link-to-request-queue.md)
      * [Eliminar una solicitud enviada o un borrador de solicitud](manage-work/requests/create-requests/delete-request-draft.md)
      * [Crear y enviar solicitudes](manage-work/requests/create-requests/copy-and-submit-requests.md)
...
* Equipos y grupos {#teams-groups}
  ...
  * Crear y administrar equipos {#create-manage-teams}
    ...
    * [Desactivación o eliminación de un equipo](people-teams-and-groups/create-and-manage-teams/deactivate-a-team.md)
  ...
  * Trabajar con grupos y equipos {#work-with-groups-teams}
    ...
    * [Grupos y equipos en Workfront](people-teams-and-groups/work-with-groups-and-teams/understanding-differences-and-similarities-between-groups-and-teams.md)
  * Trabajo con solicitudes de equipo {#work-with-team-requests}
    * [Trabajo con solicitudes de equipo](people-teams-and-groups/work-with-team-requests/work-with-team-requests.md)
  ...
  * Sugerencias, trucos y solución de problemas para equipos y grupos {#tips-tricks-people-teams-groups}
    ...
    * [Este nombre de usuario ya se está utilizando](people-teams-and-groups/tips-tricks-and-troubleshooting/username-already-in-use.md)
* Creación de informes {#reporting}
  ...
  * Paneles de lienzo {#canvas-dashboards}
    * {hide-from-toc}[Información general sobre paneles de lienzo](reports-and-dashboards/canvas-dashboards/canvas-dashboards-overview.md)
    ...
    * Añadir informes {#add-reports}
      * [Añadir informes: índice de artículos](/help/quicksilver/reports-and-dashboards/canvas-dashboards/add-reports/add-reports-toc.md)
    ...
    * Administrar paneles de lienzo {#manage-canvas-dashboards}
      * [Administrar paneles de lienzo: índice de artículos](reports-and-dashboards/canvas-dashboards/manage-canvas-dashboards/manage-canvas-dashboards.md)
  ...
  * Informes {#reports}
    ...
    * Conceptos básicos sobre la creación de informes {#report-basics}
      * [Conceptos básicos sobre la creación de informes: índice de artículos](reports-and-dashboards/reports/reporting/reporting-basics.md)
    ...
    * Elementos de creación de informes {#report-elements}
      * [Información general sobre los elementos de creación de informes](reports-and-dashboards/reports/reporting-elements/reporting-elements-overview.md)
    ...
    * Uso de informes integrados {#built-in-reports}
      ...
      * [Información general del informe de Utilización de recursos](reports-and-dashboards/reports/using-built-in-reports/resource-utilization-report.md)
    ...
    * Datos personalizados calculados en informes {#calculated-custom-data}
      ...
      * [Información general de expresiones de datos calculados](reports-and-dashboards/reports/calc-cstm-data-reports/calculated-data-expressions.md)
    ...
    * Ejemplos de vistas, filtros y agrupaciones personalizados {#custom-view-samples}
      ...
      * [Agrupación: agrupación de tareas de cuatro niveles para el propietario de portafolio, de programa y de proyecto, y el estado del proyecto.](reports-and-dashboards/reports/custom-view-filter-grouping-samples/grouping-4-level-task-grouping.md)
      ...
      * [Vista: horas reales sobre horas planificadas en la misma columna de la tarea Vista.](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-actual-hours-planned-hours-task-view.md)
      ...
      * [Vista y agrupación: mostrar la duración real del proyecto añadida por el promedio en una agrupación](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-column-project-average-actual-duration-aggregated-grouping.md)
      ...
      * [Vista: mostrar la información original del problema en las listas de tareas y proyectos.](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md)
  ...
  * Paneles {#dashboards}
    ...
    * Crear y administrar paneles de control {#create-dashboards}
      ...
      * [Copiar un panel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/copy-dashboard.md)
      * [Eliminación de un panel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/delete-dashboard.md)
      * [Editar un panel de control](reports-and-dashboards/dashboards/creating-and-managing-dashboards/edit-dashboard.md)
      ...
      * [Exportar un panel de control](reports-and-dashboards/dashboards/creating-and-managing-dashboards/export-dashboard.md)
      ...
      * {hide-from-toc}[Información general sobre paneles de lienzo](reports-and-dashboards/dashboards/creating-and-managing-dashboards/canvas-dashboards-overview.md)
  * Workfront Data Connect {#data-lake}
    * [Información general de Workfront Data Connect](reports-and-dashboards/data-lake/data-lake-overview.md)
    ...
    * Consejos, trucos y solución de problemas para Data Connect{#troubleshooting-data-connect}
      * [Consejos, trucos y solución de problemas para Data Connect](/help/quicksilver/reports-and-dashboards/data-lake/tips-tricks-troubleshooting/tips-tricks-troubleshooting-data-connect.md)
...
* Administrar recursos {#manage-resources}
  ...
  * Planificación de recursos en Adobe Workfront {#resource-planning-in-adobe-workfront}
    ...
    * [Se necesita acceso para presupuestar recursos en Workfront](resource-mgmt/resource-planning/access-needed-to-budget-resources.md)
  ...
  * Utilización de recursos {#resource-utilization}
    * [Utilización de recursos: índice de artículos](resource-mgmt/resource-utilization/resource-utilization.md)
    * [Ver información sobre la utilización de recursos](resource-mgmt/resource-utilization/view-utilization-information.md)
  * Equilibrador de carga {#the-workload-balancer}
    * [Equilibrador de carga: índice de artículos](resource-mgmt/workload-balancer/workload-balancer.md)
    * [Información general sobre el equilibrador de carga](resource-mgmt/workload-balancer/overview-workload-balancer.md)
    * [Acceso necesario para administrar los recursos en el equilibrador de carga](resource-mgmt/workload-balancer/access-needed-manage-resources-balancer.md)
    * [Buscar el equilibrador de carga](resource-mgmt/workload-balancer/locate-workload-balancer.md)
    * [Información general sobre la asignación de trabajo en el equilibrador de carga](resource-mgmt/workload-balancer/assign-work-in-workload-balancer.md)
    * [Desasignar trabajo en el equilibrador de carga](resource-mgmt/workload-balancer/unassign-work-in-workload-balancer.md)
    * [Filtrar información en el equilibrador de carga](resource-mgmt/workload-balancer/filter-information-workload-balancer.md)
    * [Asignar trabajo de forma masiva mediante el equilibrador de carga](resource-mgmt/workload-balancer/assign-work-in-workload-balancer-in-bulk.md)
    * [Asignar trabajo en el equilibrador de carga arrastrándolo y soltándolo](resource-mgmt/workload-balancer/assign-work-in-workload-balancer-by-drag-and-drop.md)
    * [Asignar trabajo manualmente mediante el equilibrador de carga](resource-mgmt/workload-balancer/assign-work-in-workload-balancer-manually.md)
    * [Administrar asignaciones de usuario en el equilibrador de carga](resource-mgmt/workload-balancer/manage-user-allocations-workload-balancer.md)
    * [Navegar por el equilibrador de carga](resource-mgmt/workload-balancer/navigate-the-workload-balancer.md)
...
* Revisar y aprobar el trabajo {#review-and-approve-work}
  ...
  * Aprobaciones unificadas {#document-reviews-and-approvals}
    ...
    * Revisión y aprobación de recursos y documentos {#review-and-approve-documents}
      ...
      * [Ver puntuación y comentarios del revisor de contenido](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/view-ai-reviewer-feedback.md)
  ...
  * Revisión {#proofing}
    ...
    * Información general de revisión {#proofing-overview}
    ...
    * Crear pruebas {#create-proofs}
      ...
      * [Crear una revisión de un contenido interactivo en un archivo ZIP](review-and-approve-work/proofing/creating-proofs-within-workfront/generate-proof-interactive-content.md)
      * [Crear pruebas estáticas para un sitio web u otro contenido web](review-and-approve-work/proofing/creating-proofs-within-workfront/generate-static-proof-website-other-web-content.md)
    ...
    * Administrar pruebas en Adobe Workfront {#manage-proofs-in-workfront}
      ...
      * Administrar pruebas {#manage-proofs}
      ...
      * Administrar notificaciones de la prueba {#manage-proof-notifications}
        * [Administrar notificaciones de la prueba: índice de artículos](review-and-approve-work/proofing/managing-proofs-within-workfront/manage-proof-notifications/manage-proof-notifications.md)
      ...
      * Administrar fechas límite de la prueba {#manage-proof-deadlines}
      ...
      * Administrar pruebas automatizadas {#manage-automated-proofs}
        ...
        * [Ver etapas activas en una prueba](review-and-approve-work/proofing/managing-proofs-within-workfront/view-active-stages-proof.md)
    ...
    * Uso del visor de revisión de escritorio {#use-the-desktop-proofing-viewer}
      ...
      * [Actualizar el visor de revisión de escritorio](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/update-the-desktop-proofing-viewer.md)
      ...
      * [Preguntas frecuentes: visor de revisión de escritorio](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/faq-desktop-proofing-viewer.md)
    * Revisar pruebas en Adobe Workfront {#review-proofs-in-workfront}
      ...
      * Revisión de una prueba {#review-a-proof}
        ...
        * [Descarga de una prueba en el visor de revisión](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/download-a-proof-in-viewer.md)
        ...
        * [Compartir una revisión desde el visor de revisión](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md)
        ...
        * [Cambiar la resolución de revisión interactiva en el visor de revisión](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/view-interactive-content-as-it-appears-in-device.md)
        ...
        * [Revisar el contenido interactivo con la herramienta de revisión de Adobe Workfront](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-proof-in-web-viewer-extension.md)
      * Comentario sobre una prueba {#comment-on-a-proof}
        * [Comentario sobre pruebas: índice de artículos](review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/comment-on-proof.md)
      ...
      * Tomar una decisión sobre una prueba {#make-decision-on-proof}
        ...
        * [Tome una decisión sobre una revisión en el visor de revisión](review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decisions-on-proof.md)
    ...
    * Sugerencias, trucos y solución de problemas para la revisión en Adobe Workfront {#ttt-proofing-in-workfront}
      ...
      * [La decisión del aprobador muestra un guion en el informe de aprobación de la prueba](review-and-approve-work/proofing/tips-tricks-and-troubleshooting/approver-decision-shows-hyphen.md)
...
* Hojas de horas {#timesheets}
  ...
  * Detalles sobre la plantilla de horas {#details}
  ...
  * Crear y administrar plantillas de horas {#create-and-manage-timesheets-in-adobe-workfront}
  ...
  * Sugerencias, trucos y solución de problemas para las plantillas de horas {#tips-tricks-troubleshooting-for-timesheets}
    ...
    * [No se puede registrar el tiempo para fechas futuras](timesheets/tips-tricks-and-troubleshooting/unable-to-log-time-future-dates.md)
* Planificador de escenarios de Adobe Workfront {#scenario-planner}
  ...
  * [Solicitar permisos para un plan en el planificador de escenarios](scenario-planner/request-access-to-plan.md)
  ...
  * [Mostrar la asignación de funciones para proyectos e iniciativas en el equilibrador de carga](scenario-planner/show-role-allocation-workload-balancer.md)
* Adobe Workfront Goals {#adobe-workfront-goals}
  * [Adobe Workfront Goals: índice de artículos](workfront-goals/workfront-goals.md)
...
* Planificación de Workfront de Adobe {#adobe-workfront-planning}
  ...
  * Arquitectura de Planificación de Workfront de Adobe {#adobe-workfront-planning-architecture}
    ...
    * [Información general de jerarquía y ruta](planning/architecture/hierarchy-and-breadcrumb-overview.md)
    * [Crear jerarquías de espacio de trabajo](planning/architecture/create-workspace-hierarchies.md)
  ...
  * Campos de Planificación de Workfront de Adobe {#adobe-workfront-planning-fields}
    ...
    * [Eliminación de campos](planning/fields/delete-fields.md)
  ...
  * Acceso a Planificación de Workfront de Adobe {#adobe-workfront-planning-access}
    ...
    * [Compartir campos de Workfront Planning](planning/access/share-fields.md)
  ...
  * Registros de Planificación de Workfront de Adobe {#adobe-workfront-planning-records}
    ...
    * [Información general de registros conectados](planning/records/connected-records-overview.md)
    ...
    * [Restaurar registros eliminados](planning/records/restore-deleted-records.md)
    * [Compartir registros usando un vínculo](planning/records/share-records.md)
  ...
  * Solicitudes de Planificación de Workfront de Adobe {#adobe-workfront-planning-requests}
    ...
    * [Compartir solicitudes de Planning](planning/requests/share-requests.md)
  ...
  * Adobe Workfront Planning como producto independiente {#planning-standalone}
    ...
    * [Introducción a Adobe Workfront Planning como producto independiente](planning/planning-sta/planning-sta-overview.md)
    * [Acceso necesario para Adobe Workfront Planning como producto independiente](planning/planning-sta/access-needed-for-planning-sta.md)
...
* Integraciones de Adobe Workfront {#adobe-workfront-integrations}
  ...
  * Adobe Workfront para Creative Cloud {#workfront-for-creative-cloud}
    ...
    * Instalar el complemento de Adobe Workfront para aplicaciones de Creative Cloud {#install-wf-cc}
      * [Instalar Adobe Workfront para aplicaciones de Creative Cloud](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-install-toc.md)
    ...
    * Administrar el trabajo con el complemento de Adobe Workfront para aplicaciones de Creative Cloud {#manage-wf-cc}
      ...
      * [Administrar [!DNL Adobe Workfront] notificaciones desde Adobe Creative Cloud](/help/quicksilver/workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-notifications.md)
    * Carga de documentos y pruebas con el complemento de Adobe Workfront para aplicaciones de Creative Cloud {#upload-docs-proofs-wf-cc}
      * {hide-from-toc}[Cargar documentos y pruebas del [!DNL Adobe Workfront plugin] al [!DNL Creative Cloud]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/upload-documents-and-proofs.md)
      ...
      * [Cargar mesas de trabajo XD como documentos en Workfront](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-xd-docs.md)
    ...
    * Extensión de Workfront para Illustrator e InDesign {#workfront-for-illustrator-indesign}
  ...
  * Adobe Workfront para Jira {#workfront-for-jira}
    * [Adobe Workfront para Jira: índice de artículos](workfront-integrations-and-apps/use-workfront-with-jira/workfront-for-jira.md)
    ...
    * [Ver el registro de actividad de Jira](workfront-integrations-and-apps/use-workfront-with-jira/view-the-jira-activity-log.md)
  * Adobe Workfront para Google Workspace {#workfront-for-g-suite}
    ...
    * [Acceso al contenido de inicio de Adobe Workfront desde Google Workspace](workfront-integrations-and-apps/workfront-for-g-suite/access-wf-home-content-from-g-suite.md)
    * [Actualizar un objeto de Adobe Workfront desde Google Workspace](workfront-integrations-and-apps/workfront-for-g-suite/update-a-workfront-object-in-gsuite.md)
    ...
    * [Ver y administrar detalles del objeto de Adobe Workfront desde Google Workspace](workfront-integrations-and-apps/workfront-for-g-suite/view-manage-work-item-details-in-gsuite.md)
    ...
    * [Administración de detalles de notificación de Adobe Workfront de Google Workspace](workfront-integrations-and-apps/workfront-for-g-suite/manage-wf-email-notification-details-in-gsuite.md)
    * [Respuesta a una notificación de actualización de Adobe Workfront de Google Workspace](workfront-integrations-and-apps/workfront-for-g-suite/reply-to-wf-update-notification-from-gsuite.md)
    * [Convertir correos electrónicos de Google Workspace en objetos y actualizaciones de Adobe Workfront](workfront-integrations-and-apps/workfront-for-g-suite/turn-gsuite-emails-into-wf-objects-and-updates.md)
    * [Crear una tarea de Adobe Workfront en Google Workspace mediante contenido de correo electrónico](workfront-integrations-and-apps/workfront-for-g-suite/create-wf-task-in-gsuite-using-email-content.md)
  ...
  * Adobe Workfront para Outlook {#workfront-for-outlook}
    * [Adobe Workfront para Outlook: índice de artículos](workfront-integrations-and-apps/using-workfront-with-outlook/workfront-for-outlook.md)
  * Adobe Workfront para Microsoft Teams {#workfront-for-microsoft-teams}
    * [[!DNL Adobe Workfront for Microsoft Teams]: índice de artículos](workfront-integrations-and-apps/using-workfront-with-microsoft-teams/use-workfront-with-ms-teams.md)
    ...
    * [Buscar y compartir elementos de Adobe Workfront en Microsoft Teams](workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md)
    * [Crear tareas de Adobe Workfront a partir de Microsoft Teams](workfront-integrations-and-apps/using-workfront-with-microsoft-teams/create-workfront-tasks-from-ms-teams.md)
  ...
  * Adobe Workfront para Scalesforce {#workfront-for-salesforce}
    * [Adobe Workfront para Scalesforce](workfront-integrations-and-apps/using-workfront-with-salesforce/workfront-for-salesforce.md)
    ...
    * [Envío de solicitudes de Adobe Workfront a partir de objetos de Salesforce](workfront-integrations-and-apps/using-workfront-with-salesforce/submit-workfront-requests-from-salesforce-objects.md)
  ...
  * Adobe Workfront para Slack {#workfront-for-slack}
    ...
    * [Acceda a sus elementos favoritos y más recientes desde Slack](workfront-integrations-and-apps/using-workfront-with-slack/access-favorites-and-recent-items-from-slack.md)
    ...
    * [Buscar elementos de Adobe Workfront desde Slack](workfront-integrations-and-apps/using-workfront-with-slack/search-for-wf-items-from-slack.md)
    * [Acceder a objetos de Adobe Workfront desde un vínculo compartido en Slack](workfront-integrations-and-apps/using-workfront-with-slack/access-wf-objects-from-shared-linked-in-slack.md)
  ...
  * Adobe Workfront con Anaplan {#workfront-with-anaplan}
    ...
    * [Enviar actualizaciones de proyecto de Adobe Workfront a un elemento de lista de Anaplan](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-updates-to-anaplan-list-item.md)
    ...
    * [Aplicar una asignación de presupuesto de Anaplan a una solicitud de campaña o a un proyecto de campaña de Adobe Workfront](workfront-integrations-and-apps/adobe-workfront-with-anaplan/apply-anaplan-budget-allocation-to-workfront-campaign-requests-and-projects.md)
* Workfront Proof {#workfront-proof}
  ...
  * Introducción a Workfront Proof {#get-started-wf-proof}
    ...
    * Ejemplos de flujo de trabajo {#workflow-examples}
      ...
      * [Revisión interna y luego externa en Workfront Proof](workfront-proof/wp-getstarted/workflow-examples/internal-external-review.md)
      * [Trabajar con diseñadores y gerentes de proyectos en Workfront Proof](workfront-proof/wp-getstarted/workflow-examples/work-designers-project-managers.md)
      * [Trabajar con autónomos en Workfront Proof](workfront-proof/wp-getstarted/workflow-examples/work-freelancers.md)
    * Configuración personal en Workfront Proof {#personal-settings-in-wf-proof}
      ...
      * [Designación de propietarios de revisión temporales en Workfront Proof](workfront-proof/wp-getstarted/personal-settings/designate-temp-proof-owners.md)
    ...
    * Preguntas frecuentes de Workfront Proof {#wf-proof-faq}
  ...
  * Trabajar con pruebas y archivos en Workfront Proof {#work-with-proofs-in-wf-proof}
    * [Trabajar con pruebas y archivos en Workfront Proof](workfront-proof/wp-work-proofsfiles/wp-work-proofs-files.md)
    * Flujo de trabajo automatizado en Workfront Proof {#automated-workflow-in-wf-proof}
      ...
      * [Configurar una prueba con un flujo de trabajo automatizado en Workfront Proof](workfront-proof/wp-work-proofsfiles/automated-workflow/set-up-proof-auto-workflow.md)
      * [Administrar una prueba configurada con un flujo de trabajo automatizado en Workfront Proof](workfront-proof/wp-work-proofsfiles/automated-workflow/manage-proof-configured-auto-workflow.md)
    * Funciones básicas de Workfront Proof {#basic-features-in-wf-proof}
      ...
      * [Búsqueda en Workfront Proof](workfront-proof/wp-work-proofsfiles/basic-features/search.md)
      * [Comprensión de la pista de auditoría de actividad de Workfront Proof](workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md)
    * Creación de pruebas y archivos {#create-proofs-and-files}
      ...
      * [Copiar pruebas en Workfront Proof](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/copy-proofs.md)
    ...
    * Administrar su trabajo {#manage-your-work}
      ...
      * [Administrar detalles de prueba en Workfront Proof](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-details.md)
    ...
    * Organizar su trabajo {#organize-your-work}
      ...
      * [Comprender permisos de carpeta en Workfront Proof](workfront-proof/wp-work-proofsfiles/organize-your-work/folder-permissions.md)
      * [Crear y administrar etiquetas en Workfront Proof](workfront-proof/wp-work-proofsfiles/organize-your-work/create-and-manage-tags.md)
      * [Archivar en Workfront Proof](workfront-proof/wp-work-proofsfiles/organize-your-work/archive.md)
      * [Hacer una copia de seguridad de sus datos en Workfront Proof](workfront-proof/wp-work-proofsfiles/organize-your-work/back-up-data.md)
    ...
    * Revisar pruebas en el visor de revisión de escritorio {#review-proofs-in-viewer}
      * [Revisar pruebas en el visor de revisión de escritorio](workfront-proof/wp-work-proofsfiles/review-proofs-dpv/review-proofs-in-desktop-proofing-viewer.md)
    ...
    * Revisión de pruebas en el Visor de corrección web {#review-proofs-web-proofing-viewer}
      ...
      * [Abrir una prueba en Workfront Proof](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/open-proof.md)
      ...
      * [Descarga de una prueba en el visor de revisión](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/download-proof.md)
      * [Atajos de teclado en el visor de revisión de Workfront Proof](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/keyboard-shortcuts.md)
    ...
    * Compartir pruebas y archivos {#share-proofs-and-files}
      ...
      * [Compartir una prueba en Workfront Proof](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof.md)
      ...
      * [Compartir la dirección URL pública en Workfront Proof](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-public-url.md)
      ...
      * [Suscribirse a una prueba en Workfront Proof](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/subscribe-to-proof.md)
      * [Crear una miniprueba en Workfront Proof](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/create-mini-proof.md)
  ...
  * Administración de cuentas de Workfront Proof {#wf-proof-account-admin}
    ...
    * Configuración de cuenta en Workfront Proof {#account-settings-in-wf-proof}
      ...
      * [Configurar el perfil de permiso de prueba de un usuario en Workfront Proof](workfront-proof/wp-acct-admin/account-settings/config-user-pref-in-wp.md)
      * [Configurar perfiles personalizados en Workfront Proof](workfront-proof/wp-acct-admin/account-settings/configure-custom-profiles.md)
      ...
      * [Configurar opciones de decisión de aprobación en Workfront Proof](workfront-proof/wp-acct-admin/account-settings/configure-approval-decision-in-wp.md)
      ...
      * [Comprobar su almacenamiento de Workfront Proof](workfront-proof/wp-acct-admin/account-settings/check-workfront-proof-storage.md)
    ...
    * Promoción de la marca en Workfront Proof {#branding-wf-proof}
      * [Promoción de la marca en Workfront Proof](workfront-proof/wp-acct-admin/branding/branding.md)
      * [Personalización de la marca en el sitio de Workfront Proof](workfront-proof/wp-acct-admin/branding/brand-wp-site.md)
      * [Personalización de la marca en el sitio de Workfront Proof: avanzado](workfront-proof/wp-acct-admin/branding/brand-wp-site-advanced.md)
    * Administración de la seguridad {#manage-security}
      ...
      * [Comprensión de las firmas electrónicas en Workfront Proof](workfront-proof/wp-acct-admin/managing-security/electronic-sigs-in-wp.md)
    ...
    * Cuentas satélite en Workfront Proof {#satellite-accounts-in-wf-proof}
      ...
      * [Configurar una cuenta satélite en Workfront Proof](workfront-proof/wp-acct-admin/satellite-accounts/configure-sat-acct-in-wp.md)
    ...
    * Sugerencias, trucos y solución de problemas para la administración de la cuenta de Workfront Proof {#ttt-wf-proof-account-admin}
      * [Sugerencias, trucos y solución de problemas para la administración de la cuenta de Workfront Proof](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/tips-tricks-and-troubleshooting.md)
      * [Preguntas frecuentes: migración de Workfront Proof de EE. UU. a EMEA](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/faq-wp-us-to-emea-mig.md)
  * Configuración de facturación de Workfront Proof {#wf-proof-billing-settings}
    ...
    * Administración de su facturación {#manage-billing}
      * [Administración de su facturación](workfront-proof/wp-billingsettings/manage-your-billing/manage-your-billing.md)
      * [La página de facturación de Workfront Proof](workfront-proof/wp-billingsettings/manage-your-billing/wp-billing-page.md)
      * [Elección del método de pago en Workfront Proof](workfront-proof/wp-billingsettings/manage-your-billing/choose-payment-method-in-wp.md)
      * [Descarga de la factura de Workfront Proof](workfront-proof/wp-billingsettings/manage-your-billing/download-wp-invoice.md)
      * [Cerrar su cuenta de Workfront Proof](workfront-proof/wp-billingsettings/manage-your-billing/close-wp-acct.md)
  * Notificaciones y recordatorios de prueba {#proof-notifications-and-reminders}
    ...
    * Envío de mensajes a los revisores {#send-messages-to-reviewers}
      ...
      * [Recordar a un revisor las asignaciones de Workfront Proof](workfront-proof/wp-emailsntfctns/messaging-reviewers/remind-reviewer-assignments-wp.md)
  ...
  * Alertas de correo electrónico {#email-alerts}
    ...
    * [Cambiar la configuración de alertas por correo electrónico para una prueba en Workfront Proof](workfront-proof/wp-emailsntfctns/email-alerts/change-email-alert-settings-wp.md)
  * Administrar usuarios y contactos en Workfront Proof {#managing-users-in-wf-proof}
    * [Administrar usuarios y contactos en Workfront Proof](workfront-proof/wp-mnguserscontacts/manage-user-contacts.md)
    * Usuarios {#users}
      ...
      * [Crear y administrar perfiles personalizados mediante Workfront Proof](workfront-proof/wp-mnguserscontacts/users/create-and-manage-custom-profiles.md)
    ...
    * Grupos {#groups}
      ...
      * [Crear grupos de revisión mediante Workfront Proof](workfront-proof/wp-mnguserscontacts/groups/create-proofing-groups.md)
    ...
    * Contactos {#contacts}
      ...
      * [Comprensión de usuarios, miembros e invitados en Workfront Proof](workfront-proof/wp-mnguserscontacts/contacts/use-members-guests.md)
  ...
  * Workfront Proof para móvil {#wf-proof-mobile}
    ...
    * Aplicaciones móviles de Workfront Proof {#wf-proof-mobile-apps}
      * {hide-from-toc}[Aplicaciones móviles de Workfront Proof](workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-apps.md)
      * {hide-from-toc}[aplicación móvil de Workfront Proof](workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-app-phones.md)
      * {hide-from-toc}[Aplicación móvil de Workfront Proof para tabletas](workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-app-tablet.md)
    * Sugerencias, trucos y solución de problemas para las aplicaciones móviles de Workfront Proof {#ttt-wf-proof-mobile-apps}
      * {hide-from-toc}[Sugerencias, trucos y solución de problemas para la aplicación móvil de Workfront Proof](workfront-proof/wp-mobile/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-wp-mobile.md)
      * {hide-from-toc}[No se puede iniciar sesión en la aplicación móvil de Workfront Proof](workfront-proof/wp-mobile/tips-tricks-and-troubleshooting/unable-to-log-in.md)
  * Rincón técnico de Workfront Proof {#wf-proof-tech-corner}
    ...
    * Tipos de prueba {#proof-types}
      ...
      * [Crear una prueba de sitios web estática usando Workfront Proof](workfront-proof/wp-tech-corner/proof-types/create-status-web-proof.md)
    * Solución de problemas en Workfront Proof {#troubleshooting-wf-proof}
      ...
      * [Comprender cómo la caché y las cookies afectan a Workfront Proof](workfront-proof/wp-tech-corner/troubleshooting/how-cache-cookies-affect-pv.md)
      * [Problemas de velocidad en Workfront Proof](workfront-proof/wp-tech-corner/troubleshooting/speed-issue.md)
      * [Solución de problemas: visor de revisión de Workfront Proof](workfront-proof/wp-tech-corner/troubleshooting/proofing-viewer.md)
  * Integraciones de Workfront Proof {#wf-proof-integrations}
    ...
    * Box {#box}
      ...
      * [Carpetas de Box de sincronización con Workfront Proof](workfront-proof/wp-integrations/box/sycn-box-folder.md)
    ...
    * Basecamp {#basecamp}
      ...
      * [Añadir una prueba a un proyecto de Basecamp Classic](workfront-proof/wp-integrations/basecamp/add-proof-to-basecamp-project.md)
      ...
      * [Revisión de una prueba en Basecamp](workfront-proof/wp-integrations/basecamp/review-proof-basecamp.md)
      * [Comprender la integración de Basecamp con Workfront Proof](workfront-proof/wp-integrations/basecamp/basecamp-integration-overview.md)
...
* API de Adobe Workfront {#adobe-workfront-api}
  ...
  * Suscripciones a eventos {#event-subscriptions}
    * [Suscripciones a eventos](wf-api/api/event-subscriptions.md)
  ...
  * API de webhooks de documentos {#document-webhooks-api}
    * [API de webhooks de documentos: índice de artículos](wf-api/doc-wbhks-api/document-webhooks-api.md)
  ...
  * Descripciones de objeto de Workfront {#workfrtont-object-descriptions}
    * [Descripciones de objeto de Workfront](wf-api/wf-objects/workfront-objects.md)
  ...
  * Sugerencias, trucos y solución de problemas para la API de Adobe Workfront {#tips-troubleshooting-apis}
    ...
    * [Al actualizarse emailAddr no se actualiza username](wf-api/tips-tricks-and-troubleshooting/update-email-addr-and-username.md)
...
* API de ProofHQ {#proofhqpapi}
  ...
  * General {#general}
    ...
    * {hide-from-toc}[Muestras de código](proofhq-api/general/code-samples.md)

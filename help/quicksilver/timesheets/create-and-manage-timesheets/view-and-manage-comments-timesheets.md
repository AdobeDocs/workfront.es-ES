...
title: Ver y administrar comentarios en una hoja de horas
description: Puede realizar comentarios en las plantillas de horas, los elementos de trabajo incluidos en las mismas y en todas las entradas de horas que registre.
author: Alina
feature: Timesheets
...
Puede realizar comentarios en los siguientes elementos de una plantilla de horas:

* En la hoja de horas
* En las entradas de horas
* En un elemento individual, como una tarea o un problema

Puede mostrar las actualizaciones desde una plantilla de horas o desde entradas de horas individuales en un informe de notas. Para obtener más información, vea [Ver todas las actualizaciones en un informe de notas](/help/quicksilver/workfront-basics/updating-work-items-and-viewing-updates/view-all-updates-in-a-report.md).
...
Los comentarios se muestran debajo del elemento en el que se registraron la entrada de hora y el comentario.
   ...
   ![Comentarios expandidos bajo tareas hoja de horas rediseñada](assets/comments-expanded-under-tasks-redesigned-timesheet.png)
...
1. Haga clic en el campo de entrada de hora donde desee hacer un comentario y haga clic en **Comentario** para agregar un comentario para la entrada de hora.
   ...
   * Haga clic en el icono **Eliminar** ![Eliminar icono](assets/delete.png) para eliminar un comentario guardado.
...
>[!TIP]
>
>Puede realizar comentarios en elementos individuales de la plantilla de horas y actualizar la fecha o condición de inicio real. La actualización se muestra en el área Actualizaciones del objeto asociado con el tiempo registrado.

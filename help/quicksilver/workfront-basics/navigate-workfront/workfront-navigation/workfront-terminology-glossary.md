...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <p>Para un proyecto, [!DNL Workfront] utiliza la fórmula siguiente para calcular [!UICONTROL Costo real de gastos]:</p> <p><code>Project Actual Expense Cost = SUM (All Project Actual Expense Costs) + SUM (All Tasks Actual Expense Costs)</code> <br> </p> 
   <!--
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Las carpetas se utilizan para organizar documentos o informes asociados a un objeto.</td> 
  </tr> <!--
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Los datos que componen las programaciones.</td> 
  </tr> 
  <tr> 

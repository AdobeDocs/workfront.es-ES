...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Nombre de objeto<br>Nombre de objeto principal<br>Número de referencia de objeto<br>Nombre del usuario que realizó la actualización dirigida<br>Nombre de todos los equipos y usuarios incluidos en la actualización dirigida<br>Fecha y hora en que se realizó la actualización dirigida<br>Texto de la actualización dirigida<br><strong>[!Comentario de UICONTROL]</strong> button<br>*Número total de comentarios recibidos<br>*Número de comentarios recibidos para cada objeto<br>*Nombre de proyecto<br>*<strong>[!UICONTROL Ver todas las notificaciones]</strong> button<br>*Fecha de diariamente est </p> </td> 
   <td><strong>Diariamente</strong> </td> 
  </tr> 
  <tr> 

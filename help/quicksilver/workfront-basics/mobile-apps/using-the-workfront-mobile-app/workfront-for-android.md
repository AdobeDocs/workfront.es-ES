...
description: La aplicación  [!DNL Adobe Workfront] te permite acceder a tu trabajo en cualquier dispositivo Android. Puedes instalar y usar la  [!DNL Workfront] aplicación móvil en teléfonos y tabletas con Android 5.0 o posterior.
author: Lisa
...
La aplicación de [!DNL Adobe Workfront] permite acceder al trabajo en cualquier dispositivo [!DNL Android]. Puede instalar y usar la aplicación móvil [!DNL Workfront] en teléfonos y tabletas con [!DNL Android] 5.0 o posterior.

Para obtener información sobre cómo iniciar sesión en la aplicación móvil, consulte la sección [Iniciar sesión en la [!DNL Workfront] aplicación móvil](../../../workfront-basics/manage-your-account-and-profile/managing-your-workfront-account/log-in-to-workfront.md#log) en el artículo [Iniciar sesión en [!DNL Adobe Workfront]](../../../workfront-basics/manage-your-account-and-profile/managing-your-workfront-account/log-in-to-workfront.md).

## [!UICONTROL Inicio]

El área [!UICONTROL Inicio] le permite trabajar directamente en las tareas, problemas y aprobaciones que se le hayan asignado. En el área [!UICONTROL Inicio] de la aplicación, es posible:
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>Marcar tareas y problemas como [!UICONTROL Done]</li> 
     <li>Reasignar tareas y problemas</li> 
     <li>Cambiar [!UICONTROL Commit Date]</li> 
    </ul> </td> 
   <td> 
    <ul> 
...
Para obtener más información, consulte los widgets del área de [[!UICONTROL Inicio]](../../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/home-area-widgets-mobile.md) y la sección [[!UICONTROL Mi trabajo] de la aplicación móvil](../../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/my-work-section-mobile.md).

![Área Inicio](assets/mobile-home-area.png)

## [!UICONTROL Tableros]

El área [!UICONTROL Tableros] le permite acceder a sus tableros de [!DNL Workfront].

![Área Tableros](assets/mobile-all-boards-displayed.png)
...
El área [!UICONTROL Proyectos] le permite interactuar con proyectos que usted posee y en los que participa y administrar los mismos. Desde el área de [!UICONTROL proyectos] de la aplicación, puede:
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <ul> 
     <li>Actualizar el estado de los proyectos</li> 
     <li>Ver detalles importantes de los proyectos</li> 
     <li>Publicar en el área [!UICONTROL Updates]</li> 
     <li>Convertir tareas, problemas y solicitudes en proyectos</li> 
    </ul> </td> 
   <td> 
    <ul> 
     <li>Interactuar con tareas y problemas de los proyectos</li> 
     <li>Ver documentos</li> 
     <li>Adjuntar fotos</li> 
     <li> <p>Crear tareas rápidas</p> <p>Nota: Las tareas creadas en un proyecto se asignarán automáticamente al proyecto en el que se encuentre. </p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
El área [!UICONTROL Aprobaciones] le permite ver y aprobar las aprobaciones que se le hayan asignado o delegado. Desde el área [!UICONTROL approvals], puede aprobar:
...
![Lista de autorizaciones en la aplicación móvil](assets/mobile-approvals-adobe-350x574.png)
...
El área [!UICONTROL Plantilla de horas] le permite ver detalles sobre las plantillas de horas. En el área Plantillas de horas de la aplicación, puede:

* Publicar en el área [!UICONTROL Actualizaciones]
* Administrar tipos de hora
* Cambiar el tiempo registrado
* Introducir comentarios en la plantilla de horas
* Cerrar su plantilla de horas

![Área de plantillas de horas](assets/mobile-timesheets-area.png)

## [!UICONTROL Favoritos]

Puede obtener acceso a los elementos existentes desde el menú [!UICONTROL Favoritos] y agregar nuevos elementos al menú Favoritos.
...
* Establecer preferencias de seguridad
* Enviar comentarios

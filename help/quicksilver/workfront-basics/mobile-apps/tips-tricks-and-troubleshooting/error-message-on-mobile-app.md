...
1. En la sección **[!UICONTROL Seguridad]**, seleccione la opción **[!UICONTROL Permitir que los usuarios usen las aplicaciones móviles]** de [!DNL Workfront] para habilitarla.

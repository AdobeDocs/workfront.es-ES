---
title: Uso compartido de informes, paneles de control y calendarios
content-type: reference
product-area: user-management;reports;dashboards;calendars
navigation-topic: grant-and-request-access-to-objects
description: El administrador de Adobe Workfront concede a los usuarios acceso para ver o editar informes, paneles de control y calendarios cuando asigna niveles de acceso. Para obtener más información sobre la concesión de acceso a informes, paneles de control y calendarios, consulte Concesión de acceso a informes, paneles de control y calendarios.
author: Courtney
...
## Consideraciones sobre cómo compartir un informe, panel de control o calendario
...
* El creador de un informe, panel de control o calendario tiene permisos de Administración de forma predeterminada.
* Compartir informes, paneles de control y calendarios es similar a compartir cualquier otro objeto en Workfront.
...
* También puede compartir un informe o un calendario de forma pública o en todo el sistema.
  ...
  No puede compartir un panel de control de forma pública, pero sí en todo el sistema.

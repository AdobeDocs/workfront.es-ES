...
Para obtener información sobre cómo compartir objetos en Workfront, consulte los siguientes artículos:

* Para ver los proyectos, vea [Compartir un proyecto](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-project.md).

* Para ver las tareas, vea [Compartir una tarea](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-task.md).

* Para ver los problemas, consulte [Compartir un problema](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-an-issue.md).

* Para los portafolios, vea [Compartir un portafolio](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-portfolio.md)

* Para ver los programas, consulte [Compartir un programa](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-a-program.md).

* Para ver los documentos, vea [Compartir un documento](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/document-permissions.md).

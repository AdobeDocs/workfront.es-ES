...
+++ Amplíe para ver una lista detallada de los widgets disponibles
       ...
       A continuación se muestran los 11 widgets disponibles para elegir, así como un resumen de la información que muestran:
...
1. Busque el widget en la página de inicio que desee eliminar y luego haga clic en el icono de más ![Icono de más](assets/more-icon.png) en la esquina superior derecha del widget.

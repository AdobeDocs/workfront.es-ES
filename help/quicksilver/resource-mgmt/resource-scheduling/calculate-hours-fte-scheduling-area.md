...
title: Configure cómo calcula Workfront la hora del recurso y la disponibilidad de FTE para el área de programación
description: El administrador de Adobe Workfront determina cómo calcula Workfront la disponibilidad de los recursos y la asignación de usuarios a nivel de sistema (teniendo en cuenta las horas y la disponibilidad de los usuarios a tiempo completo) cuando configura las preferencias de Gestión de recursos.
author: Alina
...
# Configure cómo calcula Workfront la hora del recurso y la disponibilidad de FTE para el área de programación
...
El administrador de Adobe Workfront determina cómo calcula Workfront la disponibilidad de los recursos y la asignación de usuarios a nivel de sistema (teniendo en cuenta las horas y la disponibilidad de los usuarios a tiempo completo) cuando configura las preferencias de Gestión de recursos.

Pueden seleccionar utilizar una de las siguientes opciones:
...
* Al permitir que Workfront asigne recursos automáticamente, como se describe en el siguiente artículo:
...
* Al mostrar los indicadores de asignación, tal como se describe en el siguiente artículo:

   * La sección &quot;Indicadores de asignación&quot; del artículo  [Administrar asignaciones de usuario en las áreas de programación](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).

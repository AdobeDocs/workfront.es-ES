...
Si sigue sin tener acceso, pregunte al administrador de Workfront si ha establecido restricciones adicionales en su nivel de acceso. Para obtener información sobre cómo un administrador de Workfront puede cambiar su nivel de acceso, consulte <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Crear o modificar niveles de acceso personalizados</a>.</p> </td>
  ...
  <tr> 
   ...
   <td> <p>Ver permisos o superiores para proyectos</p> <p>Para obtener información sobre cómo solicitar acceso adicional, consulte <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Solicitud de acceso a objetos </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
También puede crear filtros personalizados. Para obtener información sobre la personalización de filtros en el Planificador de recursos, consulte la sección [Crear filtros de Planificador de recursos](#create-resource-planner-filters) en este artículo.
...
1. Clic **Recursos**.
   ...
   El **Planificador** se muestra de forma predeterminada.

   De forma predeterminada, la primera vez que acceda al Planificador de recursos, la variable <strong>Filtro predeterminado</strong> se aplica.<br>Para obtener más información sobre el filtro predeterminado, consulte la <a href="#overview-of-the-default-filter-in-the-resource-planner" class="MCXref xref">Información general sobre el filtro predeterminado en el Planificador de recursos</a> de este artículo.

1. En la esquina superior izquierda de , haga clic en el icono **Filtrar** icono.\
   ![filter_icon.png](assets/filter-icon.png)\
   O\
   Expanda el **Filtrar** y haga clic en. **Añadir nuevo filtro**.\
...
1. Para generar un filtro utilizando los criterios integrados, especifique cualquiera de los siguientes campos:
   ...
   * **Portfolio**: Empiece escribiendo el nombre del portafolio que contiene la información que desea incluir en el Planificador de recursos y, a continuación, haga clic en el nombre cuando aparezca en la lista.\
   ...
   * **Equipo**: Empiece a escribir el nombre de uno o varios equipos asociados con los usuarios asignados a las tareas de los proyectos que desea ver.
   ...
   * **Grupos**: Empiece a escribir el nombre de uno o varios conjuntos de recursos asociados a los proyectos (en la vista de proyecto), a los usuarios (en la vista de usuario) o a los asociados tanto a los proyectos como a los usuarios (en la vista de función) que desea ver.
   * **Grupo**: Empiece a escribir el nombre de uno o varios grupos asociados a los usuarios (en la vista Usuario) o proyectos (en las vistas Proyecto y Función) que desea ver.

1. Clic **Agregar regla de filtro**, y empiece a escribir el nombre del campo por el que desea filtrar en la **Escriba para filtrar los elementos** cuadro. Si el campo está disponible, se rellena para cada objeto donde se puede asociar.
...
1. Haga clic en el nombre del campo para añadirlo al filtro cuando aparezca en la lista.\
   Para obtener más información sobre los campos que ve en la lista, consulte [Glosario de terminología de Adobe Workfront](../../workfront-basics/navigate-workfront/workfront-navigation/workfront-terminology-glossary.md).
...
1. (Opcional) Seleccione los modificadores de filtro y condición para el filtro. Los modificadores disponibles se describen en [Modificadores de filtro y condición](../../reports-and-dashboards/reports/reporting-elements/filter-condition-modifiers.md).
   ...
   Para obtener información sobre los caracteres comodín admitidos en los filtros, consulte [Resumen de variables de filtro comodín](../../reports-and-dashboards/reports/reporting-elements/understand-wildcard-filter-variables.md).

1. Clic **Guardar** para guardar la regla de filtrado.
1. (Opcional) Haga clic en **Agregar regla de filtro** para agregar una regla nueva para otro objeto o campo.
1. Clic **Aplicar** para aplicar el filtro sin guardarlo.

   O

   Clic **Guardar filtro** para guardar el filtro.\
   ![RP_Apply_or_Save_buttons_on_filters.png](assets/rp-apply-or-save-buttons-on-filters-320x79.png)

1. (Condicional) Después de hacer clic en **Guardar**, especifique un nombre para el filtro en la **Nombre del filtro** dentro de la **Guardar filtro** Cuadro de diálogo. Este campo es obligatorio.\
...
1. En la esquina superior izquierda, expanda **Filtrar** menú desplegable.
...
1. Vaya al Planificador de recursos y expanda **Filtrar** menú desplegable para seleccionar un filtro guardado.
1. Expanda el **Filtrar** menú desplegable. Busque el filtro cuyo nombre desea cambiar y pase el ratón sobre él.
1. Seleccione el **Cambiar nombre de filtro** junto al nombre del filtro.

   ![](assets/rp-filter-options-edit-350x154.png)

1. Especifique un nuevo nombre para el filtro en la **Nombre del filtro** cuadro.
1. Haga clic en **Guardar**.\
...
1. Vaya al Planificador de recursos y expanda **Filtrar** menú desplegable en la esquina superior izquierda.
1. Seleccione un filtro existente que desee editar.
1. Haga clic en **Filtrar** icono.\
   ![filter_icon.png](assets/filter-icon.png)

1. Agregue nuevos campos al filtro.\
   Para obtener información sobre la creación de filtros, consulte [Crear filtros de Planificador de recursos](#create-resource-planner-filters).

1. Pase el ratón sobre los campos existentes seleccionados para el filtro y haga clic en **Editar** para seleccionar otro campo o la variable **Eliminar** para eliminar el campo.\
   ![RP_custom_filter_delete_and_edit_icon.png](assets/rp-custom-filter-delete-and-edit-icons-350x169.png)

1. (Opcional) Haga clic en **Agregar regla de filtro** para añadir nuevos campos al filtro.\
...
1. Clic **Aplicar** para aplicar el filtro sin guardarlo.
   ...
   Clic **Guardar** para guardar el filtro.\
...
Para obtener información sobre el filtro predeterminado, consulte la [Información general sobre el filtro predeterminado en el Planificador de recursos](#overview-of-the-default-filter-in-the-resource-planner) de este artículo.
...
1. Vaya al Planificador de recursos.
1. Expanda el **Filtrar** menú desplegable.
...
1. Clic **Eliminar** en el **Eliminar filtro** Cuadro de diálogo.
...
Para obtener información sobre la duplicación de filtros, consulte [Duplicación de un filtro](#duplicate-a-filter) de este artículo.

1. Vaya al Planificador de recursos.
1. Expanda el **Filtrar** menú desplegable.
1. Busque el filtro que desea compartir y pase el ratón sobre su nombre.
1. Seleccione el **Compartir filtro** junto al nombre del filtro.

   ![](assets/rp-filter-options---share-350x154.png)

   Aparece el cuadro de diálogo Filtrar acceso.

1. (Opcional) Para que el filtro esté disponible para todos los usuarios del Planificador de recursos, haga clic en **Configuración** y luego seleccione **Hacer esto visible en todo el sistema**.

   ![](assets/make-this-visible-system-wide-350x119.png)

1. En el **Conceder acceso al filtro del planificador de recursos a:** , empiece a escribir los nombres de los usuarios, equipos, roles, grupos o empresas con los que desea compartir el filtro.
1. Seleccione entre los siguientes niveles de permisos:

   * Vista
   * Administrar

     Para obtener información sobre los permisos en Workfront, consulte [Información general sobre los permisos de uso compartido en objetos](../../workfront-basics/grant-and-request-access-to-objects/sharing-permissions-on-objects-overview.md)
...
1. Haga clic en **Guardar**.
   ...
   El filtro se comparte con las entidades seleccionadas y aparece en la **Compartido conmigo** área.

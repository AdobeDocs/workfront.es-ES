...
Para obtener información general sobre cómo asignar trabajo a usuarios y agentes de trabajo mediante el Distribuidor de cargas de trabajo, consulte [Información general sobre la asignación de trabajo en el Distribuidor de cargas de trabajo](../../resource-mgmt/workload-balancer/assign-work-in-workload-balancer.md).
...
* Al asignar roles de trabajo y usuarios de forma masiva, puede hacer lo siguiente:
  ...
  * Realice asignaciones entre usuarios y funciones en todas las combinaciones válidas.
...
* Se asignan 45 tareas de 3 proyectos diferentes a María López. María deja la organización y ahora debe reasignar sus tareas a otro usuario. Puede utilizar la función Asignar para asignar estas tareas a la nueva persona.
...
Puede asignar o reemplazar recursos en los proyectos seleccionados.
...
Cuando asigna o reemplaza un recurso mediante Asignaciones masivas en el Distribuidor de cargas de trabajo, se producen los siguientes problemas:

* El nuevo recurso se asigna a todos los elementos de trabajo asignados actualmente al recurso original dentro de los proyectos seleccionados.
...
Para asignar un recurso de forma masiva:

1. Seleccione elementos de trabajo en el área de asignaciones masivas del Distribuidor de cargas de trabajo como se ha descrito anteriormente y seleccione **Asignar recurso**.
...
1. Haga clic en **Asignar**.
   ...
   Una confirmación muestra cuántos elementos de trabajo se han reemplazado con la asignación original por el segundo recurso seleccionado.
...
1. Haga clic en **Anular asignación**.\
   Una confirmación muestra el número de elementos de trabajo en los que se eliminó el usuario especificado.

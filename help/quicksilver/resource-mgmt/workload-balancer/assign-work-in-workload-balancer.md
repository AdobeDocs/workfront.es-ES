...
Como administrador de recursos, puede utilizar el Distribuidor de cargas de trabajo de Adobe Workfront para ver los elementos de trabajo que aún no se han asignado a usuarios y agentes de trabajo, así como asignarles estos elementos.
...
Para obtener más información sobre las áreas de trabajo no asignado y asignado del Distribuidor de cargas de trabajo y la configuración del Distribuidor de cargas de trabajo, consulte [Navegar por el Distribuidor de cargas de trabajo](../../resource-mgmt/workload-balancer/navigate-the-workload-balancer.md).

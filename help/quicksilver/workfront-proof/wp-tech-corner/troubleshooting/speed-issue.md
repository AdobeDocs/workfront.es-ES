...
description: Esta página puede ayudarle a determinar si algún problema de velocidad que podría estar experimentando al usar [!DNL Workfront Proof] está relacionado con su ISP o con la red de distribución de contenido de [!DNL Workfront Proof].
author: Courtney
...
Esta página puede ayudarle a determinar si algún problema de velocidad que podría estar experimentando al usar [!DNL Workfront Proof] está relacionado con su ISP o con la red de distribución de contenido de [!DNL Workfront Proof].
...
Al usar [!DNL Workfront Proof], es posible que esté trabajando con el panel de control, por ejemplo, administrando el contenido de la carpeta y los usuarios, o con el visualizador de [!DNL Workfront Proof]: realizando una revisión de prueba, comprobando los comentarios ya realizados, etc.
...
* ¿Ocurre el problema en el panel de control o en el visualizador de [!DNL Workfront Proof]?
* ¿Qué parte exacta del sistema es lenta? (por ejemplo, procesar una nueva prueba o abrir un comentario en el visualizador de [!DNL Workfront Proof])
...
1. Cuando finalice el ping, haga clic con el botón secundario en el símbolo del sistema y en Seleccionar todo.
...
1. Abra la consola del explorador y la pestaña de red.
...
## Comprobar la conexión en una red y un equipo diferentes

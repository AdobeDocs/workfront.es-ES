...
title: Incrustar un Miniproof
description: Miniproof es un widget que permite incrustar una prueba en una página web, un blog o una wiki. Miniproof le muestra la prueba junto con todos los comentarios y marcas existentes. Se puede usar para trabajar en una prueba igual que si estuviera en  [!DNL Workfront Proof].
author: Courtney

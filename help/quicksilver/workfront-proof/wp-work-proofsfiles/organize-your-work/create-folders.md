...
description: Es posible la creación de subcarpetas en Workfront Proof.
author: Courtney
...
1. En la barra lateral, haga clic en la flecha desplegable (1) situada junto al botón verde **[!UICONTROL Nueva prueba]**.
...
Es posible crear subcarpetas de cualquiera de las siguientes maneras:

* [Creación de subcarpetas desde la página de detalles de la carpeta](#creating-a-sub-folder-from-the-folder-details-page)
* [Creación de subcarpetas desde la página de carpetas de la cuenta](#creating-a-sub-folder-from-the-account-folders-page)
...
Para obtener información sobre la página [!UICONTROL Detalles de la carpeta], consulte [Administrar carpetas y su contenido en Workfront Proof](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/manage-folders-and-contents.md).
...
1. Haga clic en el botón de nueva subcarpeta (2) de la parte superior de la página.\
   Aparecerá una nueva carpeta en la lista de elementos de la carpeta.
1. Escriba un nombre para la nueva subcarpeta. (3)
1. Presione **[!UICONTROL Entrar]**.\
   O\
   Haga clic fuera del campo de nombre de la carpeta.

1. (Opcional) Edite los detalles de la nueva subcarpeta en la página de detalles de la carpeta.
1. Continúe con [Configuración de la nueva carpeta](#configuring-the-new-folder).
...
1. Haga clic en las carpetas [Su nombre de cuenta] de la barra lateral para tener acceso a la página de carpetas de la cuenta (1)\
   ![Subfolder_from_acc_folders_1.png](assets/subfolder-from-acc-folders-1.png)

1. Busque la carpeta a la que quiera añadir una subcarpeta y abra el menú de [!UICONTROL acciones] (2)
1. Seleccione [!UICONTROL Nueva subcarpeta] en el menú (3)\
   Se mostrará la página [!UICONTROL Nueva carpeta].
1. Continúe con [Configuración de la nueva carpeta](#configuring-the-new-folder).
...
Después de empezar a crear una nueva carpeta (tal y como se describe en [Creación de una nueva carpeta de nivel superior](#creating-a-new-top-level-folder) o [Creación de una nueva subcarpeta](#creating-a-new-sub-folder)), es posible establecer las opciones de configuración que se describen en esta sección.

* [Navegación por rutas de exploración](#breadcrumb-navigation) (1)
...
### Navegación por rutas de exploración {#breadcrumb-navigation}

La navegación por rutas de exploración muestra si se está creando una carpeta de nivel superior o una subcarpeta) (1)

### Detalles de la carpeta {#folder-details}
...
En esta sección puede rellenar los detalles del cliente, lo que le permite ordenar la página Mis carpetas por nombre de cliente/proyecto:
...
En la sección [!UICONTROL Share] puede:

* Asignar un nuevo propietario a la carpeta (1): el creador de la carpeta permanecerá en la lista de la carpeta y no se podrá eliminar. Sin embargo, puede hacer que otro usuario de su cuenta sea el propietario, lo que le otorgará derechos de edición sobre la carpeta.
...
* Definir los permisos para las personas con las que comparte la carpeta (3). Esto resulta útil para compartir carpetas privadas con usuarios de su cuenta. Puede decidir si se debe permitir a los usuarios con el perfil [Perfiles de permisos de prueba en [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md) crear, editar o eliminar elementos de la carpeta.
* Quitar un usuario de la lista de uso compartido de carpetas haciendo clic en el icono de papelera (4) situado a la derecha del nombre del usuario.

...
description: Todas las carpetas están asignadas en la barra lateral de navegación izquierda de la pestaña [!UICONTROL Carpetas]. Si un usuario de una cuenta de  [!DNL Workfront Proof] diferente comparte una carpeta con usted (o comparte pruebas que están en una carpeta), la carpeta también se muestra en la pestaña [!UICONTROL Carpetas].
author: Courtney
...
>[!IMPORTANT]
>
>Este artículo hace referencia a la funcionalidad del producto [!DNL Workfront Proof] independiente. Para obtener información sobre la revisión dentro de [!DNL Adobe Workfront], consulte [Revisión](../../../review-and-approve-work/proofing/proofing.md).

Todas las carpetas están asignadas en la barra lateral de navegación izquierda de la pestaña [!UICONTROL Carpetas]. Si un usuario de una cuenta de [!DNL Workfront Proof] diferente comparte una carpeta con usted (o comparte pruebas que están en una carpeta), la carpeta también se muestra en la pestaña [!UICONTROL Carpetas].

## Administrar carpetas desde la página [!UICONTROL Carpetas de cuenta]

La página [!UICONTROL Carpetas de cuenta] muestra todas las carpetas de su cuenta (incluidas las carpetas que compartieron con usted los usuarios de otras cuentas de [!DNL Workfront Proof]) y le permite administrarlas con facilidad.

1. Haga clic en **[!UICONTROL [carpetas Su nombre de cuenta]]** en la barra lateral de navegación izquierda.\
...
1. Seleccione las carpetas que desee administrar de una de las siguientes maneras:
   ...
   * Seleccione una carpeta seleccionando la casilla de verificación que hay junto a ella.
...
1. En la barra de herramientas, realice cualquiera de las siguientes acciones:
   ...
   * Mover las carpetas a una carpeta diferente.
   * Compartir las carpetas con otros usuarios.
   * Eliminar las carpetas.
   * En el menú **[!UICONTROL Más]**, cambiar el propietario de la carpeta.

1. Seleccione la casilla de verificación de una sola carpeta y, a continuación, haga clic en el menú **[!UICONTROL Más]** (tres puntos) situado a la derecha para ver las siguientes opciones adicionales (según su nivel de acceso):
   ...
   * **[!UICONTROL Compartir]**: permite añadir nuevas personas a la carpeta.
   * **[!UICONTROL Resumen de Excel]**: permite descargar un resumen de Excel de las pruebas que hay en la carpeta.
   * **[!UICONTROL Eliminar]**: mueve la carpeta a la papelera.

>[!NOTE]
>
>Al eliminar una carpeta principal, también se eliminan todas las subcarpetas, pruebas y archivos incluidos en la carpeta.

## Administrar una carpeta desde la página Detalles de la carpeta
...
1. Realice cualquiera de las siguientes acciones:
   ...
   * Mueva la carpeta para que se encuentre en una carpeta principal diferente.\
     ...
     Mover la carpeta al nivel superior haciendo clic en **[!UICONTROL No se ha seleccionado ninguna carpeta]** en el menú desplegable.

   * Compartir la carpeta con otros usuarios.
   * Crear una nueva subcarpeta.
   * Solicitar un resumen de Excel de las pruebas que hay en la carpeta.
   * Eliminar la carpeta.
...
1. Edite el nombre y, a continuación, haga clic fuera del cuadro.\
   Workfront Proof le guarda sus cambios automáticamente.

## Cambio de una carpeta pública a una privada
...
* [Eliminación de una carpeta de la página [!UICONTROL Carpetas de cuenta]](#deleting-a-folder-from-the-account-folders-page)
* [Eliminación de una carpeta de la página [!UICONTROL Detalles de la carpeta]](#deleting-a-folder-from-the-folder-details-page)
...
1. Haga clic en el icono de **[!UICONTROL Eliminar]** (papelera).
...
1. Haga clic en el icono de **[!UICONTROL Eliminar]** (papelera) en la parte superior de la página.

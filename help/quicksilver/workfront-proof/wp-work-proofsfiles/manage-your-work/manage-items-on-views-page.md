...
>[!IMPORTANT]
>
>Este artículo hace referencia a la funcionalidad del producto independiente [!DNL Workfront Proof]. Para obtener información sobre la prueba dentro de [!DNL Adobe Workfront], consulte [Revisión](../../../review-and-approve-work/proofing/proofing.md).

La página [!UICONTROL Vistas] le permite ver todas las pruebas, archivos y carpetas y trabajar con ellos en un solo lugar.

## Cómo mostrar la página [!UICONTROL Vistas]
...
## Cambio del diseño de página de [!UICONTROL Vistas]
...
1. Haga clic en el icono **[!UICONTROL Page Layout]** (1) y, a continuación, elija el diseño que desee.

![Views_Page_Layout.png](assets/views-page-layout-350x140.png)

## Cambio de la lista [!UICONTROL Vistas]

Para cambiar lo que se ve en la lista [!UICONTROL Vistas]:

1. Haga clic en el botón **[!UICONTROL Change view]**.\
...
1. Haga clic en una vista diferente en el menú desplegable:
   ...
   * **[!UICONTROL All items]**: incluye todas las pruebas, archivos y carpetas para los que tiene permiso de visualización. Es la opción predeterminada al abrir la página [!UICONTROL Vistas]. Tiene la opción de incluir/excluir pruebas archivadas en esta vista.
   * **[!UICONTROL Active items]**: todas las pruebas, archivos y carpetas activos.
   * **[!UICONTROL Active proofs]**: todas las pruebas activas (no archivadas) para las que tiene permiso de visualización.
   * **[!UICONTROL Locked proofs]**: solo pruebas bloqueadas.
   * **[!UICONTROL Archived proofs]**: solo pruebas archivadas (consulte [Archivar en [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/archive.md)).

   * **[!UICONTROL My Proofs]**: muestra solo las pruebas de las que es el propietario y que se le han delegado. Para obtener más información, consulte [Designación de propietarios de pruebas temporales en [!DNL Workfront Proof]](../../../workfront-proof/wp-getstarted/personal-settings/designate-temp-proof-owners.md).

   * **[!UICONTROL Proofs awaiting decision]**: muestra solo las pruebas en las que debe tomar una decisión
   * **[!UICONTROL Late proofs]**: muestra solo las pruebas para las que ha pasado la fecha límite
   * **[!UICONTROL Files]**: muestra solo archivos
   ...
   * **Estado**: [!UICONTROL Pending, Changes required, Approved]
   * **Decisiones**: Número de decisiones tomadas y número requerido
   * **Propietario**: Nombre de la persona a la que pertenece la prueba\

     Mis pruebas, Pruebas pendientes de decisión y Vistas de pruebas tardías tienen una columna adicional llamada Mi fecha límite. Esta columna muestra sus propias fechas límite en las pruebas en las que se le añade explícitamente como revisor/aprobador.
...
1. Para aplicar todos los filtros elegidos, haga clic en el icono [!UICONTROL Filtro] (4) al final de la barra de filtrado.\
...
>[!NOTE]
>
>Si establece opciones de filtrado y, a continuación, oculta la barra de filtrado haciendo clic en el icono [!UICONTROL Hide filters] (5), la barra se volverá a mostrar automáticamente si cambia de vista. Si oculta la barra de filtrado mientras todos los filtros están configurados con la opción predeterminada Todos, la barra de filtrado permanece oculta al cambiar de vista.

## Ordenar elementos

Cuando crea una nueva prueba (o versión) o carga un nuevo archivo, aparece en la parte superior de su lista [!UICONTROL All items]. El elemento más antiguo aparece en la parte inferior de la lista.
...
1. Realice una de las siguientes acciones:
   ...
   * Haga clic en la flecha abajo en la esquina superior derecha de la página [!UICONTROL Views] para ordenar por la fecha de creación (Más reciente o Más antigua) o por tipo, nombre, estado, decisiones o propietario.\
   ...
   * Los cambios que realice en el orden de los elementos solo durarán mientras permanezca en la página Todos los elementos. Si sale de la página Todos los elementos y vuelve más tarde, los elementos vuelven a aparecer en el orden cronológico inverso predeterminado.

## Visualización de un resumen de prueba
...
1. Haga clic en la flecha a la izquierda de la imagen de prueba.\
   ...
   * **Fase**: indica la fecha límite de la prueba y el número de decisiones tomadas y requeridas
   * **Revisores**: se enumerará el nombre, la función y el progreso de cada revisor
   * **Versiones**: versión de la prueba que se está viendo y número total de versiones disponibles
   * **Carpeta**: carpeta en la que se encuentra la prueba
   * **Estado**: activo, bloqueado, borrador o enviado

1. (Opcional) Si tiene derechos de edición sobre la prueba y esta tiene fases, haga clic en el menú **[!UICONTROL More]** (tres puntos) a la derecha de la fase para acceder a las siguientes opciones:

   * **[!UICONTROL Message all]**: envía un correo electrónico a todos los revisores de la fase.
   * **[!UICONTROL Share]**: añade nuevos revisores
   * **[!UICONTROL Delete stage]**

1. (Opcional) Haga clic en el menú **[!UICONTROL More]** (tres puntos) de un revisor, que se encuentra a la derecha de su nombre, para realizar una de las siguientes acciones:

   * Enviar un mensaje recordatorio al revisor.
   * Edite la configuración del revisor en la prueba.\

     En el cuadro Editar revisor que aparece, puede cambiar no solo las alertas de función y de correo electrónico, sino también el Nombre para mostrar del revisor. Tenga en cuenta que el Nombre para mostrar solo se puede cambiar en la prueba específica, no en los detalles del revisor en la página Contactos. Consulte [Contactos](https://support.workfront.com/hc/en-us/sections/115000920808-Contacts) para obtener más información.
   ...
   * También puede cambiar la función y las alertas de correo electrónico de un revisor añadido a la prueba.

## Incluir y excluir pruebas archivadas
...
1. Realice una de las siguientes acciones:
   ...
   * Para abrir una revisión en el visor de revisiones, haga clic en **[!UICONTROL Ir a la revisión]**.\
     ...
     Para obtener información sobre el visor de revisión, consulte [Revisión de una prueba](../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-a-proof.md).
...
1. En las opciones adicionales que aparecen encima de la lista Vistas, realice una de las acciones siguientes en los archivos seleccionados:
   ...
   * Haga clic en **[!UICONTROL Etiquetas]** para añadir una etiqueta a estos elementos.
...
1. Abra la estructura de carpetas en la barra lateral haciendo clic en la flecha que está a la izquierda de su carpeta principal.
1. Realice una de las siguientes acciones:

...
1. En el panel de control o en una vista de lista, agrupe las pruebas en las que desee trabajar arrastrándolas a la carpeta creada.

   ![Drag_proof_to_folder.png](assets/drag-proof-to-folder-350x162.png)

## Revisar varias pruebas agrupadas en una carpeta

Como revisor, puede trabajar con varias revisiones en una carpeta sin salir del visor de corrección.

1. En [!DNL Workfront Proof], haga clic en el nombre de la carpeta para abrirla y luego abra una revisión en la carpeta para iniciar el visor de corrección.
...
1. (Opcional) Realice cualquiera de las siguientes acciones con las revisiones de la carpeta mientras utiliza el visor de corrección:
   ...
   * Para comparar dos revisiones en la carpeta, abra una revisión, luego seleccione la otra en la lista de carpetas y haga clic en el botón [!UICONTROL Comparar] en el extremo derecho de esa revisión (consulte [Comparar revisiones en el visor de corrección](../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md) si necesita más información acerca de la comparación de dos revisiones).

     ![Compare_button_in_folder_list_in_proofing_viewer.png](assets/compare-button-350x67.png)

     Mientras compara revisiones, si desea cambiar a una nueva revisión, ya sea en el lado izquierdo o derecho del visor de corrección, haga clic en el botón [!UICONTROL Comparar] situado encima de la revisión.

...
title: Códecs en  [!DNL Workfront Proof]
description: Códecs en  [!DNL Workfront Proof]
author: Courtney
...
* Códec sin pérdidas de [!DNL Alparysoft]
...
* [!DNL IBM Ultimotion]
* [!DNL IBM UltiMotion]
* [!DNL id Quake II CIN] vídeo
* [!DNL id RoQ] vídeo
* [!DNL IFF ByteRun1]
* [!DNL IFF ILBM]
* Códec [!DNL Independent JPEG Group's]
...
* [!DNL Intel Indeo 5]
* [!DNL Interplay C93]
* [!DNL Interplay MVE] vídeo
* códec de vídeo de [!DNL Karl Morton]
* [!DNL Kega Game Video]
...
* [!DNL Nintendo Gamecube THP] vídeo
...
* [!DNL On2 VP7]
* [!DNL Power VideoWorks] vídeo
* [!DNL ProRes 422]
* [!DNL Psygnosis YOP] vídeo
* [!DNL Q-team QPEG]
* [!DNL QPEG]
* [!DNL QuickTime 8BPS] vídeo
* [!DNL QuickTime Animation (RLE)] vídeo
...
* [!DNL Sierra VMD] vídeo
* [!DNL sif1 alpha4]
* [!DNL Smacker] vídeo
* [!DNL SMPTE VC-1]
* [!DNL SMV2]
* [!DNL Snow]
* Códec [!DNL SoftMedia ViVD V2]
...
* [!DNL Telegeny VDTZ]
* [!DNL Theora]
* [!DNL Tiertex Limited SEQ] vídeo
* [!DNL TrueMotion 1.0]
* [!DNL TrueMotion 2.0]
* [!DNL UCOD-ClearVideo]
* códec avanzado [!DNL VDOWave 3]
* Códec [!DNL VDOWave]
* [!DNL Verint Video Manager]
* [!DNL Vianet Lsvx Video]
* [!DNL VMware Screen Codec] / [!DNL VMware Video]
* [!DNL VP8]
* [!DNL VQA (Vector Quantized Animation)] vídeo
* [!DNL VSS Codec Light]
* [!DNL VSS Wavelet Video Codec]
* [!DNL WebTrain Communication] grabadora de pantalla sin pérdidas
* Códec [!DNL wincam screen capture]
...
* Códec [!DNL Winnov Videum winx]
* Códec [!DNL Winnov Videum wnv1]
* [!DNL Winnov WNV1]
...
* [!DNL ProRes 4444] ([!DNL ProRes 422] compatible)
* [!DNL HDV 720p60]
* [!DNL Go2Meeting3 (G2M3)]
* [!DNL Go2Meeting4 (G2M4)]
* [!DNL ER AAC LD] (Resistente a errores, variante de baja demora de [!DNL AAC])
* [!DNL REDCODE]

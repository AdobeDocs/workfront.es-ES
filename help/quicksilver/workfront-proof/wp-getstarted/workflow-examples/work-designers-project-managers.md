...
title: Trabajo con diseñadores y gerentes de proyectos en  [!DNL Workfront Proof]
description: Puede mejorar el flujo de trabajo de la corrección para el gerente del proyecto (la persona que gestiona el proceso de revisión) y el diseñador que trabajan conjuntamente en un proyecto de las dos formas que se describen a continuación.
author: Courtney

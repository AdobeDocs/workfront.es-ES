...
1. Seleccione la opción [!UICONTROL Ver detalles] en la parte superior del menú desplegable.\
   Esta opción varía en función de si se pone en contacto con un usuario, invitado o abonado.
1. En la página que aparece, abra la sección **[!UICONTROL Elementos compartidos]**.
1. Seleccione la casilla de verificación de los elementos que desee recordar a este revisor.\
   O\
   Si desea recordarles todas sus revisiones, active la casilla de verificación situada encima de la lista.

...
## Envar un mensaje a los revisores de una prueba

1. En cualquier vista de lista o en el [!UICONTROL Panel de control], haga clic en el menú **[!UICONTROL Más]** (tres puntos) de la prueba y, a continuación, haga clic en **[!UICONTROL Mensaje]**.
...
## Enviar un mensaje a los revisores de una fase

1. En cualquier vista de lista o panel de control, haga clic en el menú **[!UICONTROL Más]** (tres puntos) de la prueba y, a continuación, haga clic en **[!UICONTROL Ver detalles de la prueba]**.

1. En **[!UICONTROL Flujo de trabajo,]** en la esquina superior derecha del escenario, haga clic en el menú **[!UICONTROL Más]** (tres puntos) del escenario y, a continuación, haga clic en **[!UICONTROL Enviar mensaje a todos]** en el menú desplegable.

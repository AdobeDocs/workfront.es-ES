...
title: 'Personalización de marca del sitio [!DNL Workfront Proof] '
description: Como administrador de [!DNL Workfront Proof] puede personalizar su cuenta de [!DNL Workfront Proof] para que usted y sus usuarios disfruten de una experiencia más personalizada.
author: Courtney

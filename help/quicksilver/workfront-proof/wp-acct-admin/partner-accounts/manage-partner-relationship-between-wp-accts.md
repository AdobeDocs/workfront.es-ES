...
# Administrar una relación de socio entre cuentas de [!DNL Workfront Proof]
...
La relación de socios se establece entre dos organizaciones en lugar de entre dos usuarios, y ambas organizaciones deben tener una cuenta [!DNL Workfront Proof].

>[!NOTE]
>
>Los usuarios de la cuenta de socio aparecerán como miembros en su cuenta de y viceversa. Si su socio añade un nuevo usuario a su cuenta, este nuevo usuario aparecerá automáticamente en su página de contactos como miembro. Del mismo modo, cuando añada un nuevo usuario a su cuenta, ese nuevo usuario aparecerá en la página de contactos de su socio como miembro.
...
>[!NOTE]
>
>La relación de socio aparece tanto en la cuenta de remitente como en la de destinatario, en la pestaña [!UICONTROL Socios].
...
Si la organización destinataria elimina una invitación, la invitación ya no se mostrará en la cuenta del destinatario, pero aparecerá como [!UICONTROL Rechazada] en la cuenta del remitente.
...
Es posible eliminar una relación de socio existente si ya no es necesaria. Cuando se elimina una relación de socios, los usuarios de la cuenta del antiguo socio se mantienen en la página de [!UICONTROL Contactos], pero los futuros usuarios no se sincronizarán. Los elementos compartidos anteriormente permanecen en ese estado.

...
description: Si tiene una relación de socio de  [!DNL Workfront Proof]  con otra organización (como un cliente u otro departamento de su compañía), puede compartir pruebas, archivos, carpetas y detalles de contacto con el socio. Para obtener más información acerca de las relaciones de socio, consulte Administrar una relación de socio entre cuentas de  [!DNL Workfront Proof] .
author: Courtney

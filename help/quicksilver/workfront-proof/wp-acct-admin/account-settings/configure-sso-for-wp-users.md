...
description: Si tienes el plan Select o Premium, puedes proporcionar la capacidad de inicio de sesión único (SSO) que te permite usar el nombre de usuario y la contraseña de tu organización para acceder a tu cuenta de  [!DNL Workfront Proof] i.
author: Courtney
...
Si tiene el plan Select o Premium, puede proporcionar la capacidad de inicio de sesión único (SSO) que le permite usar el nombre de usuario y la contraseña de su organización para acceder a su cuenta de [!DNL Workfront Proof].
...
## Habilitando SSO en [!DNL Workfront Proof]

La funcionalidad de inicio de sesión único se puede habilitar en la ficha [!UICONTROL Inicio de sesión único] de la [!UICONTROL configuración de la cuenta] y se aplicará a todos los usuarios de la cuenta de [!DNL Workfront Proof]. Consulte [Configuración de la cuenta](https://support.workfront.com/hc/en-us/sections/115000912147-Account-settings) para obtener más información.
...
Una vez habilitada esta opción, las cuentas de usuario se crearán automáticamente para las personas que no tengan sus propios perfiles de [!DNL Workfront Proof], pero que tengan acceso a la cuenta de [!DNL Workfront Proof] mediante sus credenciales de inicio de sesión único. Esto solo se llevará a cabo cuando aún no se haya alcanzado el límite de usuarios en su cuenta.

1. Los nuevos usuarios aprovisionados tendrán los permisos de perfil de Responsable asignados de forma predeterminada. Si necesita más información, vea [Perfiles de permisos de revisión en [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md).
...
1. ![Habilitando_SSO_-_Cuenta_satélite.png](assets/enabling-sso---satellite-account-350x266.png)
...
![Cuenta_satélite_-_Herited_SSO.png](assets/satellite-account---inherited-sso-350x99.png)

En su cuenta de concentrador (9), el campo [!UICONTROL Uso de SSO] muestra que esta configuración la utilizan las cuentas satélite (10).\
...
1. Abra la ficha **[!UICONTROL Inicio de sesión único]**.
1. Haga clic en **[!UICONTROL Editar],** para rellenar el campo y, a continuación, haga clic en **[!UICONTROL Guardar]** (2).

1. En la fila **[!UICONTROL SSO]**, haga clic en **[!UICONTROL Habilitado]** (3).

![Cuenta_satélite_-_Manual_SSO.png](assets/satellite-account---manual-sso-350x280.png)
...
1. Abra la ficha **[!UICONTROL Inicio de sesión único]**.
1. Asegúrese de que el dominio o subdominio [!DNL Workfront Proof] (1) esté configurado y de que los usuarios tengan acceso a su cuenta de [!DNL Workfront Proof] a través de este dominio o subdominio personalizado.
...
Cuando la funcionalidad de inicio de sesión único está habilitada en su cuenta de [!DNL Workfront Proof], los nuevos usuarios no recibirán ningún correo electrónico de confirmación, ya que sus cuentas se activarán automáticamente y estarán listas para usar.

Desde la página de inicio de sesión de [!DNL Workfront Proof], después de hacer clic en el botón [!UICONTROL Iniciar sesión], se redirige a los usuarios a la página de inicio de sesión de SSO y se les pide que escriban sus credenciales de inicio de sesión de inicio de sesión único.

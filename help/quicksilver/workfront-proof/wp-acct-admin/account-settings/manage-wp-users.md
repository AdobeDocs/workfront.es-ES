...
title: 'Administrar usuarios de  [!DNL Workfront Proof] '
...
1. Abra la pestaña **[!UICONTROL Usuarios]**.
   ...
   Esta pestaña enumera los usuarios de su cuenta y los detalles de su cuenta de usuario.
...
1. (Opcional) Seleccione uno o varios usuarios y, a continuación, haga clic en cualquiera de las siguientes opciones:
   ...
   | **[!UICONTROL Volver a invitar]** | Volver a invitar al usuario o usuarios seleccionados para que tengan acceso a [!DNL Workfront Proof]. |

---
title: Aplicación móvil Workfront Proof para tabletas
description: El [!DNL Workfront Proof] la aplicación para tableta le permite revisar y aprobar convenientemente sus pruebas cuando está fuera de casa. La aplicación está disponible para descargar para todos, no tiene que ser un [!DNL Workfront Proof] para poder revisar las pruebas en la tableta o el teléfono.
hide: true
hidefromtoc: true
...
El [!DNL Workfront Proof] la aplicación para tableta le permite revisar y aprobar convenientemente sus pruebas cuando está fuera de casa. La aplicación está disponible para descargar para todos, no tiene que ser un [!DNL Workfront Proof] para poder revisar las pruebas en la tableta o el teléfono.

Los huéspedes pueden simplemente hacer clic en [!UICONTROL Ir a la revisión] en la notificación por correo electrónico que reciben para abrir la prueba en la aplicación.

[!DNL Workfront Proof] los usuarios pueden iniciar sesión en la aplicación y utilizar el panel para administrar convenientemente su trabajo.

## Requisitos del dispositivo

* dispositivos iOS: iPad 3, iPad air, iPad mini
* Dispositivos Android: sistema operativo Android versión 4.4+, 5+; Samsung Galaxy Tab 3+ (10,1&quot;)

Se trata de una aplicación diseñada específicamente para tabletas. Si desea utilizar el [!DNL Workfront Proof] en iPhone, descargue la aplicación de iOS desde iTunes Store.
...
El [!DNL Workfront Proof] La aplicación para tableta está disponible en Apple App Store y en Google Play Store.
...
El [!DNL Workfront Proof] la aplicación para tableta le permite acceder al tablero con las pruebas que requieren su atención. Para acceder al tablero:

1. Realice una de las siguientes acciones:

   * Inicie sesión con su [!DNL Workfront Proof] credenciales.
...
Si desea mantener la sesión iniciada en [!DNL Workfront Proof] cuenta:

1. Activar **[!UICONTROL Mantener mi sesión]** en el menú de la barra lateral debajo de **[!UICONTROL Configuración]**:

![Keep_me_logged_in.gif](assets/keep-me-logged-in-350x446.gif)

El *[!UICONTROL Tablero]* Este vínculo le devolverá al tablero desde cualquier vista de la aplicación. También puede utilizarlo para volver a cargar el tablero.
...
Al igual que los gráficos de panel de nuestra aplicación web, en la aplicación móvil mostramos una lista de pruebas que se compartieron con usted. El mensaje de bienvenida en la parte superior de la página le proporcionará la cantidad total de pruebas y, debajo, las desglosaremos en *A tiempo*, *En riesgo*, y *Pruebas tardías*.

* **Pruebas de tiempo de activación** son las pruebas que no tienen un plazo establecido o que se han agotado en más de 24 horas.
* **Pruebas de riesgo** son los que tienen la fecha límite en las próximas 24 horas: la barra de progreso de estas pruebas es naranja.
* **Pruebas tardías** son las pruebas que ya han pasado la fecha límite: la barra de progreso está en rojo para estas pruebas. Al llegar al plazo [!DNL Workfront Proof] envía un correo electrónico recordatorio automatizado a los responsables de la toma de decisiones tardía y al propietario de la prueba.
...
1. Haga clic en el nombre de la prueba para abrirla en [!DNL Workfront Proof] Visor.

   O

   Para abrir una prueba desde una notificación por correo electrónico, los revisores pueden hacer clic en **[!UICONTROL Ir a la revisión]** en la notificación.
Si tiene un [!DNL Workfront Proof] , puede iniciar sesión y acceder a la prueba desde el panel.
...
1. Navegue en la prueba:
   ...
   * Para desplazarse, mantenga presionada la tecla y mueva la imagen hasta que encuentre la posición correcta.
     ...
     La revisión de pruebas en la aplicación móvil es tan sencilla como la de pruebas mediante el [!DNL Workfront Proof] Visor. A continuación analizaremos más de cerca la adición de comentarios y marcas, la administración de comentarios y la toma de decisiones. También analizaremos las diferentes opciones disponibles en la barra lateral de la aplicación.
...
Solo puede editar y eliminar comentarios si no se ha publicado ninguna respuesta. Si no ve la etiqueta [!UICONTROL papelera] , es posible que esta opción haya sido desactivada por su [!DNL Workfront Proof] administrador.
...
La corrección de texto sobre la marcha está realmente en la [!DNL Workfront Proof] aplicación para tableta. La herramienta de anotación de texto está disponible en la barra de herramientas de marcas después de hacer clic en la naranja **[!UICONTROL Añadir comentario]** botón.
...
1. Mantenga presionado el dedo sobre la palabra hasta que esté disponible el resaltado y utilice los controles deslizantes para resaltar la palabra o frase completa que desee marcar.
   ...
   |---|---|
   | **[!UICONTROL Reemplazar]** | Agrega [[!UICONTROL REPLACE]] y [[!UICONTROL CON]] en el cuadro de comentarios junto con el texto, lo que facilita la recomendación de texto de sustitución. |
   | **[!UICONTROL Eliminar]** | Tiras el texto y añade [DELETE] al cuadro de comentarios. |
   | **[!UICONTROL Insertar después]** | Agrega [INSERTAR TRAS] en el cuadro de comentarios. |
...
Después de que todos hayan dejado sus comentarios y marcas en la prueba, con mucha frecuencia el administrador de pruebas debe revisar los comentarios y decidir qué cambios se deben aplicar a la siguiente versión de la prueba. Entrada [!DNL Workfront Proof] puede utilizar Actions on comments para marcar cada comentario individual y marcar los que deben realizarse.

Las acciones sobre los comentarios deben configurarse en su cuenta mediante el [!DNL Workfront Proof] administrador y solo pueden utilizarlos en una prueba las personas que tengan derechos de edición.
...
![locked_comments.png](assets/locking-comments-350x246.png)

## Revisión de pruebas de vídeo

Revisar los vídeos sobre la marcha es fácil con el [!DNL Workfront Proof] aplicación para tableta. El siguiente vídeo muestra cómo realizar comentarios, marcas y decisiones en la aplicación.
...
>[!NOTE]
>
>Debido a las limitaciones de iOS, la comparación de dos vídeos no está disponible en los iPads. Está disponible en tablets con sistemas operativos Android.
...
| Panel | Le lleva de nuevo al panel de la aplicación móvil. |
|---|---|
...
| **[!UICONTROL Configuración]** | Puede optar por mostrar chinchetas o marcas en la prueba; también puede activar [!UICONTROL Mantener mi sesión] para evitar que se cierre la sesión de la aplicación. |

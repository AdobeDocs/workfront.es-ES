...
1. Vaya a la página principal del usuario al que desee enviar un mensaje.\
   ...
   * Haga clic en el nombre vinculado del usuario tal como aparece en cualquier parte de la interfaz [!DNL Workfront]. Los nombres de usuario se muestran en muchas áreas de la interfaz [!DNL Workfront], como en un comentario realizado por el usuario.

1. En la ficha **[!UICONTROL Actualizaciones]**, haga clic en el campo del cuadro de texto.

   ![Usuario de mensaje en la ficha [!UICONTROL Actualizaciones]](assets/message-user-NWE.png)
...
El mensaje se publica en la parte superior de la lista de mensajes de la ficha **[!UICONTROL Actualizaciones]** de la página principal del usuario.

...
description: Como administrador de Adobe Workfront, puede utilizar un nivel de acceso para definir el acceso de un usuario a los proyectos en Workfront.
author: Caroline
...
Como administrador de Adobe Workfront, puede utilizar un nivel de acceso para definir el acceso de un usuario a los proyectos, tal como se explica en [Información general sobre los niveles de acceso](../../../administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).
...
## Configuración del acceso de los usuarios a los proyectos mediante un nivel de acceso personalizado

1. Comience a crear o editar el nivel de acceso, tal como se explica en [Crear o modificar niveles de acceso personalizados](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md).
1. Haga clic en el icono del engranaje ![](assets/gear-icon-settings.png) en el **Ver** o **Editar** a la derecha de Proyectos y, a continuación, seleccione las capacidades que desea conceder en **Ajustar la configuración**.

   ![](assets/planner-fine-tune-your-settings-with-copy-projects.png)

   >[!NOTE]
   >
   >* Los usuarios con una licencia de trabajo tienen derechos de proyecto limitados. Pueden contribuir a un proyecto, pero no administrarlo.
   >* Los usuarios con una licencia de revisión tienen derechos de visualización en proyectos de problemas convertidos, pero sus derechos de visualización son limitados.
...
1. (Opcional) Haga clic en **establecer valores predeterminados de uso compartido** a la derecha de la opción Crear y, a continuación, **Agregar regla** para agregar una regla de uso compartido para nuevos proyectos.
   ...
   Cuando el usuario con este nivel de acceso crea un proyecto, el proyecto se comparte automáticamente con los usuarios seleccionados en el menú de la izquierda.

   ![](assets/project-sharing-menu.png)

   En el menú de la derecha, especifique cómo desea que el proyecto se comparta con esos usuarios:

   ![](assets/project-sharing-right-menu.png)

   >[!NOTE]
   >
   >Si un usuario con este nivel de acceso utiliza una plantilla de acceso a un proyecto, la plantilla anula la configuración de uso compartido en el nivel de acceso. Para obtener información sobre las plantillas de acceso al proyecto, consulte [Uso compartido de un proyecto en Adobe Workfront](../../../workfront-basics/grant-and-request-access-to-objects/share-a-project.md).

...
description: Su organización compró una cantidad determinada de licencias cuando adquirió Adobe Workfront. Como administrador de Workfront, usted proporciona uno de los tres tipos de licencias nuevas de Workfront a cada usuario cuando les asigna un nivel de acceso.
author: Becky
...
Su organización compró una cantidad determinada de licencias cuando adquirió Adobe Workfront. Como administrador de Workfront, usted proporciona uno de los dos tipos de licencias de Workfront a cada usuario cuando les asigna un nivel de acceso.
...
>[!NOTE]
>
>La licencia externa no es una licencia de pago. Está diseñada principalmente para compartir documentos con personas que no utilizan Workfront. Para obtener más información, consulte [Información general sobre los niveles de acceso](/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/access-level-overview.md).

...
title: Inicio de sesión único en Adobe Workfront
description: Puede integrar Workfront con su solución SSO corporativa existente. Esta configuración es fácil de configurar y administrar y está disponible para los clientes OnDemand y OnPremise Enterprise.
author: Caroline
...
# Inicio de sesión único en Adobe Workfront

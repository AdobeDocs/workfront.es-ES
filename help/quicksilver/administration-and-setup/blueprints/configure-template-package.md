...
1. En la sección [!UICONTROL Preferencias de plantilla], especifique un nuevo nombre de plantilla.
...
![[!UICONTROL Asignación de grupo], sección](assets/Blueprints_GroupMapping.png)

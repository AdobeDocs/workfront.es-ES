...
description: Puede copiar una plantilla de diseño existente. Esto resulta útil cuando su organización necesita varias plantillas de diseño que compartan muchas de las mismas configuraciones.
author: Caroline
...
Puede copiar una plantilla de diseño existente. Esto resulta útil cuando su organización necesita varias plantillas de diseño que compartan muchas de las mismas configuraciones.
...
1. Haga clic en **Copiar**.
   ...
   Toda la configuración, excepto el nombre, la descripción y las asignaciones de usuario en la plantilla de diseño existente, se copia en la nueva plantilla.

1. En la pantalla que aparece, escriba una nueva **Nombre de la plantilla de diseño** y (opcional) a **Descripción** para ello.
...
1. (Opcional) Personalice la plantilla como se describe en los siguientes artículos:

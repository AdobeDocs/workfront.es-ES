...
1. Clic **Previsualizar** en la esquina superior izquierda para ver el aspecto que tendrá el formulario cuando se utilice, y después haga clic en **Finalizar previsualización** para volver a la edición del formulario.

...
>[!IMPORTANT]
>
>El procedimiento descrito en esta página se aplicaba únicamente a las organizaciones que aún no se habían incorporado a Admin Console.
>
>Todas las organizaciones de Workfront se han incorporado a Adobe Admin Console. Por lo tanto, ya no es posible cambiar el dominio de Workfront.

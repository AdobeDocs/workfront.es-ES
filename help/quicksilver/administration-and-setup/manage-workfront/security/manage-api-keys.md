...
1. Para configurar las claves API para que caduquen al caducar las contraseñas de los usuarios, seleccione **Quitar clave API cuando caduque la contraseña de un usuario**.

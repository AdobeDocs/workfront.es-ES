...
Cuando exporta una plantilla de KickStart, recibe un libro de Excel en blanco. En los procedimientos posteriores de este artículo, rellenará el libro con la información y, a continuación, lo importará de nuevo a Workfront.

Para exportar una plantilla de KickStart:

1. Haga clic en **Menú principal** icono ![](assets/main-menu-icon.png) en la esquina superior derecha de Adobe Workfront, haga clic en **Configurar** ![](assets/gear-icon-settings.png).

1. Clic **Sistema** > **Exportar datos (Kick-Starts)**.

1. Clic **Más opciones**, a continuación, seleccione los tipos de información que desea incluir.

   Cada opción seleccionada representa una colección de varias fichas en la hoja de cálculo exportada. Por ejemplo, si selecciona la opción Informe, todos los objetos necesarios para crear un informe se incluyen en la hoja de cálculo (vistas, filtros, agrupaciones e informes).
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td scope="col"> <p>Informe</p> <p>Todos los informes del sistema están disponibles para exportar. Puede seleccionar hasta 100 informes específicos en una sola exportación.</p> </td> 
      <td scope="col">Exportaciones como archivo ZIP </td> 
     ...
     <tr> 
      ...
      <td scope="col"> <p>Aprobador de etapa</p> <p>Paso de aprobación</p> <p>Ruta de aprobación</p> <p>Proceso de aprobación</p> <p>Preferencias</p> </td> 
     </tr> 
     <tr> 
...
>
>* No elimine ni modifique estos campos de ninguna manera. Por ejemplo, no cambie el orden ni los nombres.
>* Rellene cada campo con un encabezado de columna en negrita. Estos representan campos obligatorios.
>
...
1. (Opcional) Para agregar datos personalizados:
   ...
   * Asigne un nombre a cada nueva columna para su campo personalizado correspondiente de la siguiente manera: **DE:[Nombre del campo personalizado tal como aparece en Workfront]**.
...
>[!TIP]
>
>A la mayoría de las personas les resulta más fácil utilizar el formato MM/DD/AAAA (por ejemplo: 10/07/2022).

Workfront también acepta valores de hora como parte de la fecha (por ejemplo: 10/07/2022 01:30 o 10/07/2022 1:00 PM).

Si omite una hora en la fecha, Workfront realiza una de las siguientes acciones:

* Asume las 12:00 AM. Para ver el resultado de la fecha que espera, la zona horaria del sistema debe coincidir con la del sistema.
...
* **(importación de proyecto)**
  ...
  Para realizar la sustitución de nombres de atributo para el ejemplo descrito anteriormente, cambie el **setGroupID** encabezado de columna a **#setGroupID GROUP****name**. A continuación, puede hacer referencia al grupo de cada proyecto por su nombre.
...
1. Clic **Cargue.**
   ...
   Si el archivo de Excel tarda más de 5 minutos en cargarse en Workfront, la aplicación agota el tiempo de espera y no se puede cargar el archivo.

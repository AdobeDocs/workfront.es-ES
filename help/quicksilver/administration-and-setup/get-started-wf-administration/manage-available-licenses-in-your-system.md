...
1. En la parte inferior del panel izquierdo, haga clic en **Sistema** > **Licencias**.
   ...
   Para obtener más información sobre las licencias enumeradas en esta página, consulte [Información general sobre las licencias de Adobe Workfront](../../administration-and-setup/add-users/access-levels-and-object-permissions/wf-licenses.md).
...
## Visualización de información sobre licencias para complementos de Workfront

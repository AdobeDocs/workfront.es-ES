...
description: Adobe Workfront registra la actividad que tiene lugar en ciertos objetos del área [!UICONTROL Actualizaciones]. Una actualización del sistema incluye una breve nota que describe el tipo de cambio que se produjo en el objeto. [!DNL Workfront] Los administradores pueden definir el tipo de cambios que el sistema debe realizar en la sección [!UICONTROL Actualizaciones].
author: Alina
...
* [Información general sobre actualizaciones rastreadas por el sistema](../../../administration-and-setup/set-up-workfront/system-tracked-update-feeds/system-tracked-update-feeds.md)

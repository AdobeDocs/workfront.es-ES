...
description: Cuando visualiza un grupo que administra, puede ver y administrar a todos los usuarios de los subgrupos del grupo.
author: Lisa
...
1. Realice una de las siguientes acciones:
   ...
   * Seleccione un miembro de la lista y, a continuación, haga clic en Editar ![Editar icono](assets/edit-icon.png) para modificar el perfil de usuario de esa persona.
   ...
   * Exportar ![Exportar](assets/export.png) la lista de miembros.

...
Para revisar un documento desde el visor Frame.io, la instancia de Workfront debe estar integrada con Frame.io. Para obtener más información, consulte [Resumen unificado de revisión y aprobación](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/document-approvals-overview.md).
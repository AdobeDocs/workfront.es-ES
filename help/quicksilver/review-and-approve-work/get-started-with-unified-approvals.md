...
title: Introducción a la revisión y aprobación unificadas
...
Si su organización tiene una licencia de Frame.io Enterprise, los proyectos creados en Workfront también son visibles en Frame.io, lo que permite a los usuarios interactuar y cargar recursos en cualquier producto. En Frame.io, todos los proyectos vinculados a Workfront se agrupan en un único Workspace denominado **Proyectos vinculados a Workfront**. Para obtener más información sobre cómo aparecen y se comportan los proyectos vinculados en Frame.io, consulte [Información general sobre la integración de Adobe Workfront](https://help.frame.io/en/articles/12242607-adobe-workfront-integration-overview) en la documentación de Frame.io.
...
Los coordinadores de proyecto pueden crear aprobaciones y revisiones únicas o plantillas de aprobación reutilizables. Pueden asignar revisores, aprobadores o una combinación de ambos:
...
* **Aprobaciones de un solo uso**: en el proyecto o tarea donde reside el recurso, el coordinador del proyecto puede asignar revisores y aprobadores y establecer un límite de finalización. Se recuerda a los revisores y aprobadores por correo electrónico 72 horas antes del plazo, 24 horas antes del plazo y, a continuación, en el propio plazo. También puede configurar aprobaciones de varias etapas y rutas paralelas para que se ejecuten varios seguimientos de revisión al mismo tiempo.
...
* **Aprobado con cambios**: el recurso está casi completo, pero necesita cambios menores para poder utilizarlo. Una vez realizados los cambios especificados, el recurso está listo y no necesita pasar por otra ronda de aprobaciones.
...
Para obtener más información, consulte [Usar Adobe Experience Manager con Workfront y el almacenamiento en la nube de Adobe](/help/quicksilver/review-and-approve-work/native-integrations/frame-io/use-aem-with-frame.md).

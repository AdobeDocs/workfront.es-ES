...
title: Habilitar el bucle en una prueba de vídeo
description: Puede configurar el vídeo para que se reproduzca en bucle continuamente (el vídeo empezará a reproducirse de nuevo una vez finalizado).
author: Courtney

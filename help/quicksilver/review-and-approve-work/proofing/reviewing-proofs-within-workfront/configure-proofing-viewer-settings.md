...
* Indica si las marcas de comentario y los anclajes se muestran en las pruebas.
* Si las herramientas de marcado se muestran en la parte superior del visor de pruebas o en un menú desplegable.
* Qué notificaciones de correo electrónico recibe como revisor en la prueba que ha abierto.
...
Puede configurar las siguientes opciones para el Visor de corrección de escritorio:

* Cómo desea que se abran los vínculos dentro del contenido del sitio web en el visor.
...
* Qué sucede cuando hace clic en un vínculo configurado para abrirse en una nueva pestaña o ventana del explorador.
* Borre los datos de la caché que se puedan guardar con la prueba que está viendo para permitir que el contenido como las ventanas emergentes (que pueden bloquearse con los datos de caché del explorador) se muestre en el visor.
...
1. Configure cualquiera de las siguientes opciones **Configuración** que se muestran.
   ...
   * **Al hacer clic en hipervínculos en una prueba** (disponible solo en el Visor de pruebas de escritorio): seleccione una opción para especificar qué sucede en el Visor de pruebas de escritorio al hacer clic en un vínculo configurado para abrirse en una nueva pestaña o ventana del explorador.
     ...
     <table style="table-layout:auto"> 
      ...
      <tbody> 
       <tr> 
        <td role="rowheader">Abrir en el visor de revisión</td> 
        <td>Los vínculos siempre se abren en el Visor de corrección de escritorio y puede revisar el contenido vinculado. </td> 
       </tr> 
       <tr> 
        <td role="rowheader">Abrir en el explorador</td> 
        <td>Los vínculos siempre se abren en el explorador, no en un visor de pruebas. No puede probar el contenido vinculado.</td> 
       </tr> 
       <tr> 
        <td role="rowheader">Preguntarme cada vez</td> 
        <td> <p>Se le preguntará cada vez si desea abrir el vínculo en el Visor de pruebas de escritorio o en el explorador. Si abre el vínculo en el Visor de corrección de escritorio, puede revisar el contenido vinculado. Si abre el vínculo en el explorador, no podrá probar el contenido vinculado.</p> <p> <img src="assets/proof-desktop-alwaysask-350x243.png" alt="proof_desktop_alwaysask.png" style="width: 350;height: 243;"> </p> <p>Esta configuración solo afecta a la prueba que haya abierto.</p> </td> 
       </tr> 
      </tbody> 
     </table>
   ...
   * **Borrar caché**: borra los datos de caché del explorador que podrían guardarse con una prueba interactiva que está viendo. Esto permite que el contenido, como las ventanas emergentes (que pueden bloquearse con los datos de caché del explorador), se muestre en el Visor de corrección de escritorio.
     ...
     Esta configuración solo afecta a la prueba que haya abierto.

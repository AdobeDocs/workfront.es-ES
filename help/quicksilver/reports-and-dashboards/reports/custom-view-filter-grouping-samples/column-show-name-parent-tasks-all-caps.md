...
1. En el menú desplegable **Vista**, seleccione **Personalizar vista**.\
   O\
...
1. Elimine el texto que encuentre en el cuadro **Modo de texto** y reemplácelo por el siguiente código: <pre>descriptionkey=name<br>displayname=Nombre de tarea<br>textmode=true<br>valueexpression=IF({numberOfChildren}>&quot;0&quot;,UPPER({name}),{name})<br>valueformat=HTML<br>width=150<br></pre>

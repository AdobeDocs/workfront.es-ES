...
description: Esta vista de proyecto muestra una lista de usuarios y funciones de trabajo asignadas al equipo del proyecto.
...
# Ver: proyecto con todos los usuarios y funciones del equipo del proyecto

Esta vista de proyecto muestra una lista de usuarios y funciones de trabajo asignadas al equipo del proyecto.

>[!NOTE]
>
>Si la función de trabajo aparece en la misma fila que un usuario, esto no significa que el usuario esté rellenando esa función en el proyecto ni que se asigne esa función al usuario en su perfil.

...
1. Clic **Agregar una regla de filtro** para el **Estado** del objeto de la lista.\
   Por ejemplo, en un informe de tareas, agregue **Estado Igual Nuevo Estado**, si desea mostrar solo las tareas que están en un estado de **Nuevo estado**.

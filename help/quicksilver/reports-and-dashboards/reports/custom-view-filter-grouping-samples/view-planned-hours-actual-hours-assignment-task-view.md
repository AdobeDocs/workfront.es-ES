...
title: '''Ver: Horas planificadas frente a horas reales por asignación en una vista de tarea"'
description: Esta vista de tareas muestra el total de horas planificadas de una tarea, el número de horas planificadas asignadas a cada usuario asignado, el total de horas reales y el número de horas reales registradas por cada usuario asignado.
...
# Ver: Horas planificadas frente a horas reales por asignación en una vista de tareas

Esta vista de tareas muestra el total de horas planificadas de una tarea, el número de horas planificadas asignadas a cada usuario asignado, el total de horas reales y el número de horas reales registradas por cada usuario asignado.

...
title: Recursos de modo de texto
description: Recursos de modo de texto
author: Nolan
...
Utilice la siguiente documentación para comprender el uso de la interfaz del modo de texto en Adobe Workfront. Puede ampliar el uso de los informes mediante el modo Texto y personalizando los informes incluso más de lo que permite el Creador de informes.

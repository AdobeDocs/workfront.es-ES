...
* Filtra en otras áreas de Workfront, fuera de listas e informes.
  ...
  Para obtener una lista de todos los filtros de Workfront y las áreas donde puede aplicarlos, consulte [Información general de filtros](../../../reports-and-dashboards/reports/reporting-elements/filters-overview.md).
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    <p>Estándar o Plan para modificar un filtro en un informe</p>
   </td>
  </tr> 
  <tr> 
   <td role="rowheader">Configuraciones de nivel de acceso</td> 
   <td> <p>Acceso de edición a filtros, vistas y agrupaciones</p> <p>Acceso de Edición a informes, paneles de control y calendarios</p>
   </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Permisos de objeto</td> 
   <td> <p>Administración de permisos para un filtro</p>
   </td> 
  </tr> 
 </tbody> 
</table>
...
Para obtener información acerca de los objetos de Workfront, consulte [Comprender los objetos en Adobe Workfront](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md).
...
* El generador estándar es la experiencia predeterminada para todas las áreas en las que está disponible. Para cambiar al generador de filtros heredados, haga clic en el menú **Más** situado junto a [!UICONTROL **Filtros**] y seleccione [!UICONTROL **Volver a los filtros heredados**].
...
1. Haga clic en el icono **Filtro** ![icono Filtro](assets/filter-nwepng.png) para abrir la interfaz del generador.
...
1. Revise las siguientes listas de filtros:
   ...
   <td>Filtros que ha marcado como favoritos. Al marcar un filtro como favorito, su ubicación original se muestra debajo del nombre del filtro y se oculta de la lista original a menos que se elimine como favorito.</td>
   </tr>
   <tr>
   <td role="rowheader"><strong>Guardado</strong></td>
   <td>Filtros que ha creado y guardado usted mismo. De forma predeterminada, esta lista muestra los filtros guardados en orden de guardado más reciente, pero los nombres de los filtros pueden arrastrarse para reordenar manualmente la lista.</td>
   </tr>
   <tr>
   <td role="rowheader"><strong>Valores predeterminados del sistema</strong></td>
   <td>Filtros predeterminados del sistema de Workfront y filtros que el administrador de Workfront añadió a su lista de filtros, ya sea a nivel de sistema o en la plantilla de diseño.</td>
   </tr>
   <tr>
...
1. Realice una de las siguientes acciones:
   ...
   * Pase el puntero por encima de un filtro que tenga permisos para administrar y haga clic en el icono **Editar**![icono Editar](assets/edit-icon.png) para editarlo.

     O

     Pase el puntero por encima de un filtro existente que tenga permisos para ver, haga clic en el menú **Más**![menú Más](assets/more-icon-spectrum.png) y, a continuación, haga clic en **Duplicar** para copiar el filtro existente y editar una copia.
...
1. (Condicional) Dependiendo de si desea buscar objetos que coincidan con todas o cualquiera de las instrucciones de un grupo de filtros, seleccione una de las siguientes opciones:
   ...
   ![Menú desplegable Incluir si todo o alguno o verdadero](assets/new-filters-all-or-any-are-true-drop-down-menu-nwe.png)

   Para obtener más información acerca de los operadores de filtro, consulte [Información general sobre los filtros](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/filters-overview.md).
...
1. Haga clic en el menú desplegable de campos para ver una lista de los campos utilizados recientemente y los campos sugeridos por los que filtrar. Los campos sugeridos se muestran actualmente en la lista que está filtrando.
   ...
   ![Localizar un campo por el cual filtrar](assets/new-filter-search-for-field.png)

1. Haga clic en el menú desplegable de modificadores para seleccionar un modificador. El modificador predeterminado es “Equals”.
...
1. Empiece a escribir el valor de un campo por el que desee filtrar. Por ejemplo, empiece a escribir el nombre de un problema, si desea filtrar por `Issue:Name`. Seleccione el valor cuando aparezca en la lista.

   >[!TIP]
   >
   >Según el modificador que haya seleccionado, puede seleccionar varios valores.

1. Haga clic en **Añadir filtro** para seleccionar otro campo y añadir un criterio de filtrado a la instrucción de filtro.
1. (Opcional) Haga clic en el icono **Eliminar** ![icono Eliminar](assets/delete.png) para eliminar las instrucciones de filtro existentes.

   O

   Haga clic en **Borrar todo** para borrar todos los criterios de filtrado.

1. (Opcional) Haga clic en **Añadir grupo de filtros** para añadir otro conjunto de criterios de filtrado. El operador predeterminado entre los conjuntos es **AND**. Haga clic en el operador para cambiarlo a **OR**.

   >[!TIP]
   >
   >Es posible que desee utilizar otro grupo de filtros cuando desee que los grupos estén conectados por un operador distinto del operador de una instrucción de filtro.

   >[!INFO]
   >
   >Cuando filtra proyectos que contienen “marketing” en el nombre y que no están completos ni en espera, se pueden utilizar los siguientes grupos de filtros múltiples:
...
1. (Opcional) Haga clic en **Modo de texto** para seguir creando el filtro mediante el modo de texto.
   ...
   ![Seleccionar el modo de texto](assets/new-filter-select-text-mode.png)
   ...
   >[!TIP]
   >
   >Se recomienda crear tantos filtros como sea posible mediante la interfaz del generador estándar y utilizar solo el modo de texto cuando deba modificar los filtros que solo se admiten en el modo de texto.

   Para obtener más información acerca de cómo crear un filtro mediante la interfaz de modo de texto, consulte [Editar un filtro mediante el modo de texto](/help/quicksilver/reports-and-dashboards/reports/text-mode/edit-text-mode-in-filter.md).
...
1. (Opcional) Para mover un filtro a la lista de Favoritos, pase el puntero por encima de cualquier filtro del cajón de filtros y haga clic en el icono **Favorito**![icono Favorito](assets/favorites-icon-small.png).

   O

   Pase el puntero por encima de cualquier filtro del cajón de filtros, haga clic en el menú Más ![menú Más](assets/more-icon-spectrum.png) y luego en **Favorito**.
...
1. (Opcional) Realice una de las siguientes acciones:
   ...
   * Comparta el filtro con otros o haga que esté disponible en todo el sistema. Para obtener más información, consulte [Compartir un filtro, vista o agrupación](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/share-filter-view-grouping.md).

   * Elimine el filtro si ya no es válido o está duplicado. Solo puede eliminar los filtros que sean de su propiedad. Puede eliminar los filtros que se compartieron con usted. Para obtener más información, consulte [Quitar filtros, vistas y agrupaciones](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/remove-filters-views-groupings.md).
...
1. Haga clic en **+ Nuevo filtro** en la parte superior de la lista de filtros.
   ...
   El generador para personalizar los lanzamientos de los filtros.

1. Realice una de las siguientes acciones:

   * Modifique las reglas de filtro existentes haciendo clic en la regla existente y seleccionando una nueva opción.
   * Añada una regla de filtro haciendo clic en **Añadir otra regla de filtro**, empiece a escribir el nombre de la opción para la que desea añadir una regla en el cuadro **Empiece a escribir el nombre del campo** y, a continuación, haga clic en él cuando aparezca en la lista desplegable.

     Los campos asociados con el objeto del filtro se enumeran en el cuadro **Empiece a escribir el nombre del campo**.

   * Haga clic en **AND** u **OR** al añadir una regla de filtro.\
     Al añadir reglas de filtro, utilice los modificadores de filtro para establecer la condición del filtro. Para obtener más información acerca de los modificadores de filtro, consulte [Modificadores de filtro y condición](../../../reports-and-dashboards/reports/reporting-elements/filter-condition-modifiers.md).

     >[!NOTE]
     >
     >Cuando conecta un grupo de instrucciones AND mediante varias instrucciones OR, debe repetir los campos que permanezcan invariables entre las instrucciones OR para cada grupo de instrucciones.
     >
     >![Instrucciones de filtro conectado](assets/filters-and-statements-connected-by-or-statements-builder-ui-legacy-filters.png)
     >
     >Cuando genere un filtro para tareas que contengan la palabra “marketing” y se encuentren en proyectos con un estado Actual o de Planificación, deberá contar con las siguientes reglas de filtrado:
     >
...
1. (Opcional) Haga clic en **Cambiar al modo de texto** para añadir un filtro mediante la interfaz del modo de texto.

   Para obtener más información acerca de cómo crear un filtro mediante la interfaz de modo de texto, consulte [Editar un filtro mediante el modo de texto](../../../reports-and-dashboards/reports/text-mode/edit-text-mode-in-filter.md).

1. Haga clic en **Guardar filtro** para crear un filtro o sustituir el seleccionado con sus cambios.
...
1. (Opcional) Realice una de las siguientes acciones:
   ...
   * Elimine los filtros que ya no desee mostrar en la lista. Para obtener más información, consulte [Quitar filtros, vistas y agrupaciones](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/remove-filters-views-groupings.md).

...
Puede compartir filtros, vistas y agrupaciones a las que tenga acceso para verlas con otros usuarios.

Cuando se comparte un filtro, una vista o una agrupación con un usuario, el usuario puede aplicar ese filtro, esa vista o esa agrupación a sus listas. En función del acceso que se le conceda, puede modificarlo y compartirlo con otros usuarios.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Acceso de visualización o superior a filtros, vistas y agrupaciones</p>
   </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Permisos de objeto</td> 
    <td> <p>Permisos de visualización o superiores con acceso para compartir en una vista, filtro o agrupación</p></td> 
   </td> 
  </tr> 
 </tbody> 
</table>
...
1. Haga clic en el icono **Filtro** ![icono Filtro](assets/filter-nwepng.png).
...
1. Revise las siguientes listas de filtros:
   ...
   <td>Filtros predeterminados del sistema de Workfront, así como filtros que el administrador de Workfront añadió a su lista de filtros, ya sea a nivel de sistema o en la plantilla de diseño.</td>
   </tr>
   <tr>
...
1. Pase el puntero por encima de un filtro al que tenga acceso al menos para ver y compartir. Luego, haga clic en el menú **Más**![Menú más](assets/more-icon-spectrum.png) y, a continuación, haga clic en **Compartir**.

   ![Más opciones de menú](assets/new-filters-more-menu-options-with-delete.png)

   Se muestra el cuadro Compartir filtros.

1. Empiece a escribir los nombres de los usuarios, equipos, funciones, grupos o empresas con los que desea compartir en el campo **Dar acceso a**.
...
1. Haga clic en **Compartir**. El filtro se comparte con las entidades especificadas.
   ...
   >[!TIP]
   >
   >El uso compartido con grupos concede permisos de filtrado a los miembros del grupo y de todos los subgrupos.
...
### Compartir filtros, vistas y agrupaciones mediante la interfaz heredada
...
1. (Condicional) En una lista, haga clic en el icono **Filtro**, **Vista** o **Agrupación** y, a continuación, pase el puntero por encima del filtro, la vista o la agrupación que desee compartir; haga clic en el icono **Más**![icono Más](assets/more-icon.png) y después en **Compartir**.
...
1. (Condicional) Si comparte datos de un informe, vuelva a hacer clic en el menú desplegable **Filtro**, **Vista** o **Agrupación** y, a continuación, haga clic en **Compartir filtro**, **Compartir vista** o **Compartir agrupación**.\
...
1. Complete cualquiera de las siguientes opciones, según con quién desee compartir:
   ...
   **Para compartir con todos los usuarios del sistema:** haga clic en el icono **Configuración** y, a continuación, haga clic en **Hacer que esto sea visible en todo el sistema**.\
   El administrador debe seleccionar la opción Compartir en todo el sistema para que esta opción esté disponible. Para obtener más información, consulte los artículos [Crear o modificar niveles de acceso personalizados](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md) y [Compartir informes, paneles de control y calendarios](../../../workfront-basics/grant-and-request-access-to-objects/permissions-reports-dashboards-calendars.md).

1. (Condicional) Si comparte contenido con usuarios, equipos, funciones, grupos o empresas individuales, haga clic en el menú desplegable para definir el nivel de acceso que desea conceder.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader"><strong>Compartirlo</strong></td> 
      <td> <p>Haga clic en <strong>Ajustes avanzados</strong> y, a continuación, active o desactive la opción <strong>Compartir</strong>, en función de si desea que los destinatarios puedan compartir con otros.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. Haga clic en **Guardar**.
   ...
   Los usuarios con los que ha compartido el filtro, la vista o la agrupación pueden acceder a ellos haciendo clic en el menú desplegable **Filtro**, **Vista** o **Agrupación** o en el icono y desplazándose hacia abajo hasta la sección **Compartido conmigo**.

...
Para obtener más información sobre la creación de informes, consulte [Creación de un informe personalizado](/help/quicksilver/reports-and-dashboards/reports/creating-and-managing-reports/create-custom-report.md) o [Creación de una copia de un informe](/help/quicksilver/reports-and-dashboards/reports/creating-and-managing-reports/create-copy-report.md).
...
1. Clic **Exportar**, luego seleccione un formato.
   ...
   Haga clic en **Exportar** icono ![Icono Exportar](assets/export-icon-nwe.png), luego seleccione un formato.

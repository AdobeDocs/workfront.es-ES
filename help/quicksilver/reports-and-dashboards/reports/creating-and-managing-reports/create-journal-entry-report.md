...
1. En la ficha **Columnas (vista)**, asegúrese de que tiene o haga clic en **Agregar columna** para agregar las siguientes columnas:
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td> <p style="font-weight: bold;">Nuevo valor de texto</p> </td> 
      <td> <p>El valor de texto actual del campo personalizado.</p> <p>Si el campo personalizado es un campo de búsqueda interna, la columna <strong>Nuevo valor de texto</strong> muestra el identificador de objeto.</p> </td> 
     </tr> 
    </tbody> 
   </table>

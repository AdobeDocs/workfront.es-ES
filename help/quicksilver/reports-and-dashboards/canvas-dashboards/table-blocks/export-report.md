---
title: Exportación de un informe en el lienzo de informes
description: Exportación de un informe en el lienzo de informes
hidefromtoc: true
hide: true
...
# Exportación de un informe en el lienzo de informes
...
1. En el encabezado del informe, haga clic en el icono **Más** ![Icono de más](assets/more-icon-27x15.png), haga clic en **Exportar** y, a continuación, seleccione el formato de archivo que desee crear.
   ...
   >[!NOTE]
   >
   >Tenga en cuenta lo siguiente con respecto a los archivos exportados:
   >

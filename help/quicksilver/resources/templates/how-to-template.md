...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[Cualquiera, profesional, empresarial, empresarial] o superior</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Licencia de Adobe Workfront*</td> 
   <td> <p>[Solicitud, Revisión, Trabajo, Plan] o superior</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Product</td> 
   <td>[Especifique la información especial del producto. Elimine esta línea si la funcionalidad está en Workfront [Proper]</td> 
  </tr> 
  <tr> 
   <td role="rowheader">Configuraciones de nivel de acceso*</td> 
   <td> <p>[Inserte cualquier configuración de nivel de acceso necesaria] <!--
  ...
  <tr> 
   ...
   <td> <p>[Inserte los permisos necesarios y especifique el objeto] <!--
      <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">

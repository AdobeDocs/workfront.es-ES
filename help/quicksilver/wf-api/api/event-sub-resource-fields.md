...
Los campos de recursos de suscripción de evento representan déclencheur para eventos que resultan en una suscripción de evento que envía un mensaje saliente a un extremo configurado. Cuando se edita un campo de recurso, se activa un evento UPDATE .

La tabla siguiente muestra los campos disponibles para los recursos de suscripción de eventos:
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> </td> 
   <td> </td> 
   <td> estimatedWorkPerDay </td> 
  </tr> 
  <tr> 
   <td> </td> 
   <td> </td> 
   <td> estimatedUserAllocationPercentage </td> 
  </tr> 
  <tr> 
   <td> </td> 
   <td> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> </td> 
   <td> </td> 
   <td><span>proofdecisions</span> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> </td> 
   <td> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> </td> 
   <td> </td> 
   <td><span>aprobadorDecisión</span> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> </td> 
   <td> </td> 
   <td><span>aprobadorID</span> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> </td> 
   <td> </td> 
   <td><span>isApendingdecisions</span> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> </td> 
   <td> </td> 
...
&#42;Un parameterValue es un valor de campo personalizado asociado a varios recursos (u objetos) de Workfront. Un mensaje saliente de suscripción de evento incluye una lista completa de parameterValues rellenados (campos personalizados).

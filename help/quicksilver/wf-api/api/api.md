...
title: API
description: Artículos sobre la API de Workfront
author: Becky
...
* [Reintentos de suscripción a eventos](../../wf-api/api/event-sub-retries.md)
...
* [Novedades de la versión 22](../../wf-api/api/new-api-version-22.md) de la API
* [Novedades de la versión 21 de la API](../../wf-api/api/new-api-version-21.md)
* [Novedades de la versión 20 de la API](../../wf-api/api/new-api-version-20.md)
...
* [Actualizaciones a la versión 8 de la API](../../wf-api/api/new-api-version-8-updates.md)

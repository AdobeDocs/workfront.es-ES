...
1. Utilice la siguiente solicitud **PUT** para cambiar el valor del campo **isActive** del usuario a **false**:

   ```
   <domain>`.my.workfront.com/attask/api/v15.0/USER/`<user's GUID>`?updates={"isActive":"false"}&method=put&apiKey=`<apiKey>`&fields=isActive
   ```

1. La respuesta mostrará que el valor del campo **isActive** ha cambiado de **true** a **false**, lo que indica que se ha desactivado el usuario:
